...
setup(
  ...
  description = 'This short little python module can help you with running your iterable functions on multi process without any hassle of creating threads by yourself.',   # Give a short description about your library
  ...
  download_url = 'https://github.com/imneonizer/improcess/archive/v0.1.0.tar.gz',    # I explain this later on
