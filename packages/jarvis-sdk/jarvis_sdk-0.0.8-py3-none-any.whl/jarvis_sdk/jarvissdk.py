...
def main():
    ...
    parser.add_argument("--gcp-project-id", help="Destination GCP Project ID", type=str, default=None)
    parser.add_argument("--gcp-composer-bucket", help="GCP Composer Bucket", type=str, default=None)
