...
- hillShading (boolean; default True)"""
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, center=Component.UNDEFINED, map_bounds=Component.UNDEFINED, scaleY=Component.UNDEFINED, showScaleY=Component.UNDEFINED, height=Component.UNDEFINED, draw_toolbar_polyline=Component.UNDEFINED, draw_toolbar_polygon=Component.UNDEFINED, draw_toolbar_marker=Component.UNDEFINED, polyline_points=Component.UNDEFINED, polygon_points=Component.UNDEFINED, marker_point=Component.UNDEFINED, lightDirection=Component.UNDEFINED, layers=Component.UNDEFINED, hillShading=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'center', 'map_bounds', 'scaleY', 'showScaleY', 'height', 'draw_toolbar_polyline', 'draw_toolbar_polygon', 'draw_toolbar_marker', 'polyline_points', 'polygon_points', 'marker_point', 'lightDirection', 'layers', 'hillShading']
        self._type = 'LayeredMap'
        self._namespace = 'webviz_subsurface_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'center', 'map_bounds', 'scaleY', 'showScaleY', 'height', 'draw_toolbar_polyline', 'draw_toolbar_polygon', 'draw_toolbar_marker', 'polyline_points', 'polygon_points', 'marker_point', 'lightDirection', 'layers', 'hillShading']
