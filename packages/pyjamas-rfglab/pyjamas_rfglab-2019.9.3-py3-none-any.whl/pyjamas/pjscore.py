...
class PyJAMAS(QtCore.QObject):
    ...
    # Calendar versioning: year.month.minor (+1 next time you upload, this is always the previous release number).
    __version__: str = '2019.9.3'
    def __init__(self):
    ...
    def initData(self) -> bool:
        ...
        self.plugin_path: str = os.path.join(self.cwd, 'plugins')
