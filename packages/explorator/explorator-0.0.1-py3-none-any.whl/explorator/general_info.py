...
def write_reports_view_to_one_excel(reports, report_name, info=['general', 'value', 'counts', 'examples', 'description']):
    '''
    DOESNT WORK
    '''
    #report_name='! rr.xlsx'
...
def get_total_info(dfc, info=['general', 'values', 'examples', 'description']):
    '''
    params:
