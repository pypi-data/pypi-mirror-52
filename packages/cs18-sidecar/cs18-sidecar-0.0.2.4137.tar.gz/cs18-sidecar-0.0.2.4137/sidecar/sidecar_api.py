...
from sidecar.services.input_value_resolver_service import InputValueResolverService
...
_input_value_resolver_service = None  # type: InputValueResolverService
...
def input_value_resolver():
    try:
        ...
        res = _input_value_resolver_service.resolve(input_value)
        return res, 200
...
def run_impl(config: ISidecarConfiguration, own_public_ip: str):
    ...
    global _app_sandbox_end_deployment_notifier
    global _input_value_resolver_service
    global _app_status_maintainer
    global _app_health_check_state
    global _file_logger
    global _status_maintainer
    ...
    _input_value_resolver_service = InputValueResolverService([_deployment_outputs_service, _sandbox_metadata])
