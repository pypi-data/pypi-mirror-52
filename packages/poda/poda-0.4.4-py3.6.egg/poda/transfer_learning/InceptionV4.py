...
class InceptionV4(object):
    def __init__(self, input_tensor, n_inception_a=4, n_inception_b=7, n_inception_c=3, classes=1000, batch_normalizations = True, dropout_rates=None, regularizers=None, scopes='InceptionV4'):
        """[summary]
    ...
    def stem_block(self, input_tensor, batch_normalization=True):
        ...
        """
        with tf.compat.v1.variable_scope(self.scope, 'StemBlock', [input_tensor], reuse=tf.compat.v1.AUTO_REUSE):
    ...
    def inception_a(self, input_tensor, batch_normalization=True):
        ...
        """
        with tf.compat.v1.variable_scope(self.scope, 'BlockInceptionA', [input_tensor], reuse=tf.compat.v1.AUTO_REUSE):
            with tf.compat.v1.variable_scope('Branch_0'):
    ...
    def reduction_a(self, input_tensor, batch_normalization=True):
        ...
        Keyword Arguments:
            ...
            reuse {[type]} -- [description] (default: {None})
        """
        with tf.compat.v1.variable_scope(self.scope, 'BlockReductionA', [input_tensor], reuse=tf.compat.v1.AUTO_REUSE):
            with tf.compat.v1.variable_scope('Branch_0'):
    ...
    def inception_b(self, input_tensor, batch_normalization=True):
        ...
        Keyword Arguments:
            ...
            reuse {[type]} -- [description] (default: {None})
        """
        with tf.compat.v1.variable_scope(self.scope, 'BlockInceptionB', [input_tensor], reuse=tf.compat.v1.AUTO_REUSE):
            with tf.compat.v1.variable_scope('Branch_0'):
                avg_pool_1 = avarage_pool_2d(input_tensor=input_tensor, kernel_sizes=(3,3), padding='SAME', stride_sizes=(1,1), names='0a_3x3')
    ...
    def reduction_b(self, input_tensor, batch_normalization=True):
        ...
        Keyword Arguments:
            ...
            reuse {[type]} -- [description] (default: {None})
        """
        with tf.compat.v1.variable_scope(self.scope, 'BlockReductionB', [input_tensor], reuse=tf.compat.v1.AUTO_REUSE):
            with tf.compat.v1.variable_scope('Branch_0'):
                max_pool_1 = max_pool_2d(input_tensor=input_tensor, pool_sizes=(3,3), stride_sizes=(2,2), paddings='VALID', names='0a_3x3')
            with tf.compat.v1.variable_scope('Branch_1'):
    ...
    def inception_c(self, input_tensor, batch_normalization=True):
        ...
        Keyword Arguments:
            ...
            reuse {[type]} -- [description] (default: {None})
        """
        with tf.compat.v1.variable_scope(self.scope, 'BlockInceptionC', [input_tensor], reuse=tf.compat.v1.AUTO_REUSE):
            with tf.compat.v1.variable_scope('Branch_0'):
                avg_pool_1 = avarage_pool_2d(input_tensor=input_tensor, kernel_sizes=(3,3), padding='SAME', stride_sizes=(1,1), names='0a_3x3')
    ...
    def create_model(self):
        ...
        Keyword Arguments:
            ...
            batch_normalizations {bool} -- [description] (default: {True})
        """
        with tf.compat.v1.variable_scope(self.scope, 'inception_v4', [self.input_tensor], reuse=tf.compat.v1.AUTO_REUSE):
