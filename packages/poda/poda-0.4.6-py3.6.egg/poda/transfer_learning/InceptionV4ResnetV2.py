...
class InceptionResnetV2(object):
    ...
    # Stem Block
    def stem_block(self, input_tensor, batch_normalization=True, scope=None):
        """[summary]
        ...
        """
        with tf.compat.v1.variable_scope(scope, 'StemBlock', [input_tensor]):
    ...
    # Inception A
    def inception_resnet_a(self, input_tensor, batch_normalization=True, scope=None):
        """[summary]
        ...
        """
        with tf.compat.v1.variable_scope(scope, 'BlockInceptionResnetA', [input_tensor]):
    ...
    # Reduction A
    def reduction_a(self, input_tensor, batch_normalization=True, scope=None):
        """[summary]
        ...
        Keyword Arguments:
            ...
            reuse {[type]} -- [description] (default: {None})
        """
        with tf.compat.v1.variable_scope(scope, 'BlockReductionA', [input_tensor]):
            with tf.compat.v1.variable_scope('Branch_0'):
    ...
    # Inception B
    def inception_resnet_b(self, input_tensor, batch_normalization=True, scope=None):
        """[summary]
        ...
        Keyword Arguments:
            ...
            reuse {[type]} -- [description] (default: {None})
        """
        with tf.compat.v1.variable_scope(scope, 'BlockInceptionResnetB', [input_tensor]):
            with tf.compat.v1.variable_scope('Relu_1'):
    ...
    # Reduction B
    def reduction_b(self, input_tensor, batch_normalization=True, scope=None):
        """[summary]
        ...
        Keyword Arguments:
            ...
            reuse {[type]} -- [description] (default: {None})
        """
        with tf.compat.v1.variable_scope(scope, 'BlockReductionB', [input_tensor]):
            with tf.compat.v1.variable_scope('Branch_0'):
                max_pool_1 = max_pool_2d(input_tensor=input_tensor, pool_sizes=(3,3), stride_sizes=(2,2), paddings='VALID', names='0a_3x3')
            with tf.compat.v1.variable_scope('Branch_1'):
    ...
    # Inception C
    def inception_c(self, input_tensor, batch_normalization=True, scope=None):
        """[summary]
        ...
        Keyword Arguments:
            ...
            reuse {[type]} -- [description] (default: {None})
        """
        with tf.compat.v1.variable_scope(scope, 'BlockInceptionC', [input_tensor]):
            with tf.compat.v1.variable_scope('Branch_0'):
