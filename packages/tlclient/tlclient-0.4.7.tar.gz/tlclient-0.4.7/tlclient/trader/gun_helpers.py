...
class GunRecorder(object):
    ...
    def __init__(self, fist_name, router_names, csv_dir=None, kdb_ip=None, kdb_port=None):
        ...
        # set csv dumper
        if csv_dir:
            self._obj.add_csv_client(csv_dir)
        if kdb_ip and kdb_port:
            self._obj.add_kdb_client(kdb_ip, kdb_port)
        # set db
