...
from ..models import Teacher, Student, Class, Classroom, Subject, CourseTableManager, RestTable
...
class DataClient(object):
    ...
    @staticmethod
    def create_course_table(course_table_manager, is_active=True):
        """
        创建课程表
    ...
    @staticmethod
    def create_rest_table(rest_table, is_active=False):
        """
        创建作息表
