...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-autoscaling", "1.8.0", __name__, "aws-autoscaling@1.8.0.jsii.tgz")
...
class CfnAutoScalingGroup(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-autoscaling.CfnAutoScalingGroup"):
    ...
    class LaunchTemplateProperty():
        ...
        @property
        def launch_template_specification(self) -> typing.Union["CfnAutoScalingGroup.LaunchTemplateSpecificationProperty", aws_cdk.core.IResolvable]:
...
class CfnAutoScalingGroupProps():
    ...
    @property
    def launch_template(self) -> typing.Optional[typing.Union[typing.Optional["CfnAutoScalingGroup.LaunchTemplateSpecificationProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::AutoScaling::AutoScalingGroup.LaunchTemplate``.
