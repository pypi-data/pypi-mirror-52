...
"}")
        ...
        self.label_26.setMinimumSize(QtCore.QSize(90, 40))
        self.label_26.setMaximumSize(QtCore.QSize(90, 40))
...
"}")
        ...
        self.pushButton = QtWidgets.QPushButton(self.main_control_qframe)
...
"]"))
        ...
        self.pushButton.setText(_translate("Form", "NOTIFICATIONS"))
