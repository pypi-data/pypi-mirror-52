...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-waf", "1.8.0", __name__, "aws-waf@1.8.0.jsii.tgz")
...
class CfnWebACL(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-waf.CfnWebACL"):
    ...
    class ActivatedRuleProperty():
        def __init__(self, *, priority: jsii.Number, rule_id: str, action: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnWebACL.WafActionProperty"]]]=None):
            """
        ...
        @property
        def action(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnWebACL.WafActionProperty"]]]:
...
class CfnWebACLProps():
    def __init__(self, *, default_action: typing.Union[aws_cdk.core.IResolvable, "CfnWebACL.WafActionProperty"], metric_name: str, name: str, rules: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnWebACL.ActivatedRuleProperty"]]]]]=None):
    ...
    @property
    def default_action(self) -> typing.Union[aws_cdk.core.IResolvable, "CfnWebACL.WafActionProperty"]:
        """``AWS::WAF::WebACL.DefaultAction``.
