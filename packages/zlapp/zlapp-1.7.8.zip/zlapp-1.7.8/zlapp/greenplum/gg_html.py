...
def gg_html_cdc1(max_html_key,conp_src,conp_dst):
    conp_dst[4]='cdc'
    ...
    db_command(sql1,dbtype="postgresql",conp=conp_dst)
    pg2pg(sql,'gg_html_cdc1',conp_src,conp_dst,chunksize=10000,datadict=datadict,if_exists='replace')
