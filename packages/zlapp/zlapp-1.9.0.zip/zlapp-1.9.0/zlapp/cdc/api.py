...
def pre_meta(loc='aliyun'):
    conp_app=app_settings[loc]['conp_app5']
...
def add_quyu_app(quyu,loc="aliyun"):
    ...
    pre_quyu(quyu,'qy_zhongbiao',loc)
    pre_quyu(quyu,'xmjl_zhongbiao',loc)
    pre_quyu(quyu,'t_gg_ent_bridge',loc)
    pre_quyu(quyu,'app_qy_zz',loc)
    pre_quyu(quyu,'app_qy_zcry',loc)
    pre_quyu(quyu,'app_qy_query',loc)
