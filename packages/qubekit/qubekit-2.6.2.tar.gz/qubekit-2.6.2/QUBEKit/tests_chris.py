...
from QUBEKit.parametrisation.antechamber import AnteChamber
...
molecule.theory = 'b3lyp'
molecule.write_pdb()

AnteChamber(molecule)
molecule.coords['mm'] = molecule.coords['input']

qm_eng = QCEngine(molecule)

result = qm_eng.call_qcengine('geometric', 'gradient', input_type='mm')
