...
class RealEnvironmentAgentManager(AgentManager):
    ...
    def _providers(self, providers_identifier):
        assert isinstance(providers_identifier, abc.Sequence)
        for provider_identifier in providers_identifier:
            assert isinstance(provider_identifier, AgentID)
