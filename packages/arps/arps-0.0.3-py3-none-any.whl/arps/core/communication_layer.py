...
class CommunicationLayer(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def unregister(self, entity: CommunicableEntity):
    ...
    async def send(self,
        ...
        '''
        if message.type in (PayloadType.error,
        ...
        try:
            ...
            message = f'Something happened when trying to send a message from {agent_src} to {agent_dst}'
