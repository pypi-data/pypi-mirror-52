...
def try_to_connect(address: str = None,
                   port: int = None,
                   tries: int = None):
    '''
...
def build_url(netloc: str, resource: str, params: str = None):
    request = ('http', netloc, resource, params, None, None)
    return urllib.parse.urlunparse(request)


def build_http_body_and_header(body: JSONType = None,
                               headers: Dict[str, str] = None) -> Tuple[str, Dict[str, str]]:
