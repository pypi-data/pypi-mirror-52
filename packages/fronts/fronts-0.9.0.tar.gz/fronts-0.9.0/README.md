# <img alt="Fronts" src="resources/logo.png" height="100">
...
The main solver function, ``fronts.solve()``, will assume that you want to work with this common problem unless you explicitly provide the optional `radial` and `ob` parameters. 
...
This is a complete list of the symbols that Fronts provides, with a short description of each. You can find the full details on each object in the [API documentation](https://readthedocs.org/projects/fronts/).
...
<img alt="S plot" src="resources/powerlaw_S.png" height=400>
...
<img alt="flux plot" src="resources/powerlaw_flux.png" height=400>
