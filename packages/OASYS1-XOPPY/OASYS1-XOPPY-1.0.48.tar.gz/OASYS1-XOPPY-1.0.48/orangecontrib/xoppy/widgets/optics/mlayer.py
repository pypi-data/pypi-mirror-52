...
class OWmlayer(XoppyWidget):
    ...
    METHOD = Setting(0) # 0 = old mlayer, 1=
    ...
    def build_gui(self):
        ...
        gui.comboBox(box1, self, "F12_FLAG",
                     label=self.unitLabels()[idx], addSpace=False,
                    items=['OLD mlayer code', 'OLD mlayer code with mlayers.f12','New python code'],
    ...
    def unitLabels(self):
         return ['Layer periodicity: ','Scanning variable: ','Calculation code:',
    ...
    def unitFlags(self):
         return ['True','True','True',
                 'self.F12_FLAG  !=  1','self.F12_FLAG  !=  1','self.F12_FLAG  !=  1',
                 'True','True','True',
    ...
    def xoppy_calc_mlayer(self):
        ...
        elif self.F12_FLAG == 2:
            aa = numpy.zeros((100,100))
            pass
        ...
        try:
            if SCAN == 0:
                calculated_data.add_content("xoppy_data", aa)
        ...
        try:
            ...
            # NLAYERS = self.NLAYERS
            # FILE = self.FILE
            if self.SCAN == 0: #angle
                E_MIN = self.ENERGY - 5000.0
                E_MAX = self.ENERGY + 5000.0

                theta1 = self.THETA
                theta2 = self.THETA + self.NPOINTS * self.SCAN_STEP
            ...
            from srxraylib.gol.plot import plot
