...
class ImageViewWithFWHM(QWidget):
    def __init__(self, x_scale_factor = 1.0, y_scale_factor = 1.0):
        ...
        layout.addWidget(self.info_box, 0, 0, 0, 0)
...
class PythonScript(QWidget):
    ...
    def __init__(self, x_scale_factor = 1.0, y_scale_factor = 1.0,):
        ...
        self.script_box = oasysgui.widgetBox(self, "", addSpace=False, orientation="vertical",
                                        height=self.WIDGET_HEIGHT - 80, width=self.WIDGET_WIDTH - 80)
        ...
        layout.addWidget(self.pythonScript, 0, 1, 1, 1)



        # self.console_box = oasysgui.widgetBox("", addSpace=True, orientation="vertical",
        #                                   height=150, width=self.WIDGET_WIDTH - 80)

        self.console = PythonConsole(self.__dict__, self)
        # console_box.layout().addWidget(self.console)

        layout.addWidget(self.console, 0, 0, 1, 1)


        # layout.addWidget(self.pythonScript, 0, 0, 1, 1)
        ...
        #
        # out_box = oasysgui.widgetBox(script_box, "System Output", addSpace=True, orientation="horizontal", height=self.WIDGET_HEIGHT - 80)
