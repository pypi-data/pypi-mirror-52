...
#
#
cpdef tuple operateur_reconstruction_one_step(double[:] L, long  int[:] row_L , long int[:] col_L, int shape_L,
                                              double[:] Lbarre, long int[:] row_Lbarre , long int[:] col_Lbarre, int shape_Lbarre,
                                              double[:] GXbarrebr, long int[:] row_GXbarrebr , long int[:] col_GXbarrebr, int shape_GXbarrebr,
                                              long int[:] Xbarre,
                                              double qprime)