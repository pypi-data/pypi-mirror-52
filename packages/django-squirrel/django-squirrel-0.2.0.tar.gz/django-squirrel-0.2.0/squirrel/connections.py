...
class RabbitCredential(Credential):
    """Rabbit Credential"""

    def get(self):
        return pika.PlainCredentials(username=self.user, password=self.password)
...
class RabbitConnection(Connection):
    ...
    def open(self):
        ...
        self.connection = pika.BlockingConnection(parameters=self.connection_params.get())
