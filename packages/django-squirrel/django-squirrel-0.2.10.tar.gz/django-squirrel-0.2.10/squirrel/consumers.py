...
class Consumer(RabbitConnection, ForkProcess, JSONRPCEncoderDecoder):
    """Consumer Mixin"""
    ...
    def create_request(self, raw_data, routing_key=None) -> Request:
        request = Request(raw_data=raw_data)
    ...
    def on_message_callback(self, payload):
        ...
        request = self.create_request(raw_data=body, routing_key=routing_key)
