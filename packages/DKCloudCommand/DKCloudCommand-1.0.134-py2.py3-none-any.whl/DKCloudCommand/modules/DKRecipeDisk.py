...
from githash import githash_by_file_name
        ...
        for remote_file in remote_sha[remote_path]:
            if remote_path in local_sha:
                local_files_found = filter(
                    lambda local_file: local_file['filename'] == remote_file['filename'],
        ...
        if ignore.ignore(local_path):
            ...
            for local_file in local_files:
                ...
                remote_files_found = filter(
                    lambda remote_file: remote_file['filename'] == local_file['filename'],
