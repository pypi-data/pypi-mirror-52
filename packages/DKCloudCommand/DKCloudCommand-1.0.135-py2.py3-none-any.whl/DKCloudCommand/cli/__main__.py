...
class Backend(object):
    ...
    def check_version(self, cfg):
        ...
        if latest_version and self.version_to_int(latest_version) > current_version:
            print '\033[31m***********************************************************************************\033[39m'  # noqa: E501
            print '\033[31m Warning !!!\033[39m'
            print '\033[31m Your command line is out of date, new version %s is available. Please update.\033[39m' % latest_version  # noqa: E501
            print ''
