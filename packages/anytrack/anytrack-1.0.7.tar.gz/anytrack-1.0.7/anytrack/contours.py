...
def get_contour_stats(video, background, force_num_contours=None, num_frames=500, how='uniform'):
    ...
    for i in range(num_frames):
        ...
        print(area_contours.shape, np.array(areas[:int(round(mean_number))]).shape)
