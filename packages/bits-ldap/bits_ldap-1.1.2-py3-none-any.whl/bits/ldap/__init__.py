...
class LDAP(object):
    ...
    def __init__(
        ...
        self.ldapobject = ldapmodule.initialize(uri, bytes_mode=False)
        if self.verbose:
    ...
    def add_entry(self, dn, new):
        ...
        ldif = ldapmodule.modlist.addModlist(self.convert_entry(new))
        try:
    ...
    def modify_entry(self, dn, current, new):
        ...
        ldif = ldapmodule.modlist.modifyModlist(current, new)
        try:
