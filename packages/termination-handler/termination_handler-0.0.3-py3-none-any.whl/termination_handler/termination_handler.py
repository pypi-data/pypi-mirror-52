...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        action='store_true',
        help='send notification message to a Slack channel',
    )
    parser.add_argument(
        '--slack-api-token',
    ...
    parser.add_argument(
        ...
        help='channel that receives the notification',
    )
    parser.add_argument(
        '--demo',
...
def build_handlers(args):
    ...
    if args.slack:
        handlers_to_return.append(SlackHandler(token=args.slack_api_token,channel=args.slack_channel))
