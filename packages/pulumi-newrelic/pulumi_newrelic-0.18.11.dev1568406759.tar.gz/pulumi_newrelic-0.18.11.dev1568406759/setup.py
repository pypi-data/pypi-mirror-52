...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v0.18.11-dev.1568406759+g42c5ed4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v0.18.11-dev.1568406759+g42c5ed4`
                """)
            else:
                raise
