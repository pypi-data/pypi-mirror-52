...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v0.18.11-alpha.1568485367+gef5733c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v0.18.11-alpha.1568485367+gef5733c`
                """)
            else:
                raise
