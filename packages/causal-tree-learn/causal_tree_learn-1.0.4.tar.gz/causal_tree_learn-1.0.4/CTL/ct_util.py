...
def grid_search(features, labels, treatment, weights=None, split_sizes=None, opt_obj="obj", base_obj=True, weight_obj=False, verbose=True):
    ...
    for w in weights:
        for s in split_sizes:
            ...
            if verbose:
                ...
                print(f"Elapsed time: {time.time()-start:.3f}" % (time.time()-start))
