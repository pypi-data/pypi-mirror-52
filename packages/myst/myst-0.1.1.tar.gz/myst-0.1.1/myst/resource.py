...
class Resource(object):
    ...
    def list(cls):
        ...
        response = client.get(class_url)
        response_json = response.json()
        resources = [cls(**resource_json) for resource_json in response_json["data"]]
        return resources
    ...
    def refresh(self):
        ...
        self.refresh_with(attributes=response.json())
