...
def get_credentials(use_service_account=False, use_console=False, service_account_key_file_path=None):
    ...
    Args:
        use_service_account (bool): whether or not to get credentials using a service account or to use the
            default of prompting and getting credentials on behalf of a user
        use_console (bool, optional): whether to use the console instead of opening and using a web browser
        service_account_key_file_path (str, optional): full path to service account key file; if this is specified,
            `use_service_account` is assumed to be `True`
...
def authenticate(credentials=None, use_service_account=False, use_console=False, service_account_key_file_path=None):
    ...
    Args:
        ...
        service_account_key_file_path (str, optional): full path to service account key file; this should only be
            specified if `use_service_account` is `True`
    """
