...
class OptionSellScreener(object):
    ...
    def _gen_ascii_tbl_data(self) -> List[List[str]]:
        ...
        equities = self._marketplace.get_equities(symbols=symbols)
    ...
    def _get_option_sell_candidates(self) -> List[OptionSellCandidate]:
        ...
        option_chains = self._marketplace.get_option_chains(ids)
    ...
    def _find_best_option_instruments(
        ...
        while start_idx <= end_idx:
            ...
            if market_data is None or market_data.chance_of_profit_short is None:
