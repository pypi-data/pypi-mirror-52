...
order_states = {'filled', 'partially_filled', 'cancelled', 'rejected', 'failed'}
...
def test_symbol_history_twtr() -> None:
    ...
    example = [
        ...
        [
            '08/08/2018 19:00',
            'CUSTOM',
            'TWTR20181019C31.0/TWTR20181019C32.0/TWTR20181019C44.0/TWTR20181019P26.0',
...
def test_symbol_history_tlry() -> None:
    report = SymbolHistory(symbol='TLRY')
    data = report._gen_ascii_tbl_data()
    example = [
        ['Date', 'Event', 'Symbol', 'Quantity', 'Price', '# of Shares', 'Avg Price', 'Cumulative Profit'],
        ...
        ['07/26/2019 20:22', 'OPTION EXPIRATION', 'TLRY20190726P40.0', '3', '$0.00', '500', '$48.02', '$-3,258.20'],
        ['07/29/2019 16:57', 'SHORT PUT', 'TLRY20190802P39.0', '10', '$0.69', '500', '$48.02', '$-3,258.20'],
        ['07/30/2019 15:48', 'SHORT CALL', 'TLRY20190802C43.5', '5', '$0.19', '500', '$48.02', '$-3,258.20'],
        ['08/02/2019 20:23', 'OPTION EXPIRATION', 'TLRY20190802C43.5', '5', '$0.00', '500', '$48.02', '$-3,163.20'],
        ['08/02/2019 20:23', 'OPTION EXPIRATION', 'TLRY20190802P39.0', '10', '$0.00', '500', '$48.02', '$-2,473.20'],
        ['08/05/2019 15:24', 'SHORT CALL', 'TLRY20190809C45.5', '5', '$0.39', '500', '$48.02', '$-2,473.20'],
        ['08/09/2019 20:24', 'OPTION EXPIRATION', 'TLRY20190809C45.5', '5', '$0.00', '500', '$48.02', '$-2,278.20'],
        ['08/12/2019 16:26', 'SHORT PUT', 'TLRY20190816P36.0', '10', '$0.40', '500', '$48.02', '$-2,278.20'],
        ['08/12/2019 19:08', 'SHORT CALL', 'TLRY20190816C46.5', '5', '$0.90', '500', '$48.02', '$-2,278.20'],
        [
            '08/13/2019 18:02',
            'ROLLING CALL', 'TLRY20190816C46.5/20190823C47.5', '5', '$0.09', '500', '$48.02', '$-2,278.20',
        ],
        ['08/16/2019 20:38', 'PUT ASSIGNMENT', 'TLRY20190816P36.0', '10', '$36.00', '1,500', '$39.74', '$-2,278.20'],
        ['08/19/2019 13:42', 'SHORT PUT', 'TLRY20190823P30.0', '15', '$1.10', '1,500', '$39.74', '$-2,278.20'],
        ['08/19/2019 13:54', 'BUY TO CLOSE', 'TLRY20190823P30.0', '15', '$1.76', '1,500', '$39.74', '$-3,268.20'],
        ['08/19/2019 14:10', 'SHORT PUT', 'TLRY20190823P30.0', '15', '$2.00', '1,500', '$39.74', '$-3,268.20'],
        ['08/19/2019 14:14', 'SHORT CALL', 'TLRY20190823C30.0', '10', '$1.04', '1,500', '$39.74', '$-3,268.20'],
        [
            '08/19/2019 15:03',
            'ROLLING CALL', 'TLRY20190823C47.5/20190823C30.0', '5', '$1.38', '1,500', '$39.74', '$-3,268.20',
        ],
        ['08/19/2019 15:41', 'BUY TO CLOSE', 'TLRY20190823P30.0', '15', '$1.18', '1,500', '$39.74', '$-2,038.20'],
        ['08/20/2019 15:37', 'SHORT PUT', 'TLRY20190823P29.5', '15', '$1.06', '1,500', '$39.74', '$-2,038.20'],
        [
            '08/23/2019 15:51',
            'ROLLING PUT', 'TLRY20190823P29.5/20190830P28.5', '15', '$0.56', '1,500', '$39.74', '$-2,038.20',
        ],
        ['08/23/2019 20:21', 'OPTION EXPIRATION', 'TLRY20190823C30.0', '15', '$0.00', '1,500', '$39.74', '$186.80'],
        [
            '08/27/2019 17:21',
            'ROLLING PUT', 'TLRY20190830P28.5/20190906P28.0', '15', '$0.18', '1,500', '$39.74', '$186.80',
        ],
        ['08/27/2019 17:23', 'SHORT PUT', 'TLRY20190830P26.5', '5', '$1.04', '1,500', '$39.74', '$186.80'],
        ['08/28/2019 14:25', 'SHORT CALL', 'TLRY20190830C27.5', '15', '$0.46', '1,500', '$39.74', '$186.80'],
        ['08/30/2019 18:45', 'BUY TO CLOSE', 'TLRY20190830P26.5', '5', '$0.78', '1,500', '$39.74', '$316.80'],
        ['08/30/2019 20:22', 'OPTION EXPIRATION', 'TLRY20190830C27.5', '15', '$0.00', '1,500', '$39.74', '$1,006.80'],
        ['09/03/2019 14:28', 'SHORT CALL', 'TLRY20190906C26.5', '15', '$0.69', '1,500', '$39.74', '$1,006.80'],
        [
            '09/03/2019 14:37',
            'ROLLING PUT', 'TLRY20190906P28.0/20190913P27.5', '15', '$0.30', '1,500', '$39.74', '$1,006.80',
        ],
        [
            '09/03/2019 18:19',
            'ROLLING CALL', 'TLRY20190906C26.5/20190913C27.0', '15', '$0.08', '1,500', '$39.74', '$1,006.80',
        ],
    ]
    for i in range(len(example)):
        assert example[i] == data[i]
