...
setup(name='damegender',
      ...
      scripts=['src/damegender/main.py', 'src/damegender/accuracy.py', 'src/damegender/git2gender.py', 'src/damegender/pca-features.py', 'src/damegender/api2gender.py', 'src/damegender/infofeatures.py', 'src/damegender/nameincountries.py'],
      ...
      entry_points={
          'console_scripts': ['main=main.command_line:main.py'],
      },
