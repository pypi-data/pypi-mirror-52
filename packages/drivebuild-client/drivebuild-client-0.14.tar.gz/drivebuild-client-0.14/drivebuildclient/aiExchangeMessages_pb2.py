...
_DATARESPONSE_DATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='DataResponse.Data.error', index=9,
  ...
  nested_types=[_DATARESPONSE_DATA_POSITION, _DATARESPONSE_DATA_SPEED, _DATARESPONSE_DATA_STEERINGANGLE, _DATARESPONSE_DATA_LIDAR, _DATARESPONSE_DATA_CAMERA, _DATARESPONSE_DATA_DAMAGE, _DATARESPONSE_DATA_LANECENTERDISTANCE, _DATARESPONSE_DATA_CARTOLANEANGLE, _DATARESPONSE_DATA_BOUNDINGBOX, _DATARESPONSE_DATA_ERROR, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
