...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-servicediscovery", "1.9.0", __name__, "aws-servicediscovery@1.9.0.jsii.tgz")
...
class Service(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-servicediscovery.Service"):
    ...
    def from_service_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, dns_record_type: "DnsRecordType", routing_policy: "RoutingPolicy", service_arn: str, service_id: str, service_name: str) -> "IService":
        ...
        :param service_name: 
        """
        attrs = ServiceAttributes(dns_record_type=dns_record_type, routing_policy=routing_policy, service_arn=service_arn, service_id=service_id, service_name=service_name)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-servicediscovery.ServiceAttributes", jsii_struct_bases=[], name_mapping={'dns_record_type': 'dnsRecordType', 'routing_policy': 'routingPolicy', 'service_arn': 'serviceArn', 'service_id': 'serviceId', 'service_name': 'serviceName'})
class ServiceAttributes():
    def __init__(self, *, dns_record_type: "DnsRecordType", routing_policy: "RoutingPolicy", service_arn: str, service_id: str, service_name: str):
        """
        :param dns_record_type: 
        :param routing_policy: 
        :param service_arn: 
