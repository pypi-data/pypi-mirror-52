...
def get_addenda(tipo_addenda, diccionario):
    addenda = __import__(tipo_addenda).addenda
            ...
            if nomina_xml.exists:
                ...
                if percepciones:
                    for p in percepciones:
                        ...
                        xml.complemento.nomina.total_gravado += string_to_decimal(
                            p.get("importegravado")
                        )
                        xml.complemento.nomina.total_exento += string_to_decimal(
                            p.get("importeexento")
                        )
                        xml.complemento.nomina.total_percepciones += string_to_decimal(
                            p.get("importegravado")
                        ) + string_to_decimal(
                            p.get("importeexento")
                        )
                ...
                if otrospagos:
                    for p in otrospagos:
                        ...
                        xml.complemento.nomina.total_otrospagos += string_to_decimal(
                            p.get("importe")
                        )
                ...
                if deducciones:
                    for d in deducciones:
                        ...
                        xml.complemento.nomina.total_deducciones += string_to_decimal(
                            d.get("importe")
                        )
