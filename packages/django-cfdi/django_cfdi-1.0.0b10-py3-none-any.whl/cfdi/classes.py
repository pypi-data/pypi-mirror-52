...
from .settings import (
    TMP_DIR, DFACTURE_AUTH, PRODIGIA_AUTH, NTLINK_AUTH,
)
...
class CFDI:
    ...
    def generar_sello(self):
        ...
        cmd_dgst = ["openssl", "dgst", self.openssl_algo_hash, "-sign", self.pem_path, co_path,]
...
class CfdiPago():
    ...
    def __init__(self, cfdi_instance, cliente, codigo_postal, sustitucion=None):
    ...
    def generar_cfdi(self, configuracion, timbrado_prueba=None, pac=None):
        ...
        cfdi.Receptor = {}
        cfdi.Receptor["Rfc"] = self.cliente.rfc
        cfdi.Receptor["Nombre"] = self.cliente.razon_social
        if self.cliente.es_extranjero():
            cfdi.Receptor["ResidenciaFiscal"] = self.cliente.get_pais()
            cfdi.Receptor["NumRegIdTrib"] = self.cliente.id_fiscal
