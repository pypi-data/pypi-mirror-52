...
class ComplementoIEDU(CfdiComplemento):
    ...
    autRVOE = ""
    rfcPago = ""
    template = 'complementos/iedu.xml'
...
class ComplementoDetallista(CfdiComplemento):
    ...
    personDepartament = ""
    sellerGLN = ""
    template = 'complementos/detallista.xml'
...
class ComplementoImpuestosLocales(CfdiComplemento):
    retenciones_locales = []
    traslados_locales = []
    template = 'complementos/impuestos_locales.xml'
...
class ComplementoComercioExterior(CfdiComplemento):
    ...
    Emisor = {}
    Receptor = {}
    template = 'complementos/comercio_exterior.xml'
...
class ComplementoContruccionLicencia(CfdiComplemento):
    ...
    estado = ""
    codigo_postal = ""
    template = 'complementos/construccion_licencia.xml'
...
class ComplementoLeyendasFiscales(CfdiComplemento):
    leyendasFiscales = []
    template = 'complementos/leyendas_fiscales.xml'
...
class ComplementoNomina(CfdiComplemento):
    ...
    template = 'complementos/nomina.xml'
    xmlns_list = [
...
class ComplementoPago(CfdiComplemento):
    pagos = []
    template = 'complementos/pago.xml'
    xmlns_list = [
