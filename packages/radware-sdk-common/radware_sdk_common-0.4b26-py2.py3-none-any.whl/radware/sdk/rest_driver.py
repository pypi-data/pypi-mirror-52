...
from radware.sdk.common import is_py3
import ssl
...
class RestSession(object):
    ...
    def __init__(self, cert_verify=True, block=False, max_connection=1):
        if not cert_verify:
    ...
    def request(self, method, url, params=None, data=None, headers=None, auth=None,
                timeout=None, verify=None, json=None, user=None, password=None):
        request = Request(
            method=method.upper(),
            url=url,
            headers=headers,
