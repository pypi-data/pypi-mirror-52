...
from .forms import UserForm, UserProfileParentsForm,UserAvatarForm, UserSearchForm, profile_inline_formset, UserClassForm, \
...
class UserUpdate(UpdateView):
    ...
    def get_form_kwargs(self):
        ...
        kwargs.update({
            'is_assistant': user.userprofile.is_assistant()
        })
        return kwargs
