...
import datetime, pytz, json, calendar, hashlib
...
class UserProfile(models.Model):
    ...
    # type-2:亲子用户，创建一组账号
    @classmethod
    def create_user(cls, op_user, preuser, type):
    ...
    @classmethod
    def _create_user(cls, preuser, type):
...
class UserClass(models.Model):
    ...
    lecturer=models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name='助教', null=True, blank=True,related_name='lecturer')
...
def get_assistant(self):
    return self.userprofile.user_class.assistant
