...
class MetricDefinitionTestCase(testtools.TestCase):
    ...
    def test__parse_attributes(self):
        ...
        self.assertEqual(
            "Temperature", self.metric_definition_inst.sensor_type
        )
        self.assertEqual(
        ...
        self.assertEqual([], self.metric_definition_inst.wildcards)
        ...
        self.assertEqual("1.1.0", self.metric_definition_inst.redfish_version)
        self.assertEqual(
            "CPU Bandwidth type", self.metric_definition_inst.name
        )
        self.assertEqual("CPUBandwidth", self.metric_definition_inst.identity)
        self.assertEqual("Numeric", self.metric_definition_inst.metric_type)
        self.assertEqual(
            "DigitalMeter", self.metric_definition_inst.implementation
        )
        ...
        self.assertEqual("1.1.0", self.metric_definition_inst.redfish_version)
        self.assertEqual(
            "CPU1 IPMI Health Sensor", self.metric_definition_inst.name
        )
        self.assertEqual("CPUHealth1", self.metric_definition_inst.identity)
        self.assertEqual("Discrete", self.metric_definition_inst.metric_type)
        self.assertEqual(
            "PhysicalSensor", self.metric_definition_inst.sensor_type
        )
        self.assertEqual(
            "PhysicalSensor", self.metric_definition_inst.implementation
        )
        ...
        self.assertEqual(expected, self.metric_definition_inst.discrete_values)
        ...
        self.assertEqual("1.1.0", self.metric_definition_inst.redfish_version)
        self.assertEqual(
            "Temperature MetricDefinition", self.metric_definition_inst.name
        )
