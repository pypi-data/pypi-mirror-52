    ...
    for chrom in contigs:
        ...
        for ci in range(nchunks):
            ...
            try:
                ...
                # The input VCF only has variants for autosomes and X.
                # However the remaining contigs are still in the VCF's header and the
                # fact that there are no variants there seems to cause an error when
                # trying to fetch stuff from these missing contigs.
                pass
