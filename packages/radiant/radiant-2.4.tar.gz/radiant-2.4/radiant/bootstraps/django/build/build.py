...
''')
    ...
    if get_bootstrap_name() in ["webview", "django"]:
        ap.add_argument('--port', dest='port',
    ...
    ap.add_argument('--status-bar-color', dest='status_bar_color',
                    default="#000000",
                    help=('Whether to compile to optimised .pyo files, using -OO '
                          '(strips docstrings and asserts)'))
    ap.add_argument('--navigation-bar-color', dest='navigation_bar_color',
                    default="#000000",
                    help=('Whether to compile to optimised .pyo files, using -OO '
                          '(strips docstrings and asserts)'))
    ap.add_argument('--theme', dest='theme',
                    default="light",
                    help=('Whether to compile to optimised .pyo files, using -OO '
                          '(strips docstrings and asserts)'))
