...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-opsworks", "1.8.0", __name__, "aws-opsworks@1.8.0.jsii.tgz")
...
class CfnAppProps():
    ...
    @property
    def app_source(self) -> typing.Optional[typing.Union[typing.Optional["CfnApp.SourceProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::OpsWorks::App.AppSource``.
