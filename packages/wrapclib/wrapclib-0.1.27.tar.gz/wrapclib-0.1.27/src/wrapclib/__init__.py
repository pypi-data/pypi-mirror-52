...
<opml version="1.0">
    ...
    <body>
        <outline text="wrapclib"
            title="wrapclib"
            type="rss"
            xmlUrl="http://www.xavierdupre.fr/app/wrapclib/helpsphinx/_downloads/rss.xml"
            htmlUrl="http://www.xavierdupre.fr/app/wrapclib/helpsphinx/blog/main_0000.html" />
    </body>
</opml>
"""
