...
try:
    from rs4.apis.google.assistant import (
        assistant_helpers,
        audio_helpers,
        browser_helpers,
        device_helpers        
...
def set_device (project_id_, device_model_id_):
    ...
    try:
        ...
        raise
    device_id, device_model_id = device_helpers.register (api_endpoint, project_id, device_model_id_)
...
def send (audio_sorce, lang = 'ko-KR', output_audio_file = None, once = True, display = True, verbose = False, *args, **kwargs):        
