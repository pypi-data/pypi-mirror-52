...
class EnumBwmNewCfgGenEmail(BaseBeanEnum):
    enabled = 2
    disabled = 3
...
class EnumSlbNewCfgProxyGratArp(BaseBeanEnum):
    enabled = 1
    disabled = 2
...
class EnumGslbNewCfgGenDssphc(BaseBeanEnum):
    enabled = 1
    disabled = 2
...
class EnumAgNewCfgAPMMgmtOrDataPort(BaseBeanEnum):
    mgmt = 1
    data = 2
...
class Root(DeviceBean):
    def __init__(self, **kwargs):
        ...
        self.bwmNewCfgGenSmtpUser = kwargs.get('bwmNewCfgGenSmtpUser', None)
        self.bwmNewCfgGenEmailFrequency = kwargs.get('bwmNewCfgGenEmailFrequency', None)
        self.bwmNewCfgGenIPUserLimit = kwargs.get('bwmNewCfgGenIPUserLimit', None)
        self.bwmNewCfgGenEmail = EnumBwmNewCfgGenEmail.enum(kwargs.get('bwmNewCfgGenEmail', None))
        self.bwmNewCfgGenReport = kwargs.get('bwmNewCfgGenReport', None)
        ...
        self.slbNewCfgSlowage = kwargs.get('slbNewCfgSlowage', None)
        ...
        self.slbNewCfgProxyGratArp = EnumSlbNewCfgProxyGratArp.enum(kwargs.get('slbNewCfgProxyGratArp', None))
        ...
        self.gslbNewCfgGenDssphc = EnumGslbNewCfgGenDssphc.enum(kwargs.get('gslbNewCfgGenDssphc', None))
        ...
        self.agNewCfgAPMMgmtOrDataPort = EnumAgNewCfgAPMMgmtOrDataPort.enum(kwargs.get('agNewCfgAPMMgmtOrDataPort', None))
        self.agNewCfgAPMServerBkupIpAddr = kwargs.get('agNewCfgAPMServerBkupIpAddr', None)
