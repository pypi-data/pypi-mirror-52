...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_04_get_assets(self):
        ...
        #     if 'walkingactivity.multiclass' in detail['name']:
        #         TestAIOpenScaleClient.source_uid = detail['source_uid']
        #         print("Selected asset details: {}".format(detail))

        TestAIOpenScaleClient.source_uid = "76611220d2a21271860e391d01269235"
    ...
    def test_13_payload_logging_data_distribution(self):
        ...
        self.assertGreaterEqual(data_distribution.shape[1], 1)
        data_columns = data_distribution.columns.values
        self.assertIn("V2", data_columns)
    ...
    def test_17_send_feedback_data(self):
        ...
        training_data = pd.read_csv('datasets/waling-activity/User Identification From Walking Activity_feedback.csv', sep=',')
    ...
    def test_19_feedback_logging_data_distribution(self):
        ...
        self.assertGreaterEqual(run_result.shape[0], 1)
        self.assertGreaterEqual(run_result.shape[1], 1)
        data_columns = run_result.columns.values
        self.assertIn("V1:avg", data_columns)
    ...
    def test_23_disable_payload_logging_and_performance_monitoring(self):
