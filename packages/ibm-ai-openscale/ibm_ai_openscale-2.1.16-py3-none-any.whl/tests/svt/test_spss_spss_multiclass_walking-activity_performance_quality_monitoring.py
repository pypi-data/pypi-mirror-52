...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_22_setup_explainability(self):
        self.skipTest("Explainability is not supported for SPSS multiclass models that return only the winning class probability")

        TestAIOpenScaleClient.data_df = pd.read_csv("datasets/waling-activity/User Identification From Walking Activity.csv")
