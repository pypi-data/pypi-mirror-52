...
class TestAIOpenScaleClient(unittest.TestCase):
                    ...
                    [
                        {
                            ...
                            'Soil_Type': 'Como - Legault families complex, extremely stony'
                        }
                    ],
            },
            "GlobalParameters": {
    ...
    def test_02_bind_azure(self):
        TestAIOpenScaleClient.binding_uid = self.ai_client.data_mart.bindings.add("Azure ml engine", AzureMachineLearningStudioInstance(self.credentials))
    ...
    def test_04_get_assets(self):
        ...
        TestAIOpenScaleClient.source_uid = "8b3fa6de5b35bb77fdc640877f5ee16b"
    ...
    def test_05_subscribe_azure_asset(self):
        subscription = self.ai_client.data_mart.subscriptions.add(
            AzureMachineLearningStudioAsset(source_uid=self.source_uid,
                                            ...
                                            feature_columns=['Elevation', 'Aspect', 'Slope', 'Hillshade_9am', 'Hillshade_Noon', 'Hillshade_3pm', 'Wilderness_Area', 'Soil_Type'],
    ...
    def test_12_stats_on_payload_logging_table(self):
        ...
        assert_payload_logging_python_table_content(python_table_content=python_table_content,
                                                    fields=['prediction_probability', 'Scored Labels',
                                                            'Scored Probabilities for Class "Aspen"',
                                                            'Scored Probabilities for Class "Lodgepole Pine"',
                                                            'Scored Probabilities for Class "Krummholz"',
                                                            'Scored Probabilities for Class "Ponderosa Pine"',
                                                            'Scored Probabilities for Class "Douglas-fir"',
                                                            'Scored Probabilities for Class "Ponderosa Pine"',
                                                            'Scored Probabilities for Class "Cottonwood/Willow"'])
    ...
    def test_13_payload_logging_data_distribution(self):
        ...
        self.assertIn('Soil_Type', data_columns)
    ...
    def test_17_send_feedback_data(self):
        ...
        training_data = pd.read_csv('datasets/forest-coverage/forest_coverage_feedback.csv', sep=',')
    ...
    def test_19_feedback_logging_data_distribution(self):
        ...
        self.assertIn("Cover_Type", data_columns)
        self.assertIn("count", data_columns)
    ...
    def test_23_setup_explainability(self):
        data_df = pd.read_csv("datasets/forest-coverage/forest_coverage_prepared.csv")
    ...
    def test_28_setup_fairness_monitoring(self):
        TestAIOpenScaleClient.subscription.fairness_monitoring.enable(
            features=[
                Feature("Hillshade_Noon", majority=[[220, 240]], minority=[[192, 200]], threshold=0.8)
            ],
            favourable_classes=["Lodgepole Pine"],
            unfavourable_classes=["Cottonwood/Willow"],
            min_records=5,
            training_data=TestAIOpenScaleClient.data_df
        )
