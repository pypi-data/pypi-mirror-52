...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def score(self, binding_details, subscription_details):
        ...
        fields = ['season', 'yr', 'mnth', 'hr', 'holiday', 'weekday', 'workingday',
                    'weathersit', 'temp', 'atemp', 'hum', 'windspeed', 'casual',
                    'registered']
        payload = "3., 1., 7., 20., 0., 6., 0., 1., 0.66, 0.6061, 0.83, 0.2239, 79., 154."
    ...
    def setUpClass(cls):
        ...
        cls.data_df = pd.read_csv("./datasets/Bike-rental/bike-rental-train.csv")
    ...
    def test_05_get_assets(self):
        ...
        for detail in asset_details:
            if 'neelima-bike-sharing' in detail['name']:
    ...
    def test_14_send_feedback_data(self):
        ...
        for i in range(0, self.feedback_records):
            feedback_records.append(
                [3., 1., 7., 20., 0., 6., 0., 1., 0.66, 0.6061, 0.83, 0.2239, 79., 154., 232.9797821044922])
