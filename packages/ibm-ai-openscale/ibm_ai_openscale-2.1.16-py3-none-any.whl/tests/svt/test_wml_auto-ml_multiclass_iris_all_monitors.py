...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_06_get_deployment(self):
        TestAIOpenScaleClient.model_uid = "d07d792b-47e6-4ada-8efb-e5910aed42b6"
        TestAIOpenScaleClient.deployment_uid = "df1566c1-439b-450a-85c0-efafeb7342b5"
    ...
    def test_07_subscribe(self):
        subscription = TestAIOpenScaleClient.ai_client.data_mart.subscriptions.add(WatsonMachineLearningAsset(
            ...
            feature_columns=["Id", "SepalLengthCm", "SepalWidthCm", "PetalLengthCm", "PetalWidthCm"],
            categorical_columns=[]
        ))
