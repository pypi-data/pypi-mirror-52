...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_02_bind_azure(self):
        TestAIOpenScaleClient.binding_uid = TestAIOpenScaleClient.ai_client.data_mart.bindings.add("Azure ml engine", AzureMachineLearningStudioInstance(self.credentials))
    ...
    def test_04_get_assets(self):
        ...
        #     if 'adultcensusincome.logistic.regression' in detail['name']:
        ...
        TestAIOpenScaleClient.source_uid = "417532dc6dae852809393ae097703de5"
    ...
    def test_05_subscribe_azure_asset(self):
        subscription = TestAIOpenScaleClient.ai_client.data_mart.subscriptions.add(
            AzureMachineLearningStudioAsset(
                ...
                feature_columns=['age', 'workclass', 'education', 'marital-status', 'occupation', 'relationship', 'race', 'sex', 'capital-gain', 'capital-loss', 'hours-per-week', 'native-country'],
    ...
    def test_17_send_feedback_data(self):
        ...
        feedback_data = pd.read_csv("datasets/adult-income/adult-income-feedback.csv", sep=';')
    ...
    def test_19_feedback_logging_data_distribution(self):
        ...
        self.assertGreater(run_result.shape[1], 2)
        data_columns = run_result.columns.values
        self.assertIn("relationship", data_columns)
        self.assertIn("education", data_columns)
    ...
    def test_24_setup_explainability(self):
        data_df = pd.read_csv("datasets/adult-income/Adult Census Income Binary Classification dataset.csv")
    ...
    def test_29_setup_fairness_monitoring(self):
        TestAIOpenScaleClient.subscription.fairness_monitoring.enable(
            ...
            favourable_classes=[">50K"],
            unfavourable_classes=["<=50K"],
            min_records=5,
            training_data=TestAIOpenScaleClient.data_df
        )
