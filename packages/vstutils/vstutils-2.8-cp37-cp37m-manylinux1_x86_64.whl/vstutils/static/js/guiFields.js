...
toBase64(data={}){let value=data[this.options.name];if(value!==undefined){return arrayBufferToBase64(value);}}};guiFields.binfile=class BinFileField extends guiFields.base64file{static get mixins(){return super.mixins.concat(gui_fields_mixins.binfile);}};guiFields.binimage=class BinImageField extends guiFields.binfile{static get mixins(){return super.mixins.concat(gui_fields_mixins.binimage);}};guiFields.text_paragraph=class TextParagraphField extends guiFields.base{toRepresent(data={}){let value=data[this.options.name];if(value===undefined){return this.options.default;}
...
getUrlParams(url,data,params){if(Object.entries(params).length!==0&&params.constructor!==Object){return params;}
