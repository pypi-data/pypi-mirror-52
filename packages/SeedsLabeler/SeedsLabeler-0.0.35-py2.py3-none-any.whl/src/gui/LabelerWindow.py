...
class LabelerWindow(QMainWindow, Ui_MainWindow):
    ...
    def setupConnections(self):
        ...
        self.detectAll.clicked.connect(self.detectAllImages)
    ...
    def loadViews(self):
        ...
        self.context = (self.edit, self.deleteAction, self.hideCurrentClass, self.showCurrentClass, self.hideAll, self.showAll)
        addActions(self.labelMenu, self.context)
        addActions(self.canvas.menus[0], self.context)
        ...
        self.onLoadActive = (self.closeAction, self.create, self.detect, self.detectAll,
    ...
    def showMoreStats(self):
        ...
        detailledMessage += f" - radical: {cnt['radical']}\n"
        detailledMessage += f" - germinated seeds: {cnt['radical']}\n"
        detailledMessage += f" - non-germinated seeds: {cnt['seed']-cnt['radical']}\n"
        if cnt['seed'] > 0:
            detailledMessage += f" - ratio germinated: {cnt['radical']*100/cnt['seed']:02.2f} %\n"
        else:
