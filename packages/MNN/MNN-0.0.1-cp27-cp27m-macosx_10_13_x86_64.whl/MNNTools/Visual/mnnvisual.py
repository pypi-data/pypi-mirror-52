...
def usage():
    """ print usage info """
    print("Usage: mnnvisual target.mnn target.png")
    print("write the target.mnn network structure to target file,eg target.png")
    print("depencies:pydot_ng or pydot and graphviz")
    print("see more detail in https://www.yuque.com/mnn/en/mnnvisual")
