...
class PQtListView(_PQtListViewBase, _PQtClientWidget, listview.PListViewBase, metaclass=_PQtSequenceMeta):
...
class PQtListBox(_PQtListViewBase, _PQtWidget, listview.PListBoxBase, metaclass=_PQtSequenceMeta):
