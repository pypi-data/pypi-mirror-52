...
from plib.gui.defs import GUI_WX, GUI_KDE4, GUI_QT4, GUI_PYSIDE, GUI_QT5, GUI_PYSIDE2
...
if gui_toolkit == 0:
    ...
    if KDE4_PRESENT or QT4_PRESENT or PYSIDE_PRESENT or QT5_PRESENT or PYSIDE2_PRESENT:
