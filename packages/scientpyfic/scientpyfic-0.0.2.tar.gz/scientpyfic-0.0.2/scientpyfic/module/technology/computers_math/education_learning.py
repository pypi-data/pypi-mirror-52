...
class EducationLearning:
  ...
  def neural_intefaces(self, title=None, description=None, pub_date=None, body=None, journals=None, **kwargs):
    """
    Returns a list with latest news from ScienceDaily about neural interfaces.
    """
    options = {
