...
class UserLive(models.Model):
    ...
    # 获取开始时间的筛选条件
    @classmethod
    def get_start_time_filter(cls, day=None, week=None, month=None):
        ...
        if not day == None:
            ...
            start_dt = datetime.datetime(year=int(year), month=int(month), day=int(day), hour=0, minute=0, second=0,
                                         tzinfo=tz)
