...
class PublicServer(BaseMoudel):
    ...
    def return_build_success_response(self, response_data=None, timestamp_now=False):
        '''
    ...
    def return_build_error_response(self, msg=None, timestamp_now=False):
        '''
        ...
        return self.return_json_response(
            self.build_return_response_data('1000', data_type='2', msg=msg, timestamp_now=timestamp_now))
