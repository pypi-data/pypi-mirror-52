...
def evaluate(args, model, property, train_loader, val_loader, test_loader, device):
    metrics = [
        ...
        schnetpack.metrics.RootMeanSquaredError(property, "y"),
    ]
...
if __name__ == "__main__":
    ...
    ani1 = spk.datasets.ANI1(args.datapath, collect_triples=args.model == "wacsf",
                             download=True)
    atomref = ani1._get_atomref(train_args.property)
