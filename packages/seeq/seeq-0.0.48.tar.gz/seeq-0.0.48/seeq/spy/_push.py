...
def push(data=None, *, metadata=None, item_type='Signal', workbook=_common.DEFAULT_WORKBOOK_PATH,
    ...
    :param item_type: The type of item being pushed if no 'metadata' argument is being supplied. Default is 'Signal'.
    :type item_type: str
    ...
    while True:
        ...
        for index, row in push_results_df.iterrows():
            ...
            try:
                ...
                dependencies_not_found.append((index, e.data_id))
                continue
    ...
    for k, v in parameters_dict.items():
        ...
        if isinstance(v, pd.DataFrame):
            ...
            if 'ID' in v:
                ...
                if not parameter_id:
                    raise ParameterNotFound(scoped_data_id)
        else:
            parameter_id = v
