...
class Workbook:
    ...
    def push(self, prefix=None, owner_id=None, folder_id=None):
        ...
        if not workbook_item:
            ...
            data_id = Workbook._item_id_with_prefix(prefix, self.id)
        ...
        items_api.set_properties(id=workbook_item.id, body=props)

    @staticmethod
    def _item_id_with_prefix(prefix, item_id):
    ...
    def find_item_id(prefix, item_id):
        ...
        data_id = Workbook._item_id_with_prefix(prefix, item_id)
...
class Worksheet:
    ...
    def _pull(self, definition):
        ...
        if current_workstep_id is not None:
            self.current_workstep = self.worksteps[current_workstep_id]
