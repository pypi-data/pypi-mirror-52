...
setup(
    ...
    download_url = 'https://github.com/Pangeamt/pangeamt_toolkit/archive/3.3.3.tar.gz',
    install_requires=[
        'aiohttp==3.5.4',
        'async-timeout==3.0.1',
        'attrs==19.1.0',
