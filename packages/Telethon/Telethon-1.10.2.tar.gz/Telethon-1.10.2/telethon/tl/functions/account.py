...
class CreateThemeRequest(TLRequest):
    CONSTRUCTOR_ID = 0x2b7ffd7f
    SUBCLASS_OF_ID = 0x56b4c80c

    def __init__(self, slug: str, title: str, document: 'TypeInputDocument'):
        """
    ...
    def from_reader(cls, reader):
        ...
        return cls(slug=_slug, title=_title, document=_document)
...
class UpdateThemeRequest(TLRequest):
    CONSTRUCTOR_ID = 0x3b8ea202
    SUBCLASS_OF_ID = 0x56b4c80c

    # noinspection PyShadowingBuiltins
    def __init__(self, format: str, theme: 'TypeInputTheme', slug: Optional[str]=None, title: Optional[str]=None, document: Optional['TypeInputDocument']=None):
        """
        :returns Theme: Instance of either ThemeDocumentNotModified, Theme.
        """
        self.format = format
    ...
    def __bytes__(self):
        return b''.join((
            b'\x02\xa2\x8e;',
            struct.pack('<I', (0 if self.slug is None or self.slug is False else 1) | (0 if self.title is None or self.title is False else 2) | (0 if self.document is None or self.document is False else 4)),
            self.serialize_bytes(self.format),
            bytes(self.theme),
    ...
    def from_reader(cls, reader):
        ...
        if flags & 4:
            ...
            _document = None
        return cls(format=_format, theme=_theme, slug=_slug, title=_title, document=_document)
