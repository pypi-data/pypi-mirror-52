...
class PHPRequest(BaseRequest):
    ...
    @property
    def hostname(self):
        return self.get_raw_header("HTTP_HOST", self.environ.get("SERVER_NAME"))
    ...
    def client_user_agent(self):
        return self.get_raw_header("HTTP_USER_AGENT", "")

    @property
    def referer(self):
        return self.get_raw_header("HTTP_REFERER", None)
    ...
    def request_headers(self):
        return defaultdict(str, **self.raw_headers)
