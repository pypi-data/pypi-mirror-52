...
from swimlane_platform.questions_groups import mongo_admin_password_question, mongo_sw_password_question
...
class DbConfiguration(BaseWithLog):
    ...
    def get_mongo_uri(self, mongo_settings):
        ...
        password = urllib.quote(mongo_settings.get('password', ''))
