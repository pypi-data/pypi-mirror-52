...
test = obst.open_obst(TEST_PATH, metafile_class=obst.metafiles.custom(unique_id = True))
...
indices = test.indices([["avg", "scan", "other.test", "stuff"], ["avg", "scan" , "other.test"]], idx_filter = [filter_one,None])
stop = time.time()
print("Finished Index: ", stop-start)


index = indices[0]

print("Here: ", index.table)
