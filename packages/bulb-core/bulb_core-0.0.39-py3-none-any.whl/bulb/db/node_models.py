...
class Node(BaseNode):
    ...
    @classmethod
    def get(cls, uuid=None, order_by=None, limit=None, skip=None, desc=False, only=None, filter=None, return_query=False):
        """
    ...
    def count(cls, uuid=None, order_by=None, limit=None, skip=None, desc=False, only=None, filter=None, **extrafields):
        request_statement = cls.get(uuid=uuid, order_by=order_by, limit=limit, skip=skip, desc=desc, only=only, filter=filter, return_query=True, **extrafields)
