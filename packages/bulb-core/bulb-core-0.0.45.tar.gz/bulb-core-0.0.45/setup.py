...
setuptools.setup(
    ...
    install_requires=['neo4j', "Pillow-SIMD", "requests", "paramiko", "pysftp", "bcrypt", "scour"],
    ...
    extras_require={"django-libsass": ["django-libsass"], "django-compressor": ["django-compressor"]},
    classifiers=[
