...
class FileAPI(API):
    ...
    def register(
        ...
        Args:
            ...
            path (str): Path to the directory in Google Cloud Storage in which the file is stored
    ...
    def edit(
        ...
        """
        file = self.identify(id, name)
        request = EditFileRequest(file=file, path=path, name=new_name, metadata=metadata, crs=CRS(crs=crs))
