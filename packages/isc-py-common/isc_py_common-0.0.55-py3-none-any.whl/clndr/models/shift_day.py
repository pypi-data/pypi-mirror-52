...
class Shift_dayManager(CommonManagetWithLookUpFieldsManager):
    ...
    def create_update(self, data):
        ...
        with transaction.atomic():
            ...
            setAttr(data, 'begintime', datetime.datetime.strptime(shiftday.begintime,'%H:%M:%S.%f').time())
            setAttr(data, 'endtime', datetime.datetime.strptime(shiftday.endtime,'%H:%M:%S.%f').time())
