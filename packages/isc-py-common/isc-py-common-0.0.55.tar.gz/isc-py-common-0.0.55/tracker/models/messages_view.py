...
from django.db.models import DateTimeField, BooleanField, UUIDField, TextField
...
class Messages_viewQuerySet(MessagesQuerySet):
    def get_range_rows1(self, request, function=None, distinct_field_names=None):
        ...
        return self.get_range_rows(start=request.startRow, end=request.endRow, function=function, distinct_field_names=distinct_field_names, json=request.json)
