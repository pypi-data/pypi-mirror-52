...
from twits import FREQUENCY_OF_POLLING_UNREAD_MESSAGES
            ...
            if user.check_password(data.get('password', None)):
                ...
                group_chats = [
                    dict(
                        ...
                        theme_ids=[Messages_theme.objects.get_or_create(
                ...
                self.response = dict(
                    ...
                    ws_host=WS_HOST,
                    ws_port=WS_PORT,
                    frequencyOfPollingUnreadMessages=FREQUENCY_OF_POLLING_UNREAD_MESSAGES,
