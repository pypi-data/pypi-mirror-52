...
def main():
    ...
    parser.add_argument("--name", "-n", "--service", type=str, required=False, default=os.getenv('SCOPE_SERVICE'),
                        dest='service', help="Service name to use when sending data to Scope [$SCOPE_SERVICE]")
