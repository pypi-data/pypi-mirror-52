...
class AutoSenseWidget(BaseWidget):
    ...
    def _on_validation_method_change(self, change):
        if change['new'] == 'Stratified Shuffle Split':
        ...
        if change['new'] in ['Stratified Metadata k-fold', 'Metadata k-fold']:
            self._info_validation_metadata.layout.visibility = 'visible'
            self._w_validation_metadata.layout.visibility = 'visible'
        else:
    ...
    def create_widget(self):
        ...
        self._w_seed = widgets.Dropdown(
            description='Seed', options=[], style=description_style)
        ...
        self._w_population_size = widgets.IntSlider(
            description="Population", value=50, min=25, max=100, step=1, style=description_style)
        ...
        self._w_validation_method = widgets.Dropdown(description='Validation', options=[
            'Stratified K-Fold Cross-Validation', 'Stratified Shuffle Split', 'Metadata k-fold', 'Stratified Metadata k-fold'], style=description_style)
