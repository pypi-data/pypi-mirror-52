...
from tflex.optimize import optimize_for_inference
...
class Converter(object):
    ...
    def convert(self, save_path, device='/device:EPU:0', level=0, strict_padding=False):
        ...
        Args:
          ...
          level: Selection of different levels of optimization, e.g., Fundamental, BatchNormalization, EPU Core or Additional optimization,
        ...
        try:
            tstart = time.time()
            new_graph_def = optimize_for_inference(self._graph_def, input_arrays, output_arrays,
                                                   device=device,
                                                   step=level,
                                                   strict_padding=strict_padding)
