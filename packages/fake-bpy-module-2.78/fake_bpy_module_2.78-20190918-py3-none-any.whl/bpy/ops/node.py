...
def add_and_link_node(settings: typing.List['bpy.types.NodeSetting'] = None,
                      type: str = "",
...
def add_node(settings: typing.List['bpy.types.NodeSetting'] = None,
             type: str = "",
             use_transform: bool = False):
...
def add_search(settings: typing.List['bpy.types.NodeSetting'] = None,
               type: str = "",
               use_transform: bool = False,
               node_item: int = ''):
    '''Add a node to the active tree 
