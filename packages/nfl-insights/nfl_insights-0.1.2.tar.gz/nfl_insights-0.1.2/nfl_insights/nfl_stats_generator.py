...
class NFLStatsGenerator(SportsStatsGenerator):
    ...
    def __init__(self):
        self.domain = nfl_insights.NFL_DOMAIN_NAME
        SportsStatsGenerator.__init__(self, self.domain, domainConfigGID=nfl_insights.NFL_DOMAIN_CONFIG_GID, queriesRoot=str(Path(__file__).parent))
        #
