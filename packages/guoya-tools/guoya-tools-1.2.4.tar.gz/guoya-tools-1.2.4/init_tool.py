...
def init_ui_project():
    ...
    deldir(tools_prj)
    mkdir(tools_prj)
    cmd = 'git clone https://github.com/LudvikWoo/guoya-tools-test.git ' + tools_prj
    invoke(cmd)
...
def init_api_project():
    ...
    ui_prj = 'c:/guoya/auto_test_init/guoya-api-test'
    deldir(ui_prj)
    mkdir(ui_prj)
    cmd = 'git clone https://github.com/LudvikWoo/guoya-ui-test.git ' + ui_prj
    invoke(cmd)
...
def init_app_project():
    ...
    ui_prj = 'c:/guoya/auto_test_init/guoya-app-test'
    deldir(ui_prj)
    mkdir(ui_prj)
    cmd = 'git clone https://github.com/LudvikWoo/guoya-ui-test.git ' + ui_prj
    invoke(cmd)
