...
class ExecutableModel(_object):
    ...
    def getFloatingSpeciesAmountRateIds(self):
        return _roadrunner.ExecutableModel_getFloatingSpeciesAmountRateIds(self)
...
class RoadRunner(_object):
    ...
    def getFloatingSpeciesAmounts(self):
        return _roadrunner.RoadRunner_getFloatingSpeciesAmounts(self)

    def getFloatingSpeciesConcentrations(self):
        return _roadrunner.RoadRunner_getFloatingSpeciesConcentrations(self)
...
class Config(_object):
    ...
    STEADYSTATE_PRESIMULATION_TOL = _roadrunner.Config_STEADYSTATE_PRESIMULATION_TOL
