...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-glue", "1.9.0", __name__, "aws-glue@1.9.0.jsii.tgz")
...
class CfnCrawler(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-glue.CfnCrawler"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, database_name: str, role: str, targets: typing.Union[aws_cdk.core.IResolvable, "TargetsProperty"], classifiers: typing.Optional[typing.List[str]]=None, configuration: typing.Optional[str]=None, crawler_security_configuration: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, schedule: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ScheduleProperty"]]]=None, schema_change_policy: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["SchemaChangePolicyProperty"]]]=None, table_prefix: typing.Optional[str]=None, tags: typing.Any=None) -> None:
        ...
        """
        props = CfnCrawlerProps(database_name=database_name, role=role, targets=targets, classifiers=classifiers, configuration=configuration, crawler_security_configuration=crawler_security_configuration, description=description, name=name, schedule=schedule, schema_change_policy=schema_change_policy, table_prefix=table_prefix, tags=tags)
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-glue.CfnCrawler.TargetsProperty", jsii_struct_bases=[], name_mapping={'jdbc_targets': 'jdbcTargets', 's3_targets': 's3Targets'})
    class TargetsProperty():
        def __init__(self, *, jdbc_targets: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnCrawler.JdbcTargetProperty"]]]]]=None, s3_targets: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnCrawler.S3TargetProperty"]]]]]=None):
            """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-glue.CfnCrawlerProps", jsii_struct_bases=[], name_mapping={'database_name': 'databaseName', 'role': 'role', 'targets': 'targets', 'classifiers': 'classifiers', 'configuration': 'configuration', 'crawler_security_configuration': 'crawlerSecurityConfiguration', 'description': 'description', 'name': 'name', 'schedule': 'schedule', 'schema_change_policy': 'schemaChangePolicy', 'table_prefix': 'tablePrefix', 'tags': 'tags'})
class CfnCrawlerProps():
    def __init__(self, *, database_name: str, role: str, targets: typing.Union[aws_cdk.core.IResolvable, "CfnCrawler.TargetsProperty"], classifiers: typing.Optional[typing.List[str]]=None, configuration: typing.Optional[str]=None, crawler_security_configuration: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, schedule: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCrawler.ScheduleProperty"]]]=None, schema_change_policy: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCrawler.SchemaChangePolicyProperty"]]]=None, table_prefix: typing.Optional[str]=None, tags: typing.Any=None):
...
class CfnDevEndpoint(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-glue.CfnDevEndpoint"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, role_arn: str, endpoint_name: typing.Optional[str]=None, extra_jars_s3_path: typing.Optional[str]=None, extra_python_libs_s3_path: typing.Optional[str]=None, number_of_nodes: typing.Optional[jsii.Number]=None, public_key: typing.Optional[str]=None, security_configuration: typing.Optional[str]=None, security_group_ids: typing.Optional[typing.List[str]]=None, subnet_id: typing.Optional[str]=None, tags: typing.Any=None) -> None:
        ...
        """
        props = CfnDevEndpointProps(role_arn=role_arn, endpoint_name=endpoint_name, extra_jars_s3_path=extra_jars_s3_path, extra_python_libs_s3_path=extra_python_libs_s3_path, number_of_nodes=number_of_nodes, public_key=public_key, security_configuration=security_configuration, security_group_ids=security_group_ids, subnet_id=subnet_id, tags=tags)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-glue.CfnDevEndpointProps", jsii_struct_bases=[], name_mapping={'role_arn': 'roleArn', 'endpoint_name': 'endpointName', 'extra_jars_s3_path': 'extraJarsS3Path', 'extra_python_libs_s3_path': 'extraPythonLibsS3Path', 'number_of_nodes': 'numberOfNodes', 'public_key': 'publicKey', 'security_configuration': 'securityConfiguration', 'security_group_ids': 'securityGroupIds', 'subnet_id': 'subnetId', 'tags': 'tags'})
class CfnDevEndpointProps():
    def __init__(self, *, role_arn: str, endpoint_name: typing.Optional[str]=None, extra_jars_s3_path: typing.Optional[str]=None, extra_python_libs_s3_path: typing.Optional[str]=None, number_of_nodes: typing.Optional[jsii.Number]=None, public_key: typing.Optional[str]=None, security_configuration: typing.Optional[str]=None, security_group_ids: typing.Optional[typing.List[str]]=None, subnet_id: typing.Optional[str]=None, tags: typing.Any=None):
...
class CfnJob(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-glue.CfnJob"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, command: typing.Union[aws_cdk.core.IResolvable, "JobCommandProperty"], role: str, allocated_capacity: typing.Optional[jsii.Number]=None, connections: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ConnectionsListProperty"]]]=None, default_arguments: typing.Any=None, description: typing.Optional[str]=None, execution_property: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ExecutionPropertyProperty"]]]=None, glue_version: typing.Optional[str]=None, log_uri: typing.Optional[str]=None, max_capacity: typing.Optional[jsii.Number]=None, max_retries: typing.Optional[jsii.Number]=None, name: typing.Optional[str]=None, number_of_workers: typing.Optional[jsii.Number]=None, security_configuration: typing.Optional[str]=None, tags: typing.Any=None, worker_type: typing.Optional[str]=None) -> None:
        ...
        """
        props = CfnJobProps(command=command, role=role, allocated_capacity=allocated_capacity, connections=connections, default_arguments=default_arguments, description=description, execution_property=execution_property, glue_version=glue_version, log_uri=log_uri, max_capacity=max_capacity, max_retries=max_retries, name=name, number_of_workers=number_of_workers, security_configuration=security_configuration, tags=tags, worker_type=worker_type)
...
class CfnTrigger(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-glue.CfnTrigger"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, actions: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "ActionProperty"]]], type: str, description: typing.Optional[str]=None, name: typing.Optional[str]=None, predicate: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["PredicateProperty"]]]=None, schedule: typing.Optional[str]=None, tags: typing.Any=None) -> None:
        ...
        """
        props = CfnTriggerProps(actions=actions, type=type, description=description, name=name, predicate=predicate, schedule=schedule, tags=tags)
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-glue.CfnTrigger.ActionProperty", jsii_struct_bases=[], name_mapping={'arguments': 'arguments', 'job_name': 'jobName', 'security_configuration': 'securityConfiguration'})
    class ActionProperty():
        def __init__(self, *, arguments: typing.Any=None, job_name: typing.Optional[str]=None, security_configuration: typing.Optional[str]=None):
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-glue.CfnTrigger.ConditionProperty", jsii_struct_bases=[], name_mapping={'job_name': 'jobName', 'logical_operator': 'logicalOperator', 'state': 'state'})
    class ConditionProperty():
        def __init__(self, *, job_name: typing.Optional[str]=None, logical_operator: typing.Optional[str]=None, state: typing.Optional[str]=None):
            """
