...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-dms", "1.8.0", __name__, "aws-dms@1.8.0.jsii.tgz")
...
class CfnEndpointProps():
    ...
    @property
    def dynamo_db_settings(self) -> typing.Optional[typing.Union[typing.Optional["CfnEndpoint.DynamoDbSettingsProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::DMS::Endpoint.DynamoDbSettings``.
