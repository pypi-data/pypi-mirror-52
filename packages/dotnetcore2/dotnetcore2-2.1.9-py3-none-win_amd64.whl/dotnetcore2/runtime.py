...
__version__ = '2.1.9'   # {major dotnet version}.{minor dotnet version}.{revision}
...
def ensure_dependencies() -> Optional[str]:
    ...
    with _FileLock(deps_lock_path, raise_on_timeout=timeout_exception):
        ...
        # Now that we have a lock on the deps dir, remove any previous state and download deps.
