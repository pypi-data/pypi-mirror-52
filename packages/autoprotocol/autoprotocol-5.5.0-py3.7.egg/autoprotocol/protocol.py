...
class Protocol(object):
    ...
    def sonicate(self, wells, duration=None, frequency=None,
        ...
        .. code-block:: python
            ...
            p.sonicate(sample_plate, mode="thermal", temperature="160:celsius")
        ...
        RuntimeError
            If container type does not have `sonicate` capability.
        ...
        # mode params per mode type
        # set defaults for modes
        return self._append_and_return(Sonicate(wells, duration, frequency,
                                                temperature, mode,
                                                mode_params))
