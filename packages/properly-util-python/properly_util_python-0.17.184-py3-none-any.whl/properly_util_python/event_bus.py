...
class ProperlyEvents(str, Enum):
    ...
    COMPLETED_OFFER = 'completedOffer' # See note below, expected to be gone before 2019 10 15
    STAGE_CHANGED_OFFER = 'stageChangedOffer'
    USER_ENTERED_ALL_OFFER_INFO = 'userEnteredAllOfferInfo'
    # NOTE: this ^ will replace COMPLETED OFFER, but change is being made in
    # multiple steps to avoid coordinated merges.
