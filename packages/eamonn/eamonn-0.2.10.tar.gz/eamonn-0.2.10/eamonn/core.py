...
class eamonn():
    ...
    def u2f(url, path, headers=""):
        ...
        content = requests.get(url, headers=f2h(headers), stream=True, verify=False, timeout=60).content
    ...
    # 图片二值化
    @staticmethod
    def ib_pict(from_path,go_path,threshold=200):
        from PIL import Image
        from io import BytesIO
