...
urlpatterns = [
    ...
    url(r'^jsi18n/$', last_modified(lambda req, **kw: last_modified_date)(JavaScriptCatalog.as_view()), js_info_dict, name='javascript-catalog'),
]
...
if settings.DJANGO_SSO_BACKEND_ENABLED:
    urlpatterns += [
        ...
        # url(r'^api/v1/groups/', include('pai_sso.core.apps.groups.urls', namespace='groups')),
        # url(r'^api/v1/profiles/', include('pai_sso.core.apps.profiles.urls', namespace='profiles')),
        # url(r'^api/v1/services/', include('pai_sso.core.apps.services.urls', namespace='services')),
        # url(r'^api/v1/passepartout/', include('pai_sso.core.apps.passepartout.urls', namespace='passepartout')),
...
if settings.DJANGO_SSO_APP_ENABLED:
    from pai_sso.app.profiles.urls import urlpatterns as profiles_urls
    sso_auth_urlpatterns += [
