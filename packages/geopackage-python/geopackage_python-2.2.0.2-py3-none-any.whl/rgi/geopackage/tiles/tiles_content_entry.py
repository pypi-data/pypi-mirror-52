...
TILES_DATA_TYPE = "tiles"


class TilesContentEntry(ContentEntry):
    """
    Tiles Content: an object representation of an tiles type entry in the GeoPackage Contents table_
    """
    ...
    def __init__(self,
        ...
        :type srs_id: int
        """
        super(TilesContentEntry, self).__init__(table_name=table_name,
