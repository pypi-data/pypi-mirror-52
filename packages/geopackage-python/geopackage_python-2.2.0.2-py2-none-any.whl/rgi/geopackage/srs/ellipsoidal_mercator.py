...
from rgi.geopackage.srs.abstract_mercator import AbstractMercator
...
class EllipsoidalMercator(AbstractMercator):
    ...
    srs_definition = """PROJCRS["WGS 84 / World Mercator",
    BASEGEODCRS["WGS 84",
    ...
    srs_description = "Euro-centric view of world excluding polar areas for very small scale mapping"
