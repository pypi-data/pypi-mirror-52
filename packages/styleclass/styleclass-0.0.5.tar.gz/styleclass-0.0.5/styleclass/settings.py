...
STYLES = [
    'acm-sig-proceedings', 'american-chemical-society',
    'american-chemical-society-with-titles', 'american-institute-of-physics',
    'american-sociological-association', 'apa', 'bmc-bioinformatics',
    'chicago-author-date', 'elsevier-without-titles', 'elsevier-with-titles',
    'harvard3', 'ieee', 'iso690-author-date-en', 'modern-language-association',
    'springer-basic-author-date', 'springer-lecture-notes-in-computer-science',
    'vancouver'
]
...
REGEX_REMOVE = [
    'doi\:.*', 'DOI .*', 'Available at:.*', 'Crossref. Web.',
    '[^ ]*doi\.org/10\.[^ ]*', 'Retrieved.*', 'Available from.*',
    '\[Internet\]', '\[online\]'
]
...
REGEX_MONTH_REMOVE = {
    ...
    r'(?<![a-zA-Z])' + MONTH_ABBR_PATTERN + '\. (' + YEAR_PATTERN + ')\.':
    r'\1.',
