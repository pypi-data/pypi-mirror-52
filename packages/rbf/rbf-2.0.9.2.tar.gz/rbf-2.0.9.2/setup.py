...
setup(
    name='rbf',
    version=VERSION,
    description="Robot Framework test library for automation of Web, Mobile, REST APIs, SOAP Services, zOS, FTP, DB, Desktop Applications",
