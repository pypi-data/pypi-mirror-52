...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.0.1-alpha.1568399335+g9e009aa9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.0.1-alpha.1568399335+g9e009aa9`
                """)
            else:
                raise
