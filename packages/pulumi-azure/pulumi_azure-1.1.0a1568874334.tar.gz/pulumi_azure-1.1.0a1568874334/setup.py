...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.1.0-alpha.1568874334+g4ce7c4dc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.1.0-alpha.1568874334+g4ce7c4dc`
                """)
            else:
                raise
