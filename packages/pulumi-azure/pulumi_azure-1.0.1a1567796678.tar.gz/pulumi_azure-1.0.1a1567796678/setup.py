...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.0.1-alpha.1567796678+g9d1464e7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.0.1-alpha.1567796678+g9d1464e7`
                """)
            else:
                raise
