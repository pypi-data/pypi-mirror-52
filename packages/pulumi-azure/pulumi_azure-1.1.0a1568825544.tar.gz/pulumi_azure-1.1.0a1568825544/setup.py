...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.1.0-alpha.1568825544+g4a53c65a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.1.0-alpha.1568825544+g4a53c65a`
                """)
            else:
                raise
