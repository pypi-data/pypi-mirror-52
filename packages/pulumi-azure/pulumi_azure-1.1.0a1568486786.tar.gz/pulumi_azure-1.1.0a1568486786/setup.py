...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.1.0-alpha.1568486786+g99621bcc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.1.0-alpha.1568486786+g99621bcc`
                """)
            else:
                raise
