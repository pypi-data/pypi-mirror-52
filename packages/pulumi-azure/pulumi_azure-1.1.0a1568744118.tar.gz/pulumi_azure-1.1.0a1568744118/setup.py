...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.1.0-alpha.1568744118+ge9e194f4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.1.0-alpha.1568744118+ge9e194f4`
                """)
            else:
                raise
