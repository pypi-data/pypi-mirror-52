...
from polarion_tools_common import utils as doc_utils
...
def get_raw_docstring(item):
    ...
    docstring = ""
    try:
        docstring = doc_utils.get_unicode_str(item.function.__doc__)
...
def process_json_data(session, items):
