...
from flask_rip.representations.json import output_json
from flask_rip.utils import http_status_message, unpack, OrderedDict
...
class Api(object):
    ...
    def _deferred_blueprint_init(self, setup_state):
        ...
        When a :class:`flask_rip.Api` object is initialized with a blueprint,
    ...
    def resource(self, *urls, **kwargs):
        """Wraps a :class:`~flask_rip.Resource` class, adding it to the
        api. Parameters are the same as :meth:`~flask_rip.Api.add_resource`.
...
class Resource(MethodView):
    ...
    :meth:`~flask_rip.Api.add_resource` for details.
    """
