...
setuptools.setup(
    name="dscyd",                                     # 包的分发名称，使用字母、数字、_、-
    version="0.0.3",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="dushanchen",                                       # 作者名字
    author_email="575678405@qq.com",                      # 作者邮箱
    description="Some utils for web development",                            # 包的简介描述
    ...
    url="https://github.com/dushanchen/dsc.git",                              # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
