...
class BaseReporter:
    ...
    * ``self.translator`` - report localization
    ...
    def __init__(self, logger, reports_dir, templates_dir, locale = 'en', timezone = 'UTC'):
        """
        ...
        self.translations_dir = os.path.join(self.templates_dir, 'translations')
    ...
    def translator(self):
        ...
        if self.locale not in self.translations:
            try:
                self.translations[self.locale] = gettext.translation(
                    'messages',
