...
class TestMentatGeoipEnricherPlugin(MentatEnricherPluginTestCase):
    ...
    def test_01_setup(self):
        ...
        mapplication.assert_has_calls([
            call.logger.info("Initialized '%s' enricher plugin: %s", 'GeoipEnricherPlugin', "{'asn': '/var/opt/opensourcedbs/GeoLite2-ASN.mmdb',\n 'city': '/var/opt/opensourcedbs/GeoLite2-City.mmdb',\n 'country': None}")
        ])
