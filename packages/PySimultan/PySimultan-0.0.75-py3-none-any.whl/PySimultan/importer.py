...
from PySimultan.geo_functions import print_status, convert_coordinate_system
    ...
    def parse_volumes(self):
        ...
        for data in self.volumes_data:
            ...
            for face_id in face_ids:
                zone_faces.append(next((x for x in self.faces.instances if x.ID == face_id), None))
