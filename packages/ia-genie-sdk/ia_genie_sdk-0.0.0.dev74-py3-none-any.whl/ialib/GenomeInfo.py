...
#        self.agent_genome = self.topology['elements']['nodes']
    ...
    def getActionManipulatives(self):
        return self.action_ids
    
    def getPrimitiveMap(self):
        return self.primitive_map
    
    def getManipulativeMap(self):
    ...
    def display(self):
        return Cytoscape(data=self.topology, visual_style=self.style_obj, layout={'height': '500px'}, background='white')
