...
class Invitation(object):
    ...
    def __init__(self, id=None, client_id=None, redirect_uri=None, cloud_name=None, cloud_role=None, project_name=None, project_role=None, email=None, status=None, sender_provider_sub=None):  # noqa: E501
    ...
    def cloud_name(self, cloud_name):
        ...
        if cloud_name is not None and len(cloud_name) < 1:
