...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "http://127.0.0.1:61622"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("gu_rest_api")
            ...
            'serviceToken':
                {
                    ...
                    'in': 'header',
                    'key': 'X-GU-APIKEY',
                    'value': self.get_api_key_with_prefix('X-GU-APIKEY')
                },
            'systemName':
                {
                    'type': 'api_key',
                    'in': 'header',
                    'key': 'X-GU-APPNAME',
                    'value': self.get_api_key_with_prefix('X-GU-APPNAME')
                },
        }
