...
class STEPS():
    def __init__(self, is_default=False, log_file="", enable_parallel=False):
        global STEPS_LIB

        if 'STEPS_LIB' not in globals():
            STEPS_LIB = pylibsteps.load_library(enable_parallel)
    ...
    def check_database(self):
        global STEPS_LIB
        STEPS_LIB.api_check_database(self.toolkit_index)
    ...
    def get_generator_related_model_name(self, generator, model_type):
        ...
        return self.__get_string_from_c_char_p(STEPS_LIB.api_get_generator_related_model_name(ibus, ickt, model_type, self.toolkit_index))
    ...
    def get_wt_generator_related_model_name(self, generator, model_type):
        ...
        ickt = self.__get_c_char_p_of_string(ickt)
        model_type = self.__get_c_char_p_of_string(model_type)
        return self.__get_string_from_c_char_p(STEPS_LIB.api_get_wt_generator_related_model_name(ibus, ickt, model_type, self.toolkit_index))
    ...
    def get_pv_unit_related_model_name(self, pv_unit, model_type):
        ...
        ickt = self.__get_c_char_p_of_string(ickt)
        model_type = self.__get_c_char_p_of_string(model_type)
        return self.__get_string_from_c_char_p(STEPS_LIB.api_get_pv_unit_related_model_name(ibus, ickt, model_type, self.toolkit_index))
    ...
    def get_load_related_model_name(self, load, model_type):
        ...
        ickt = self.__get_c_char_p_of_string(ickt)
        model_type = self.__get_c_char_p_of_string(model_type)
        return self.__get_string_from_c_char_p(STEPS_LIB.api_get_load_related_model_name(ibus, ickt, model_type, self.toolkit_index))
    ...
    def get_line_related_model_name(self, line, model_type):
        ...
        ickt = self.__get_c_char_p_of_string(ickt)
        model_type = self.__get_c_char_p_of_string(model_type)
        return self.__get_string_from_c_char_p(STEPS_LIB.api_get_line_related_model_name(ibus, jbus, ickt, model_type, self.toolkit_index))
    ...
    def get_hvdc_related_model_name(self, hvdc, model_type):
        ...
        ickt = self.__get_c_char_p_of_string(ickt)
        model_type = self.__get_c_char_p_of_string(model_type)
        return self.__get_string_from_c_char_p(STEPS_LIB.api_get_hvdc_related_model_name(ibus, jbus, ickt, model_type, self.toolkit_index))
    ...
    def get_generator_power_reference_in_MW(self, generator):
        ...
        ibus, ickt = self.__extract_single_bus_device_id(generator)
        ickt = self.__get_c_char_p_of_string(ickt)
        return STEPS_LIB.api_get_generator_power_reference_in_MW(ibus, ickt, self.toolkit_index)
    ...
    def set_generator_power_reference_in_MW(self, generator, value):
        ...
        ibus, ickt = self.__extract_single_bus_device_id(generator)
        ickt = self.__get_c_char_p_of_string(ickt)
        return STEPS_LIB.api_set_generator_power_reference_in_MW(ibus, ickt, value, self.toolkit_index)