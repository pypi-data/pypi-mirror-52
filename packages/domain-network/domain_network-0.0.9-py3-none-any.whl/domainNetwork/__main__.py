...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='specifies if the tweets from activists should be selected'
    )
    return parser
...
def main():
    ...
    if args.network_only:
        ...
        if (args.activists_file_name is not None):
            df_tweets_origin = get_tweets_of_activists(df_tweets_origin, args.activists_file_name)
