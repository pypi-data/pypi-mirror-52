...
from django2_manager_cache.cache_manager import (
    CacheManager,
    CachingQuerySet
)
from django2_manager_cache.mixins import CacheKeyMixin
...
class CacheManagerTests(TestCase):
    """
    Tests for django2_manager_cache.cache_manager.CacheManager
    """
...
class CachingQuerySetTests(TestCase):
    """
    Tests for django2_manager_cache.cache_manager.CachingQuerySet
    """    
