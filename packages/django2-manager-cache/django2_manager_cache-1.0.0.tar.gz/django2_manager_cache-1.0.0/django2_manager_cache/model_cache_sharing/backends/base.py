...
class BaseSharing(object):
    ...
    def share_model_cache_info(self, model_cache_info, **kwargs):
        ...
        ~~~~~~~~~~
        model_cache_info
            A named tuple of type django2_manager_cache.model_cache_sharing.types.ModelCacheInfo
        """
    ...
    def retrieve_model_cache_info(self, key, **kwargs):
        ...
        Returns
        ~~~~~~~
        model_cache_info - A named tuple of type django2_manager_cache.model_cache_sharing.types.ModelCacheInfo
