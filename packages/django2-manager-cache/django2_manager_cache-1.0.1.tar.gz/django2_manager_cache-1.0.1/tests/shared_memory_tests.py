...
from django2_manager_cache.model_cache_sharing import model_cache_backend
from django2_manager_cache.model_cache_sharing.types import ModelCacheInfo

class SharedMemoryTests(TestCase):
    """
    Tests for django2_manager_cache.model_cache_sharing.backends.shared_memory.SharedMemory
    """
