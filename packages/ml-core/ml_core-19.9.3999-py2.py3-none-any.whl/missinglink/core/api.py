...
class _HttpCaller(object):
    ...
    def __raise_excpetion(self, error_message):
    ...
    def __refresh_token_id_token(self):
        ...
        try:
            ...
            self.__raise_excpetion('Authorization failed, try running "ml auth init" again')
    ...
    def __api_call(self, http_method_name, url, data):
        ...
        while True:
            ...
            if r.status_code == 401:
                ...
                self.__raise_excpetion('failed to refresh the token, rerun auth init again')
