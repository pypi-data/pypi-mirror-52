...
def increment_version():
    if here!='/Users/Ryan/PycharmProjects/QuickPython':
        version_path=os.path.join(here,'rp/version')
        i=int(text_file_to_string(version_path))
        return i
    i=int(text_file_to_string('version'))
    i+=1
    string_to_text_file(os.path.join(here,'rp/version'),str(i))#This file auto-increments the version for me
