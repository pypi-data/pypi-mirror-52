...
if __name__ == "EyeShapeDesigner":
    ...
    offImage = Tk.PhotoImage(file)
    file=os.path.join(dir, '/Images/picohlogo.gif')
    logo = Tk.PhotoImage(file)
    file=os.path.join(dir, '/Images/picohlogoOn.gif')
    logoOn = Tk.PhotoImage(file)
    #spacer = Tk.PhotoImage(file="./Images/onsmaller.gif")
    file=os.path.join(dir, '/Images/movedown.gif')
    copyDown = Tk.PhotoImage(file)
    file=os.path.join(dir, '/Images/moveright.gif')
    copyRight = Tk.PhotoImage(file)
    file=os.path.join(dir, '/Images/picohGraphic.gif')
    picohGraphic = Tk.PhotoImage(file)
