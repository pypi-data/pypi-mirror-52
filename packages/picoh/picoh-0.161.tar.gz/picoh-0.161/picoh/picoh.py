...
if not path.exists('picohData/ohbot.obe'):
    if platform.system() == "Windows":
        os.popen('copy ' + os.path.join(dir, 'ohbot.obe') +' picohData/ohbot.obe')
    if platform.system() == "Darwin" or platform.system() == "Linux":
        os.popen('cp ' + os.path.join(dir, 'ohbot.obe') +' picohData/ohbot.obe')

if not path.exists('picohData/picohspeech.wav'):
    if platform.system() == "Windows":
        os.popen('copy ' + os.path.join(dir, 'picohspeech.wav') +' picohData/picohspeech.wav')
    if platform.system() == "Darwin" or platform.system() == "Linux":
        os.popen('cp ' + os.path.join(dir, 'picohspeech.wav') +' picohData/picohspeech.wav')
