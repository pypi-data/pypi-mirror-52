...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-redshift", "1.8.0", __name__, "aws-redshift@1.8.0.jsii.tgz")
...
class CfnClusterParameterGroupProps():
    ...
    @property
    def parameters(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnClusterParameterGroup.ParameterProperty"]]]]]:
        """``AWS::Redshift::ClusterParameterGroup.Parameters``.
