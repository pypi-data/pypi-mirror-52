...
from django_sso_app.core.common import DJANGO_SSO_REQUIRED_USER_FIELDS, DJANGO_SSO_REQUIRED_PROFILE_FIELDS
...
class ProfileSerializer(AbsoluteUrlSerializer):
    ...
    class Meta:
        ...
        read_only_fields = (
            ...
            'sso_id', 'sso_rev',
            'username', 'email',
            'user') + DJANGO_SSO_REQUIRED_USER_FIELDS
        fields = read_only_fields + DJANGO_SSO_REQUIRED_PROFILE_FIELDS
