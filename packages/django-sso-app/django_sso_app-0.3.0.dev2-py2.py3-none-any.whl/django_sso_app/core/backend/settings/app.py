...
from django_sso_app.app.utils import get_core_apps
...
DRF_DEFAULT_AUTHENTICATION_CLASSES = ['django_sso_app.app.authentication.DjangoSsoAppAuthentication'] + DRF_DEFAULT_AUTHENTICATION_CLASSES
...
TEMPLATES[0]['OPTIONS']['context_processors'] += [
    'django_sso_app.app.context_processors.sso_cookie_domain',
]
...
if DJANGO_SSO_APP_ENABLED:
    MIDDLEWARE += [
        'django_sso_app.app.middleware.DjangoSsoAppMiddleware',
    ]
