...
from django_sso_app.core.settings import *
from django_sso_app.core.backend.utils import get_core_apps
...
INSTALLED_APPS += ['django_sso_app.core.apps.frontend']
...
DRF_DEFAULT_AUTHENTICATION_CLASSES = DRF_DEFAULT_AUTHENTICATION_CLASSES + [
    'django_sso_app.core.apps.users.authentication.UsersAuthentication',
]
...
ACCOUNT_ADAPTER='django_sso_app.core.backend.adapter.UserAdapter'
...
ACCOUNT_FORMS = {
    'signup': 'django_sso_app.core.backend.forms.SignupForm'
}
...
REST_AUTH_SERIALIZERS = {
    'LOGIN_SERIALIZER': 'django_sso_app.core.backend.serializers.LoginSerializer',
    'USER_DETAILS_SERIALIZER' : 'django_sso_app.core.apps.users.serializers.UserSerializer',
    'PASSWORD_RESET_SERIALIZER': 'django_sso_app.core.backend.serializers.PasswordResetSerializer'
}

REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'django_sso_app.core.backend.serializers.RegisterSerializer',
}

JWT_AUTH = {
    'JWT_AUTH_COOKIE': 'jwt',

    'JWT_PAYLOAD_HANDLER': 'django_sso_app.core.backend.handlers.jwt_payload_handler',
