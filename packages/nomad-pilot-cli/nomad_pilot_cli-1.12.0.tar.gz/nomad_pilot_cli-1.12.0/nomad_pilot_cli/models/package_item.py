...
class PackageItem(object):
    ...
    def __init__(self, name=None, name_cn=None, barcode=None, sku_number=None, quantity=None, price=None, brand=None, quantity_uom=None, hs_code=None, country_of_origin=None, goldjet=None, gross_weight=None, net_weight=None, customs_unit_code=None, customs_filing_id=None, spec=None, model=None):  # noqa: E501
    ...
    def customs_unit_code(self):
        ...
        The unit code of current sku for customs purpose., both Chinese or number are ok.  # noqa: E501
