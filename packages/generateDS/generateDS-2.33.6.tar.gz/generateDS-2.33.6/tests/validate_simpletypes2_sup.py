    ...
    def validate_integer_range_1_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, int):
                warnings_.warn('Value (%(value)s) is not of the correct base simple type (int)' % {"value": value, })
                return
            if value <= 4:
    ...
    def validate_pattern_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_pattern_st_patterns_, ))
    ...
    def validate_token_enum_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if value not in enumerations:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on token_enum_st' % {"value" : encode_str_2_3(value)} )
    ...
    def validate_min_max_length_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, str):
                ...
                return
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on min_max_length_st' % {"value" : encode_str_2_3(value)} )
            if len(value) < 10:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on min_max_length_st' % {"value" : encode_str_2_3(value)} )
    def validate_length_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, str):
                ...
                return
            if len(value) != 10:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on length_st' % {"value" : encode_str_2_3(value)} )
    def validate_totalDigits_st(self, value):
        # Validate type totalDigits_st, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, decimal_.Decimal):
                warnings_.warn('Value (%(value)s) is not of the correct base simple type (decimal_.Decimal)' % {"value": value, })
                return
            if len(str(value)) >= 15:
                warnings_.warn('Value "%(value)s" does not match xsd totalDigits restriction on totalDigits_st' % {"value" : value} )
    def validate_date_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, datetime_.date):
                warnings_.warn('Value (%(value)s) is not of the correct base simple type (datetime_.date)' % {"value": value, })
                return
    ...
    def validate_time_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, datetime_.time):
                warnings_.warn('Value (%(value)s) is not of the correct base simple type (datetime_.time)' % {"value": value, })
                return
    ...
    def validate_datetime_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, datetime_.datetime):
                warnings_.warn('Value (%(value)s) is not of the correct base simple type (datetime_.datetime)' % {"value": value, })
                return
    ...
    def validate_vbar_pattern_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_vbar_pattern_st_patterns_, ))
    ...
    def validate_unicode_pattern_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_unicode_pattern_st_patterns_, ))
    ...
    def validate_integer_range_A_0_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, int):
                ...
                return
            if value < 4:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_0_st' % {"value" : value} )
            if value > 6:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on integer_range_A_0_st' % {"value" : value} )
            if value < 2:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_0_st' % {"value" : value} )
            if value > 8:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on integer_range_A_0_st' % {"value" : value} )
    ...
    def validate_integer_range_A_1_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, int):
                ...
                return
            if value < 2:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_1_st' % {"value" : value} )
            if value > 8:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on integer_range_A_1_st' % {"value" : value} )
            if value < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_1_st' % {"value" : value} )
            if value > 10:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on integer_range_A_1_st' % {"value" : value} )
    def validate_integer_range_A_2_st(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, int):
                ...
                return
            if value < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on integer_range_A_2_st' % {"value" : value} )
            if value > 10:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on integer_range_A_2_st' % {"value" : value} )
    def validate_anonymous_float_valueType(self, value):
        # Validate type anonymous_float_valueType, a restriction on xs:float.
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, float):
                warnings_.warn('Value (%(value)s) is not of the correct base simple type (float)' % {"value": value, })
                return
            if value < 1.1:
    ...
    def validate_simpleTwoElementTwoType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, str):
                ...
                return
            if len(value) > 24:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on simpleTwoElementTwoType' % {"value" : encode_str_2_3(value)} )
            if len(value) < 12:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on simpleTwoElementTwoType' % {"value" : encode_str_2_3(value)} )
    def hasContent_(self):
        if (
