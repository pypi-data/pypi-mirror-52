    ...
    def validate_SKU(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_SKU_patterns_, ))
    ...
    def validate_USState(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if value not in enumerations:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on USState' % {"value" : encode_str_2_3(value)} )
    def hasContent_(self):
        if (
    ...
    def validate_UKPostcode(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not isinstance(value, str):
                ...
                return
            if len(value) > 24:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on UKPostcode' % {"value" : encode_str_2_3(value)} )
    def hasContent_(self):
        if (
