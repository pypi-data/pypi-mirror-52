...
class RestClient(object):
    ...
    def update(
            self, subscription_id, resource_group_name, workspace_name, id, api_version=None, dto=None, custom_headers=None, raw=False, **operation_config):
        """Update.
    ...
    def schedule_run(
            self, subscription_id, resource_group_name, workspace_name, id, api_version=None, custom_headers=None, raw=False, **operation_config):
        """CreateScheduleRun.
    ...
    def publish_metrics(
        ...
        :type id: str
        :param dto:
        :type dto: ~_restclient.models.TelemetryMetricsDto
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        """
        # Construct URL
        url = self.publish_metrics.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        # Construct body
        if dto is not None:
            body_content = self._serialize.body(dto, 'TelemetryMetricsDto')
        else:
            body_content = None
        ...
        if raw:
            ...
            return client_raw_response
    publish_metrics.metadata = {'url': '/datadrift/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datadrifts/{id}/metrics'}

    def get_data_profiles(
            self, subscription_id, resource_group_name, workspace_name, service_name=None, model_name=None, model_version=None, start_date_string=None, end_date_string=None, api_version=None, custom_headers=None, raw=False, **operation_config):
        """GetDataProfiles.
    ...
    def schedule_msd_run(
            self, subscription_id, resource_group_name, workspace_name, api_version=None, custom_headers=None, raw=False, **operation_config):
        """CreateMSDScheduleRun.
        ...
        """
        # Construct URL
        url = self.schedule_msd_run.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str')
        ...
        return deserialized
    schedule_msd_run.metadata = {'url': '/datadrift/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/modelservingdataset/schedulerun'}
