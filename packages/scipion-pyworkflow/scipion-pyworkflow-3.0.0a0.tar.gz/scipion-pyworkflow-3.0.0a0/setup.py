...
setup(
    ...
    name='scipion-pyworkflow',  # Required
    ...
    description='Simple workflow platform used in scientific applications, '
                'initially developed within the Scipion framework for image '
                'processing in Electron Microscopy.',  # Required
    ...
    url='https://github.com/scipion-em/scipion-pyworkflow',  # Optional
