...
latex_documents = [
    (master_doc, 'BT-FLOR.tex', u'BT-FLOR Documentation',
...
man_pages = [
    (master_doc, 'bt-flor', u'BT-FLOR Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BT-FLOR', u'BT-FLOR Documentation',
     author, 'BT-FLOR', 'One line description of project.',
     'Miscellaneous'),
]
