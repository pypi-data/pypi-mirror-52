...
def ddicParser(parser):
    ...
    parser.add_argument('-spm',
                        ...
                        default=2,
                        dest='SUBPIXEL_MARGIN',
                        help="Subpixel margin for subpixel interpolation on top of label dilate. Default = 2px")
    ...
    #  sub pixel margin must be at least as big as label dilate
        ...
        #print("spam-ddic: Warning, \"label dilate\" is less than \"sub pixel margin\", overriding")
...
def regularStrainsCalcParser(parser):
    ...
    parser.add_argument('-tif',
                        ...
                        action="store_true",
                        dest='TIFF',
                        help='Activate TIFFoutput format. Default = True')
...
def discreteStrainsCalcParser(parser):
    ...
    # Output file name prefix
    if args.PREFIX is None:
        args.PREFIX = os.path.splitext(os.path.basename(args.inFile.name))[0] + "-largeStrains"
...
def moveGrainsParser(parser):
    ...
    parser.add_argument('-pre',
                        ...
                        default=None,
                        dest='PREFIX',
                        help='Prefix for output TIFFfile (without extension). Default is basename of input file')
