...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v0.18.14-dev.1568406595+gb80736c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v0.18.14-dev.1568406595+gb80736c`
                """)
            else:
                raise
