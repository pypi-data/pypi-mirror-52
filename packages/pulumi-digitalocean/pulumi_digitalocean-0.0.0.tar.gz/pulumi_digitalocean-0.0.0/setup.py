...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v0.18.14-alpha.1568485513+gab6adab'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v0.18.14-alpha.1568485513+gab6adab`
                """)
            else:
                raise
