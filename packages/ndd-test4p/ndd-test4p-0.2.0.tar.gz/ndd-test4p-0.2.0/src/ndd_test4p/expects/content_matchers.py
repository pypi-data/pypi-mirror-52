...
class have_same_content_as(Matcher):  # pylint: disable=invalid-name
    ...
    def _match(self, subject):
        """
        Args:
            subject (pathlib.PosixPath): The file path of the actual content to compare.
...
class have_same_content_recursively_as(Matcher):  # pylint: disable=invalid-name
    ...
    def __init__(self, expected_directory_path: PosixPath):
        """
        Args:
            expected_directory_path (pathlib.PosixPath): The path of the directory with the expected content to compare.
        """
    ...
    def _match(self, subject):
        """
        Args:
            subject (pathlib.PosixPath): The path of the directory with the actual content to compare.
    ...
    @staticmethod
    def _to_bullet_list(file_paths: List[PosixPath]) -> str:
        if file_paths:
