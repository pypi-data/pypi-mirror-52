...
class TestAbstractTest(AbstractTest):
    ...
    @pytest.fixture()
    def tests_directory_path(self) -> PosixPath:
        return PosixPath(__file__).parent.parent.parent

    @pytest.fixture()
    def test_case_directory_path(self, tests_directory_path: PosixPath) -> PosixPath:
    ...
    def test_test_file_path(self, test_case_directory_path: PosixPath):
    ...
    def test_test_directory_path(self, test_case_directory_path: PosixPath):
    ...
    def test_test_data_directory_path(self, test_case_directory_path: PosixPath):
    ...
    def test_test_data_subdirectory_path(self, test_case_directory_path: PosixPath):
    ...
    def test_test_data_file_path(self, test_case_directory_path: PosixPath):
    ...
    def test_test_data_file_paths(self, test_case_directory_path: PosixPath):
        expected_paths = [
