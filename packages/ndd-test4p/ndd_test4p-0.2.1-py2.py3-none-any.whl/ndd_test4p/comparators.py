...
class DirectoryContentComparator:
    ...
    def __init__(self, actual_directory_path: PosixPath, expected_directory_path: PosixPath, fail_fast: bool = True):
        """
        Args:
            actual_directory_path (pathlib.PosixPath): The path of the actual directory to compare.
            expected_directory_path (pathlib.PosixPath): The path of the expected directory to compare.
    ...
    @property
    def actual_only_files(self) -> List[PosixPath]:
        """
        Returns:
            pathlib.PosixPath[]: The paths of the files which appear in the actual directory only.
        """
        return self._actual_only_files

    @property
    def expected_only_files(self) -> List[PosixPath]:
        """
        Returns:
            pathlib.PosixPath[]: The paths of the files which appear in the expected directory only.
        """
        return self._expected_only_files

    @property
    def different_files(self) -> List[PosixPath]:
        """
        Returns:
            pathlib.PosixPath[]: The paths of the files which are different.
        """
        return self._different_files

    @property
    def funny_files(self) -> List[PosixPath]:
        """
        Returns:
            pathlib.PosixPath[]: The paths of the files which couldn't be compared.
        """
        return self._funny_files

    def _are_contents_equal_complete(self, directory_1: PosixPath, directory_2: PosixPath) -> bool:
        """
        Recursively compare the contents of two directories, taking into account the content of the files.

        Args:
            directory_1 (pathlib.PosixPath): The path of the first directory to compare.
            directory_2 (pathlib.PosixPath): The path of the second directory to compare.
    ...
    def _are_contents_equal_fast(self, directory_1: PosixPath, directory_2: PosixPath) -> bool:
        """
        Recursively compare the contents of two directories, taking into account the content of the files.
