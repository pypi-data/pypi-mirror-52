...
class Email:
    def __init__(self, host='smtp.gmail.com', port=587, use_tls=True, username=None, password=None, subject=None, From=None, to=None, cc=None, bcc=None):
        ...
        self.message['From'] = From or self.username
