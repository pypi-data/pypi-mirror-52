...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'sakuracloud', '0.0.1', '--server', 'https://github.com/sacloud/pulumi-sakuracloud/releases/download/0.0.1'])
        except OSError as error:
            if error.errno == errno.ENOENT:
                print("""
                There was an error installing the sakuracloud resource provider plugin.
...
setup(name='pulumi_sakuracloud',
      ...
      url='https://github.com/sacloud/pulumi-sakuracloud',
      project_urls={
