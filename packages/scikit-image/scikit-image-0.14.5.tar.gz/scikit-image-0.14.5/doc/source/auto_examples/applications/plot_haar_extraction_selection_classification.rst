...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Computing the full feature set took 114.695s, plus 1.029s training, for an AUC of 1.00. Computing the restricted feature set took 0.126s, plus 0.787s training, for an AUC of 1.00.


**Total running time of the script:** ( 1 minutes  58.982 seconds)
