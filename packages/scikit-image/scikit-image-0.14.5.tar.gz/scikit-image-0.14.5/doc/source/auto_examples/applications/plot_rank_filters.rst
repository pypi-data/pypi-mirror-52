.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_applications_plot_rank_filters.py>` to download the full example code
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  31.982 seconds)
