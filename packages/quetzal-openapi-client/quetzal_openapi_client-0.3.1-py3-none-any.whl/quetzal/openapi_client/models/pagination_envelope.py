...
class PaginationEnvelope(object):
    ...
    @property
    def results(self):
        """Gets the results of this PaginationEnvelope.  # noqa: E501

        Array of objects with the results of the current page  # noqa: E501

        :return: The results of this PaginationEnvelope.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def results(self, results):
        """Sets the results of this PaginationEnvelope.

        Array of objects with the results of the current page  # noqa: E501

        :param results: The results of this PaginationEnvelope.  # noqa: E501
        :type: list[object]
        """
        if results is None:
