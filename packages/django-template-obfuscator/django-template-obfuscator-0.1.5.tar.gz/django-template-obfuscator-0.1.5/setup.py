...
def get_version(*file_paths):
    """Retrieves the version from django_template_obfuscator/__init__.py"""
...
version = get_version("django_template_obfuscator", "__init__.py")
...
setup(
    ...
    test_suite='django_template_obfuscator.run',
)
