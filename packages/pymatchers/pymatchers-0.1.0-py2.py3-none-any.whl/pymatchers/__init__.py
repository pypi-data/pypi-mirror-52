...
import logging
from pymatchers.__NlpParser import match_name
from pymatchers.__Detector import Detectors
from pymatchers.__Html2Json import PageParser
from pymatchers.__RegularParser import commonParse,ReverseParser,ContentParser
...
class Matchers(object):
    def __init__(self):
        # logging.info("Let's start pymatchers")
        pass
