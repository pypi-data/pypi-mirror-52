...
class SupportedModelNames:
    ...
    SupportedClassificationModelList = [
        ...
        ModelName(
            SupportedModels.Classification.NimbusMLAveragedPerceptronClassifier,
        ...
        ModelName(
            SupportedModels.Classification.NimbusMLLinearSVMClassifier,
        ...
        ModelName(
            SupportedModels.Classification.CatBoostClassifier,
            LegacyModelNames.ClassificationLegacyModelNames.CatBoostClassifier,
            ModelClassNames.ClassificationModelClassNames.CatBoostClassifier),
        ModelName(
            SupportedModels.Classification.
            GradientBoosting,
    ...
    SupportedRegressionModelList = [
        ...
        ModelName(
            SupportedModels.Regression.NimbusMLFastLinearRegressor,
        ...
        ModelName(
            SupportedModels.Regression.NimbusMLOnlineGradientDescentRegressor,
        ...
        ModelName(
            SupportedModels.Regression.CatBoostRegressor,
            LegacyModelNames.RegressionLegacyModelNames.CatBoostRegressor,
            ModelClassNames.RegressionModelClassNames.CatBoostRegressor),
        ModelName(
            SupportedModels.Regression.
