...
class _RawFeatureSummary:
    ...
    def __init__(self, raw_feature_name: str, type_detected: FeatureType, if_dropped: bool) -> None:
        ...
        self._tranformations = []  # type: List[str]
    ...
    def append_tranformation(self, tranformation: str) -> None:
        self._tranformations.append(tranformation)

    def to_user_friendly_repr(self) -> Dict[str, Optional[Any]]:
        return {_RawFeatureSummaryConstants.RawFeatureName: self._raw_feature_name,
                ...
                _RawFeatureSummaryConstants.Tranformations: self._tranformations}
    ...
    def get_coalesced_raw_feature_featurization_mapping_internal(
        ...
        for raw_feature_transformation_info in raw_feature_featurization_dict.values():
            ...
            if raw_feature_name in temp_summary:
                ...
                coalesced_raw_feature_featurization_mapping.append_tranformation(
