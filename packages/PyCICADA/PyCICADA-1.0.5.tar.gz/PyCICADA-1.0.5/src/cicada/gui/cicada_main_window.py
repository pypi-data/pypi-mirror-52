...
class CicadaMainWindow(QMainWindow):
    ...
    def openWindow(self):
        ...
        self.musketeers_widget = MusketeersWidget(config_handler=self.config_handler, parent=self)
...
class MusketeersWidget(QWidget):
    ...
    def __init__(self, config_handler, parent=None):
        ...
        analysis_overview_widget = AnalysisOverview(parent=parent, config_handler=self.config_handler)
