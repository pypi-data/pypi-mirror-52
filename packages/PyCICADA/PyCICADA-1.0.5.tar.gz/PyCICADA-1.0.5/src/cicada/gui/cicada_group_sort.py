...
class SessionsWidget(QWidget):
    ...
    def __init__(self, config_handler, parent=None, to_analysis_button=None):
    ...
    def more_menu(self):
        ...
        self.otherActionsMenu.addMenu(self.parent.selectGroupMenu)
        self.otherActionsMenu.addAction(self.parent.seeAllGroupAct)
