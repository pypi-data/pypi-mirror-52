...
class AnalysisTreeApp(QWidget):
    ...
    def create_tree_model(self):
        ...
        analysis_class_names = ["CicadaHubsAnalysis", "CicadaConnectivityGraph",
                                "CicadaPsthAnalysis", "CicadaCellsMapAnalysis",
                                "CicadaDisplayRasterAnalysis",
                                "CicadaDeepCinacPredictionAnalysis", "CicadaTimeCorrelationGraphAnalysis",
                                "CicadaSeqGraphAnalysis", "CicadaSeqnmfAnalysis",
                                "CicadaSeqMalvacheAnalysis", "CicadaAssembliesMalvacheAnalysis",
                                "CicadaAssembliesRussoAnalysis", "CicadaSpotDisClustAnalysis",
                                "CicadaAssembliesIcaCsAnalysis", "CicadaAssembliesIcaMpAnalysis",
                                "CicadaAssembliesSvdAnalysis", "CicadaAssembliesSgcAnalysis",
                                "CicadaAssembliesPromaxCsAnalysis", "CicadaAssembliesPromaxMpAnalysis",
                                "CicadaAssembliesGonzalezAnalysis", "CicadaAssembliesTavoniAnalysis",
                                "CicadaAssembliesCoreAnalysis", "CicadaTransientFrequencyAnalysis",
                                "CicadaTransientAmplitudeAnalysis", "CicadaTransientDurationAnalysis",
                                "CicadaCellAssVsIntervalsAnalysis", "CicadaTransientsVsIntervalsAnalysis",
                                "CicadaActivityIntervalsRatioAnalysis"
                                ]
        analysis_instances = []
