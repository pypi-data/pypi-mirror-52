...
class CicadaTransientsVsIntervalsAnalysis(CicadaAnalysis):
    def __init__(self):
        """
        """
        CicadaAnalysis.__init__(self, name="Transients in intervals", family_id="Intervals",
                                short_description="Distribution of transients in intervals")
    ...
    def run_analysis(self, **kwargs):
        ...
        start_time = time()
        print("Transients vs intervals: coming soon...")
