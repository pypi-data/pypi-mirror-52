...
class CicadaSeqMalvacheAnalysis(CicadaAnalysis):
    def __init__(self):
        """
        """
        CicadaAnalysis.__init__(self, name="Malvache's method", family_id="Sequences detection",
                                short_description="Malvache et al. 2016")
    ...
    def run_analysis(self, **kwargs):
        ...
        start_time = time()
        print("Malvache seq solver: coming soon...")
