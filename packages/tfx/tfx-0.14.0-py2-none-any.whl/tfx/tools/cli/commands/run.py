...
def create_run(ctx         , engine      , pipeline_name      , endpoint      ,
               iap_client_id      , namespace      )        :
...
@click.option(
    ...
    type=str,
    help='Kubernetes namespace to connect to the KFP API.')
def terminate_run(ctx         , engine      , run_id      , endpoint      ,
                  iap_client_id      , namespace      )        :
...
@click.option(
    ...
    type=str,
    help='Kubernetes namespace to connect to the KFP API.')
def list_runs(ctx         , engine      , pipeline_name      , endpoint      ,
              iap_client_id      , namespace      )        :
...
@click.option(
    ...
    type=str,
    help='Kubernetes namespace to connect to the KFP API.')
def get_run(ctx         , engine      , pipeline_name      , run_id      ,
            endpoint      , iap_client_id      , namespace      )        :
  """Command definition to stop a run."""
...
@click.option(
    ...
    type=str,
    help='Kubernetes namespace to connect to the KFP API.')
def delete_run(ctx         , engine      , run_id      , endpoint      ,
               iap_client_id      , namespace      )        :
