...
def create_pipeline(ctx         , engine      , pipeline_path      ,
                    package_path      , endpoint      , iap_client_id      ,
                    namespace      )        :
...
@click.option(
    ...
    type=str,
    help='Kubernetes namespace to connect to the KFP API.')
def update_pipeline(ctx         , engine      , pipeline_path      ,
                    package_path      , endpoint      , iap_client_id      ,
                    namespace      )        :
...
@click.option(
    ...
    type=str,
    help='Kubernetes namespace to connect to the KFP API.')
def delete_pipeline(ctx         , engine      , pipeline_name      ,
                    endpoint      , iap_client_id      ,
                    namespace      )        :
...
@click.option(
    ...
    type=str,
    help='Kubernetes namespace to connect to the KFP API.')
def list_pipelines(ctx         , engine      , endpoint      ,
...
@click.option(
    ...
    type=str,
    help='Kubernetes namespace to connect to the KFP API.')
def compile_pipeline(ctx         , engine      , pipeline_path      ,
                     package_path      , endpoint      , iap_client_id      ,
                     namespace      )        :
  """Command definition to create a pipeline."""
