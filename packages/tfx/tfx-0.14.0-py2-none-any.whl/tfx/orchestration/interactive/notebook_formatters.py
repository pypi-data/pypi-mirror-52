...
class NotebookFormatter(object):
  ...
  def __init__(self,
               cls              ,
               attributes             = None,
               title_format                                           = None):  # pylint: disable=g-bare-generic
  ...
  def _extended_getattr(self, obj        , property_name      )          :
  ...
  def render(self,
             obj        ,
             expanded       = True,
             seen_elements                = None)        :  # pylint: disable=g-bare-generic
  ...
  def render_value(self,
                   value        ,
                   seen_elements     )          :  # pylint: disable=g-bare-generic
  ...
  def render_dict(self,
                  obj      ,  # pylint: disable=g-bare-generic
                  seen_elements     )        :  # pylint: disable=g-bare-generic
