...
def create_e2e_components(pipeline_root      , csv_input_location      ,
                          taxi_module_file      )                       :
...
class BaseKubeflowTest(tf.test.TestCase):
  ...
  @classmethod
  def _build_and_push_docker_image(cls, container_image      ):
  ...
  @classmethod
  def _get_mlmd_db_name(cls, pipeline_name      ):
  ...
  def _delete_workflow(self, workflow_name      ):
  ...
  def _run_workflow(self, workflow_file      , workflow_name      ):
  ...
  def _delete_pipeline_output(self, pipeline_name      ):
  ...
  def _delete_pipeline_metadata(self, pipeline_name      ):
  ...
  def _pipeline_root(self, pipeline_name      ):
    return os.path.join(self._test_output_dir, pipeline_name)

  def _create_pipeline(self, pipeline_name      ,
                       components                     ):
  ...
  def _create_dataflow_pipeline(self, pipeline_name      ,
                                components                     ):
  ...
  def _get_kubeflow_metadata_config(self, pipeline_name      
                                   )                                       :
  ...
  def _compile_and_run_pipeline(self, pipeline                       ):
