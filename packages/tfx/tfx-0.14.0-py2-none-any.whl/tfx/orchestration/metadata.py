...
def sqlite_metadata_connection_config(metadata_db_uri      
                                     )                                       :
...
def mysql_metadata_connection_config(host      , port     , database      ,
                                     username      , password      
                                    )                                       :
...
class Metadata(object):
  ...
  def previous_execution(self, input_artifacts                            ,
                         exec_properties                 ,
                         pipeline_info                         ,
                         component_info                          
                        )                 :
  ...
  def search_artifacts(self, artifact_name      , pipeline_name      ,
                       run_id      ,
  ...
  def get_execution_states(self, pipeline_name      ,
                           run_id      )                    :
