...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancingv2-targets", "1.9.0", __name__, "aws-elasticloadbalancingv2-targets@1.9.0.jsii.tgz")
...
__all__ = ["InstanceIdTarget", "IpTarget", "LambdaTarget", "__jsii_assembly__"]
