...
def MarketStart(builder): builder.StartObject(9)
...
def MarketAddSeq(builder, seq): builder.PrependUint32Slot(1, seq, 0)
def MarketAddOwner(builder, owner): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(owner), 0)
def MarketStartOwnerVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddTerms(builder, terms): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(terms), 0)
def MarketAddMeta(builder, meta): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(meta), 0)
def MarketAddMaker(builder, maker): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(maker), 0)
def MarketStartMakerVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddProviderSecurity(builder, providerSecurity): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(providerSecurity), 0)
def MarketStartProviderSecurityVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddConsumerSecurity(builder, consumerSecurity): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(consumerSecurity), 0)
def MarketStartConsumerSecurityVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def MarketAddMarketFee(builder, marketFee): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(marketFee), 0)
