...
def MemberStart(builder): builder.StartObject(4)
...
def MemberAddEula(builder, eula): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(eula), 0)
def MemberAddProfile(builder, profile): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(profile), 0)
def MemberAddLevel(builder, level): builder.PrependUint8Slot(3, level, 0)
