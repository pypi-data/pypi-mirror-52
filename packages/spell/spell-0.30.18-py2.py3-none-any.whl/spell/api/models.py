...
class Run(Model):
    ...
    compare_fields = ["id", "status", "command", "creator", "gpu", "git_commit_hash", "docker_image", "framework",
                      ...
                      "tensorboard_enabled", "tensorboard_directory", "distributed"]
    ...
    def __init__(self, id, status, command, creator, gpu, git_commit_hash, description, framework, docker_image,
                 ...
                 github_url=None, tensorboard_enabled=None, tensorboard_directory=None, distributed=None,
                 labels=None, **kwargs):
        self.id = int(id)
        self.status = status
...
class RunRequest:
    ...
    tensorboard_enabled -- indicates if tensorboard is enabled
    tensorboard_directory -- indicates which directory tensorboard files will be written to if not /tensorboard
    ...
    def __init__(self, machine_type="CPU", command=None, workspace_id=None, commit_hash=None, commit_label=None,
                 ...
                 framework_version=None, python2=None, tensorboard_enabled=None, tensorboard_directory=None,
                 attached_resources=None, description=None, envvars=None, conda_file=None, run_type="user",
                 idempotent=False, provider=None, local_root=None, workflow_id=None, github_url=None,
                 github_ref=None, distributed=None, stop_conditions=None, uncommitted_hash=None):
