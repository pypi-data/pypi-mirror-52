...
def tensorboard_params(f):
    ...
    @click.option("--tensorboard-enabled", is_flag=True, help="Specifies if tensorboard is enabled", cls=HiddenOption)
    @click.option("--tensorboard-dir",
                  help="Specifies if TensorBoard files will be written to somewhere other than /tensorboard.",
