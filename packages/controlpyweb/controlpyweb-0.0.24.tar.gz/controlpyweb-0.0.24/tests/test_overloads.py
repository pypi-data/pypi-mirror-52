...
class Module(WebIOModule):
    member_len = 7
    Button1 = DiscreteIn("device1DigitalInput1", units="On/Off")
    Button2 = DiscreteIn("device1DigitalInput2", units="Start/Stop")
    Button3 = DiscreteIn("device1DigitalInput3")
    Lamp1 = DiscreteOut("redLamp")
    Lamp2 = DiscreteOut("amberLamp")
    temperature1 = AnalogOut(units="DegF")
    Temp2 = AnalogOut("temperature2")
...
class TestOverloads(unittest.TestCase):
    ...
    def test_modulo(self):
        module.temperature1 = 10
        module.Temp2 = 3
        assert_that(module.temperature1 % 3).is_equal_to(1)
        assert_that(module.temperature1 % module.Temp2).is_equal_to(1)
