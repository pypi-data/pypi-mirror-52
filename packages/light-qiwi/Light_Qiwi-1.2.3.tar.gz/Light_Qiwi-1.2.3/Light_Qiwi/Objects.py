...
class Bill:
    ...
    def __init__(self, raw):
        ...
        self.raw = raw
        self.id = raw['id']
        self.external_id = raw['external_id']
        self.creation_datetime = raw['creation_datetime']
        self.expiration_datetime = raw['expiration_datetime']
        self.currency = parse_item_multi_value_enum(raw['sum']['currency'], Currency)
        self.amount = raw['sum']['amount']
        self.comment = raw['comment']
        self.status = raw['status']
        self.repetitive = raw['repetitive']
        self.provider = raw['provider']
        self.pay_url = raw['pay_url']
