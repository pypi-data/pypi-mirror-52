...
```bash
TAG=2.20.0.0b2 REGISTRY=us.gcr.io/onepanelio make publish-pip-package
```
...
```bash
TAG=2.20.0.0b1 REGISTRY=us.gcr.io/onepanelio make build-docker-image push-docker-image
```
