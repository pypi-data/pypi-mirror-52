...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codebuild", "1.8.0", __name__, "aws-codebuild@1.8.0.jsii.tgz")
...
class CfnProject(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.CfnProject"):
    ...
    class ProjectTriggersProperty():
        ...
        @property
        def filter_groups(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnProject.WebhookFilterProperty", aws_cdk.core.IResolvable]]]]]]]:
...
class CfnProjectProps():
    ...
    @property
    def artifacts(self) -> typing.Union[aws_cdk.core.IResolvable, "CfnProject.ArtifactsProperty"]:
        """``AWS::CodeBuild::Project.Artifacts``.
    ...
    @property
    def secondary_artifacts(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnProject.ArtifactsProperty"]]]]]:
        """``AWS::CodeBuild::Project.SecondaryArtifacts``.
    ...
    @property
    def triggers(self) -> typing.Optional[typing.Union[typing.Optional["CfnProject.ProjectTriggersProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::CodeBuild::Project.Triggers``.
...
class LinuxBuildImage(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.LinuxBuildImage"):
    ...
    @classmethod
    def from_asset(cls, scope: aws_cdk.core.Construct, id: str, *, directory: str, build_args: typing.Optional[typing.Mapping[str,str]]=None, repository_name: typing.Optional[str]=None, exclude: typing.Optional[typing.List[str]]=None, follow: typing.Optional[aws_cdk.assets.FollowMode]=None) -> "IBuildImage":
