...
class SoldProperty(Model):
    ...
    def __init__(self, id: str=None, address: str=None, community: str=None, zone: str=None, yr_built: int=None, living_space_square_footage_ag: int=None, lot_size: float=None, land_use_code: str=None, assessed_value: float=None, tax_amount: float=None, building_type: str=None, style: str=None, basement_development: str=None, basement_percent_development: float=None, basement: List[str]=None, bedrooms_total: float=None, bedrooms_ag: float=None, bedrooms_with_closet: float=None, master_walk_in: bool=None, master_ensuite: bool=None, bathrooms_full: float=None, bathrooms_half: float=None, bathrooms_main: float=None, bathrooms_basement: float=None, room_number: float=None, kitchen_countertops: List[str]=None, kitchen_island: bool=None, kitchen_appliances: List[str]=None, kitchen_layout: str=None, flooring: List[str]=None, fireplace: List[str]=None, heating_type: List[str]=None, backyard_details: str=None, exterior: List[str]=None, parking: List[str]=None, total_parking: float=None, enclosed_parking: float=None, roof_type: str=None, roof_age_years: int=None, is_renovated: bool=None, renovations_or_upgrades: str=None, property_photos_user_submitted: str=None, latitude: float=None, longitude: float=None, google_place_id: str=None, geo_hash5: str=None, geo_hash12: str=None, sold_amount: float=None, previous_value: float=None, sold_date: date=None):  # noqa: E501
        ...
        :type geo_hash12: str
        :param sold_amount: The sold_amount of this SoldProperty.  # noqa: E501
        :type sold_amount: float
        :param previous_value: The previous_value of this SoldProperty.  # noqa: E501
    ...
    def land_use_code(self, land_use_code: str):
        ...
        :type land_use_code: str
        """
        allowed_values = ["R1", "R2", "R3", "M"]  # noqa: E501
        if land_use_code not in allowed_values:
            raise ValueError(
                "Invalid value for `land_use_code` ({0}), must be one of {1}"
    ...
    def sold_amount(self) -> float:
        """Gets the sold_amount of this SoldProperty.

        The amount the home was sold for  # noqa: E501

        :return: The sold_amount of this SoldProperty.
        :rtype: float
        """
        return self._sold_amount

    @sold_amount.setter
    def sold_amount(self, sold_amount: float):
        """Sets the sold_amount of this SoldProperty.

        The amount the home was sold for  # noqa: E501

        :param sold_amount: The sold_amount of this SoldProperty.
        :type sold_amount: float
        """
        if sold_amount is None:
            raise ValueError("Invalid value for `sold_amount`, must not be `None`")  # noqa: E501

        self._sold_amount = sold_amount

    @property
    def previous_value(self) -> float:
        """Gets the previous_value of this SoldProperty.

        An amount the home was initially listed at  # noqa: E501

        :return: The previous_value of this SoldProperty.
        :rtype: float
        """
    ...
    def previous_value(self, previous_value: float):
        """Sets the previous_value of this SoldProperty.

        An amount the home was initially listed at  # noqa: E501

        :param previous_value: The previous_value of this SoldProperty.
        :type previous_value: float
        """
    ...
    def sold_date(self) -> date:
        ...
        The date the home was sold at  # noqa: E501
    ...
    @sold_date.setter
    def sold_date(self, sold_date: date):
