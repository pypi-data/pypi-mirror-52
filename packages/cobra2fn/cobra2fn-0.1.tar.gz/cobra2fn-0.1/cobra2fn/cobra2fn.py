...
def cobra2fn(comodel, knockouts = [], solver = 'cplex'):
    """Create and return a dictionary with flexible net format from cobra model comodel.
       Parameters:
           comodel: cobra model
           knockouts: list of genes to knock out (the flux of the associated reactions will be set to 0)
