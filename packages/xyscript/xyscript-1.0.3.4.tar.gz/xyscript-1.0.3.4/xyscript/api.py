...
def diagnose(*parameters):
    ...
    git_objc = {}
    if PROJECT_BRANCH is None or PROJECT_ADDRESS is None or DEV_BRANCH is None or PROJECT_BUILD is None or TAG_NAME is None or PACKAGE_ORDER is None:
        git_objc = None
    else:
...
def main(prog=None,args=None):
    global PROJECT_ADDRESS, PROJECT_BRANCH, TEST_PLATFORM, NET_ENV, PROJECT_VERSION, PROJECT_BUILD,\
           ...
           CERT_PASSWORD, WITHOUT_POD_INSTALL,JIRA_URL,MODULE_KEYWORD
