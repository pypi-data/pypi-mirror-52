...
import struct
import os
from seeta_dataset import exception
...
class WriteOnlyDataset:
    ...
    ```
    """
    def __init__(self, base_path, dataset_id, record_type):
