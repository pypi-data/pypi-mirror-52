...
def run(mode, conf, retrain, useSpark, date='', tw=1, wi=1, ps=1, logpath='', use_TFoS=False, num_executor=0, **kwargs):
    assert ps > 0
...
if __name__ == '__main__':
    ...
    run(args.mode, args.conf, args.retrain, args.useSpark, args.date, args.tw, args.wi, args.ps, args.logpath,
