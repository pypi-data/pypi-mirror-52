...
vspec = importlib.util.spec_from_file_location(
  "version",
  str(Path(__file__).resolve().parent / 'pytypewriter' / "version.py")
)
...
setup(
    name='pytypewriter',
    description="This is a simple library to help you serialize Python type names and call them up again when you need them.",
    ...
    entry_points="""
    [console_scripts]
    pytypewriter=pytypewriter.cli:cli
    """,
    ...
    url='https://github.com/patdaburu/pytypewriter',
    download_url=(
        f'https://github.com/patdaburu/'
        f'pytypewriter/archive/{version}.tar.gz'
    ),
    keywords=[
