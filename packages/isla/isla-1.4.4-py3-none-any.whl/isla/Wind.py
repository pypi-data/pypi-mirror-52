...
class Wind(IntermittentComponent):
    ...
    def __init__(
        self, data, dir='auto', z_anem=10.0, z_hub=80.0, z_rough=0.0005,
    ...
    def update_init(self):
        ...
        # extract dataset
        self.wd_spd = self._data_proc('wd_spd', True)  # wind speed [m/s]
        self.wd_dir = self._data_proc('wd_dir', False)  # wind dir [deg]
