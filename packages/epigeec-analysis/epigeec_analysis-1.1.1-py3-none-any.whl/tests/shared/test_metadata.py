...
class TestMetadata(unittest.TestCase):
    ...
    def test_add(self):
        md_a = Metadata.load_from_file(StringIO(METADATA_JSON_A))
        md_b = Metadata.load_from_file(StringIO(METADATA_JSON_B))
        md_c = Metadata.load_from_file(StringIO(METADATA_JSON_C))
    ...
    def test_list_categories(self):
        data = Metadata.load_from_file(StringIO(METADATA_JSON_TYPE_DICT))
    ...
    def test_find(self):
        data = Metadata.load_from_file(StringIO(METADATA_JSON_TYPE_LIST))
