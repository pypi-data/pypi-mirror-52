...
AUTHLOG_TRACKED_MODELS = getattr(
    settings, 'AUTHLOG_TRACKED_MODELS', ['authlog.Access', 'authlog.AccessPage'])

AUTHLOG_SAVE_LOGIN_POST_DATA = getattr(
    settings, 'AUTHLOG_SAVE_LOGIN_POST_DATA', True)
AUTHLOG_SAVE_VIEW_POST_DATA = getattr(
    settings, 'AUTHLOG_SAVE_VIEW_POST_DATA', True)
