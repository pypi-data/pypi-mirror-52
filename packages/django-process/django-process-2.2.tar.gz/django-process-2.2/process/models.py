...
class Task(models.Model):
    ...
    offset = models.CharField(_("diagram offset"), default='0%', validators=[offset_validator])
...
class JobTask(models.Model):
    ...
    parent_ok = [finished, cancelled, forced]
    ...
    def ready_to_run(self):
        return all([p.status in JobTask.parent_ok for p in self.get_parents()])
