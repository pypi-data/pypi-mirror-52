...
class _AzureBatchStepBase(PipelineStep):
    ...
    def __init__(self,
        ...
        self._optional_parameters = Module.construct_azure_batch_optional_params_def(
    ...
    def create_node(self, graph, default_datastore, context):
        ...
        input_bindings, output_bindings = self.create_input_output_bindings(self._inputs,
                                                                            ...
                                                                            default_datastore)
        from azureml.pipeline.core import Module
        metadata_parameters = Module.create_azure_batch_metadata_params(context._workspace, self._compute_target)

        arguments = super(_AzureBatchStepBase, self).resolve_input_arguments(
