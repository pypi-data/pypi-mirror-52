...
Modules allows you to create computational units in a :class:`azureml.pipeline.core.Pipeline` which can have
inputs, outputs, and rely on parameters and its environment configuration to operate. A module can be versioned
and be used in different Azure ML pipelines unlike :class:`azureml.pipeline.core.PipelineStep`
...
class Module(object):
    ...
    .. remarks::
        ...
        A Module acts as a container of its versions. An example of a Module lifecycle is the following:
        ...
        In this example, two modules were created, and each published a version. The producer module has a version
        that has 3 outputs and the consumer module has a version that has 3 inputs.

        These modules can be used when defining a pipeline, in different steps, by using a
        ...
        The code above creates a Pipeline with two steps. The producer step will be executed first. Then after it has
        completed, the consumer step will be executed. Azure ML will provide the output produced by the
    ...
    def module_def_builder(name, description, execution_type, input_bindings, output_bindings, param_defs=None,
        ...
        :type version: str
        :param module_type: The mMdule type.
    ...
    def publish_python_script(self, script_name, description, inputs, outputs, params=None,
                              ...
                              source_directory=None, hash_paths=None, category=None):
        """
...
class ModuleVersion(object):
    ...
    def category(self):
        """
        Category of the Module Version.
