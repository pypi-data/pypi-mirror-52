...
def main():
    ...
    for openapi in args.openapi:
        ...
        process_openapi_file(openapi_file=openapi_abs, frontmatter_cli=frontmatter_cli, sdk_generator_cli=sdk_generator_cli,
                             ...
                             input_frontmatter_config=input_frontmatter_config, output_frontmatter_config=output_frontmatter_config,
                             no_update=args.no_update, frontmatter_md_file=frontmatter_md_file, keep_sdk=args.keep_sdk)

    if not args.keep_temp:
        logger.info('Removing temporary directory %s' % temp_dir)
        shutil.rmtree(temp_dir)

def process_openapi_file(openapi_file=None, frontmatter_cli=None, sdk_generator_cli=None, templates_dir=None, output_folder=None, apidocs_dir=None, input_frontmatter_config=None, output_frontmatter_config=None, no_update=None, frontmatter_md_file=None, keep_sdk=None):
