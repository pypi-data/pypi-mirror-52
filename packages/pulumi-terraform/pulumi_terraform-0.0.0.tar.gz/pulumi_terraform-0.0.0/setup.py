...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', 'v0.18.4-alpha.1568460409+gfc13217'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform v0.18.4-alpha.1568460409+gfc13217`
                """)
