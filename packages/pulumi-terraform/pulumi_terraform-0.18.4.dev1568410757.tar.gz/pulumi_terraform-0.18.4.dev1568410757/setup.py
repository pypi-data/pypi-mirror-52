...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', 'v0.18.4-dev.1568410757+g5475632'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform v0.18.4-dev.1568410757+g5475632`
                """)
