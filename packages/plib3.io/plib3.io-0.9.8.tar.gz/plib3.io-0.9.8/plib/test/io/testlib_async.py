#!/usr/bin/env python3
"""
TEST.IO.TESTLIB_ASYNC.PY -- utility module for PLIB3 I/O tests
...
I/O modules in PLIB3.STDLIB.
"""

from plib.io.mixins import EchoRequestMixin

import plib.io.async  # FIXME: why is this needed to make things work?
