...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host: str = "http://www.felix-scholz.org/api/1.0.0"
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "{schema}://{host}/api/{version}/",
                'description': "No description provided",
                'variables': {
                    'host': {
                        'description': "No description provided",
                        'default_value': "www.felix-scholz.org",
                        'enum_values': [
                            "localhost:8000",
                            "www.felix-scholz.org",
                            "172.17.0.1:8000"
                        ]
                        },
                    'schema': {
