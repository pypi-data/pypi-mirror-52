...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticbeanstalk", "1.8.0", __name__, "aws-elasticbeanstalk@1.8.0.jsii.tgz")
...
class CfnApplicationProps():
    def __init__(self, *, application_name: typing.Optional[str]=None, description: typing.Optional[str]=None, resource_lifecycle_config: typing.Optional[typing.Union[typing.Optional["CfnApplication.ApplicationResourceLifecycleConfigProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None):
    ...
    @property
    def resource_lifecycle_config(self) -> typing.Optional[typing.Union[typing.Optional["CfnApplication.ApplicationResourceLifecycleConfigProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::ElasticBeanstalk::Application.ResourceLifecycleConfig``.
...
class CfnApplicationVersionProps():
    def __init__(self, *, application_name: str, source_bundle: typing.Union[aws_cdk.core.IResolvable, "CfnApplicationVersion.SourceBundleProperty"], description: typing.Optional[str]=None):
    ...
    @property
    def source_bundle(self) -> typing.Union[aws_cdk.core.IResolvable, "CfnApplicationVersion.SourceBundleProperty"]:
        """``AWS::ElasticBeanstalk::ApplicationVersion.SourceBundle``.
