...
setup(
  ...
  version='0.1',
  license='MIT',
  description='Some widely used Abstract data structures',
  long_description='This repository contains python implementation of some widely used data structures',
  author='Vishal',
