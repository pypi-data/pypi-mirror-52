...
- API version: v3
- Package version: 0.2.0b3.dev01568213638
...
try:
    # Upload a collection
    api_response = api_instance.upload_collection(file, sha256=sha256, expected_namespace=expected_namespace, expected_name=expected_name, expected_version=expected_version)
    pprint(api_response)
