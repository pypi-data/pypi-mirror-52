...
class CollectionVersion(object):
    ...
    def __init__(self, type=None, artifact=None, created=None, href=None, md5=None, sha1=None, sha224=None, sha256=None, sha384=None, sha512=None, id=None, authors=None, contents=None, dependencies=None, description=None, docs_blob=None, documentation=None, homepage=None, issues=None, is_certified=None, license=None, name=None, namespace=None, repository=None, tags=None, version=None):  # noqa: E501
    ...
    def is_certified(self, is_certified):
        ...
        if is_certified is None:
            raise ValueError("Invalid value for `is_certified`, must not be `None`")  # noqa: E501
    ...
    def repository(self, repository):
        ...
        if repository is not None and len(repository) > 128:
