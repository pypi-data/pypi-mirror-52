...
- API version: v3
- Package version: 0.2.0b3.dev01568126932
...
try:
    # Upload a collection
    api_response = api_instance.upload_collection(file, sha256=sha256)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling AnsibleCollectionsApi->upload_collection: %s\n" % e)
...
*ContentCollectionsApi* | [**create**](docs/ContentCollectionsApi.md#create) | **POST** /pulp/api/v3/content/ansible/collections/ | Create a collection version
*ContentCollectionsApi* | [**list**](docs/ContentCollectionsApi.md#list) | **GET** /pulp/api/v3/content/ansible/collections/ | List collection versions
*ContentCollectionsApi* | [**read**](docs/ContentCollectionsApi.md#read) | **GET** {collection_version_href} | Inspect a collection version
...
*PulpAnsibleImportsApi* | [**list**](docs/PulpAnsibleImportsApi.md#list) | **GET** /pulp/api/v3/pulp_ansible/imports/ | List collection imports
...
## Documentation For Models
 ...
 - [CollectionImportList](docs/CollectionImportList.md)
