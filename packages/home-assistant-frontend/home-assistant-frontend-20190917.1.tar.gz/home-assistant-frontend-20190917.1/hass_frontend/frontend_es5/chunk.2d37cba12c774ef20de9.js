/*! For license information please see chunk.2d37cba12c774ef20de9.js.LICENSE */
(self.webpackJsonp=self.webpackJsonp||[]).push([[94,5,6],{113:function(e,t,i){"use strict";i(5);var n=i(94),a=i(61),o=i(6),r=i(2),s=i(4);Object(o.a)({_template:s.a`
    <style>
      :host {
...
`,is:"app-header-layout",behaviors:[r.a],properties:{hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0}},observers:["resetLayout(isAttached, hasScrollingRegion)"],get header(){return Object(a.a)(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function(){var e=this.header;if(this.isAttached&&e){this.$.wrapper.classList.remove("initializing"),e.scrollTarget=this.hasScrollingRegion?this.$.contentContainer:this.ownerDocument.documentElement;var t=e.offsetHeight;this.hasScrollingRegion?(e.style.left="",e.style.right=""):requestAnimationFrame(function(){var t=this.getBoundingClientRect(),i=document.documentElement.clientWidth-t.right;e.style.left=t.left+"px",e.style.right=i+"px"}.bind(this));var i=this.$.contentContainer.style;e.fixed&&!e.condenses&&this.hasScrollingRegion?(i.marginTop=t+"px",i.paddingTop=""):(i.paddingTop=t+"px",i.marginTop="")}}})},214:function(e,t,i){"use strict";var n=i(195);t.a=function(){try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1}()?function(e,t){return e.toLocaleTimeString(t,{hour:"numeric",minute:"2-digit"})}:function(e){return n.a.format(e,"shortTime")}},220:function(e,t,i){"use strict";i(5),i(45);var n=i(6),a=i(2),o=i(4),r=i(128),s=i(258);Object(n.a)({_template:o.a`
    <style>
      :host {
        position: relative;
        display: block;
...
</dom-module>`;document.head.appendChild(a.content);i(209),i(202),i(224);const o=n.a`<dom-module id="lumo-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        /* Sizing */
...
//# sourceMappingURL=chunk.2d37cba12c774ef20de9.js.map