(self.webpackJsonp=self.webpackJsonp||[]).push([[74],{294:function(e,t,i){"use strict";i.d(t,"b",function(){return a}),i.d(t,"a",function(){return o});const a=async(e,t=!1)=>{if(!e.parentNode)throw new Error("Cannot setup Leaflet map on disconnected element");const a=await i.e(123).then(i.t.bind(null,363,7));a.Icon.Default.imagePath="/static/images/leaflet/images/";const n=a.map(e),s=document.createElement("link");return s.setAttribute("href","/static/images/leaflet/leaflet.css"),s.setAttribute("rel","stylesheet"),e.parentNode.appendChild(s),n.setView([52.3731339,4.8903147],13),o(a,t).addTo(n),[n,a]},o=(e,t)=>e.tileLayer(`https://{s}.basemaps.cartocdn.com/${t?"dark_all":"light_all"}/{z}/{x}/{y}${e.Browser.retina?"@2x.png":".png"}`,{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>, &copy; <a href="https://carto.com/attributions">CARTO</a>',subdomains:"abcd",minZoom:0,maxZoom:20})},359:function(e,t,i){"use strict";i.d(t,"b",function(){return a}),i.d(t,"a",function(){return o});const a=(e,t)=>e.callWS(Object.assign({type:"config/core/update"},t)),o=e=>e.callWS({type:"config/core/detect"})},403:function(e,t,i){"use strict";i.d(t,"a",function(){return n});var a=i(457),o=i.n(a);const n=()=>{const e=document.createElement("datalist");return e.id="timezones",Object.keys(o.a).forEach(t=>{const i=document.createElement("option");i.value=t,i.innerHTML=o.a[t],e.appendChild(i)}),e}},404:function(e,t,i){"use strict";var a=i(3),o=i(0),n=i(294),s=i(18);let r=class extends o.a{constructor(){super(...arguments),this.fitZoom=16}fitMap(){this._leafletMap&&this.location&&this._leafletMap.setView(this.location,this.fitZoom)}render(){return o.f`
      <div id="map"></div>
    ...
    `}};a.b([Object(o.g)()],r.prototype,"location",void 0),r=a.b([Object(o.d)("ha-location-editor")],r)},674:function(e,t,i){"use strict";i.r(t);var a=i(3),o=i(0),n=(i(85),i(93),i(256),i(240),i(359)),s=i(112),r=i(18),c=i(403);i(404);const l=[52.3731339,4.8903147];let d=class extends o.a{constructor(){super(...arguments),this._working=!1}render(){return o.f`
      <p>
    ...
    `}firstUpdated(e){super.firstUpdated(e),setTimeout(()=>this.shadowRoot.querySelector("paper-input").focus(),100),this.addEventListener("keypress",e=>{13===e.keyCode&&this._save(e)}),this.shadowRoot.querySelector("[name=timeZone]").inputElement.appendChild(Object(c.a)())}get _nameValue(){return void 0!==this._name?this._name:this.onboardingLocalize("ui.panel.page-onboarding.core-config.location_name_default")}get _locationValue(){return this._location||l}get _elevationValue(){return void 0!==this._elevation?this._elevation:0}get _timeZoneValue(){return this._timeZone}get _unitSystemValue(){return void 0!==this._unitSystem?this._unitSystem:"metric"}_handleChange(e){const t=e.currentTarget;this[`_${t.name}`]=t.value}_locationChanged(e){this._location=e.currentTarget.location}_unitSystemChanged(e){this._unitSystem=e.detail.value}async _detect(){this._working=!0;try{const t=await Object(n.a)(this.hass);t.latitude&&t.longitude&&(this._location=[Number(t.latitude),Number(t.longitude)]),t.elevation&&(this._elevation=String(t.elevation)),t.unit_system&&(this._unitSystem=t.unit_system),t.time_zone&&(this._timeZone=t.time_zone)}catch(e){alert(`Failed to detect location information: ${e.message}`)}finally{this._working=!1}}async _save(e){e.preventDefault(),this._working=!0;try{const e=this._locationValue;await Object(n.b)(this.hass,{location_name:this._nameValue,latitude:e[0],longitude:e[1],elevation:Number(this._elevationValue),unit_system:this._unitSystemValue,time_zone:this._timeZoneValue||"UTC"});const i=await Object(s.b)(this.hass);Object(r.a)(this,"onboarding-step",{type:"core_config",result:i})}catch(t){this._working=!1,alert("FAIL")}}static get styles(){return o.c`
      .row {
        display: flex;
        flex-direction: row;
        margin: 0 -8px;
    ...
    `}};a.b([Object(o.g)()],d.prototype,"hass",void 0),a.b([Object(o.g)()],d.prototype,"onboardingLocalize",void 0),a.b([Object(o.g)()],d.prototype,"_working",void 0),a.b([Object(o.g)()],d.prototype,"_name",void 0),a.b([Object(o.g)()],d.prototype,"_location",void 0),a.b([Object(o.g)()],d.prototype,"_elevation",void 0),a.b([Object(o.g)()],d.prototype,"_unitSystem",void 0),a.b([Object(o.g)()],d.prototype,"_timeZone",void 0),d=a.b([Object(o.d)("onboarding-core-config")],d)}}]);
//# sourceMappingURL=chunk.980a282001275ea7d467.js.map