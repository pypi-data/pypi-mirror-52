...
`},238:function(t,e,i){"use strict";var n=i(3),s=i(0),a=(i(85),i(18));let o=class extends s.a{render(){const t=["Backend-selected","default"].concat(Object.keys(this.hass.themes.themes).sort());return s.f`
      <paper-dropdown-menu
        label="Theme"
        dynamic-align
    ...
    `}};n.b([Object(s.g)()],o.prototype,"hass",void 0),n.b([Object(s.g)()],o.prototype,"entities",void 0),o=n.b([Object(s.d)("hui-entity-editor")],o)},300:function(t,e,i){"use strict";function n(t){return t.map(t=>"string"==typeof t?{entity:t}:t)}i.d(e,"a",function(){return n})},685:function(t,e,i){"use strict";i.r(e),i.d(e,"HuiEntitiesCardEditor",function(){return h});var n=i(3),s=i(0),a=(i(146),i(143),i(144),i(207),i(184),i(238),i(248),i(177),i(179),i(300)),o=i(199),c=i(18),l=i(205);const d=o.a.union([{entity:"entity-id",name:"string?",icon:"icon?"},"entity-id"]),r=Object(o.a)({type:"string",title:"string|number?",theme:"string?",show_header_toggle:"boolean?",entities:[d]});let h=class extends s.a{setConfig(t){t=r(t),this._config=t,this._configEntities=Object(a.a)(t.entities)}get _title(){return this._config.title||""}get _theme(){return this._config.theme||"Backend-selected"}render(){return this.hass?s.f`
      ${l.a}
...
//# sourceMappingURL=chunk.eb8fe9221b6ec2906865.js.map