/*! For license information please see chunk.1ad252306d09bed30335.js.LICENSE */
...
`,is:"paper-tooltip",hostAttributes:{role:"tooltip",tabindex:-1},properties:{for:{type:String,observer:"_findTarget"},manualMode:{type:Boolean,value:!1,observer:"_manualModeChanged"},position:{type:String,value:"bottom"},fitToVisibleBounds:{type:Boolean,value:!1},offset:{type:Number,value:14},marginTop:{type:Number,value:14},animationDelay:{type:Number,value:500,observer:"_delayChange"},animationEntry:{type:String,value:""},animationExit:{type:String,value:""},animationConfig:{type:Object,value:function(){return{entry:[{name:"fade-in-animation",node:this,timing:{delay:0}}],exit:[{name:"fade-out-animation",node:this}]}}},_showing:{type:Boolean,value:!1}},listeners:{webkitAnimationEnd:"_onAnimationEnd"},get target(){var t=Object(a.a)(this).parentNode,e=Object(a.a)(this).getOwnerRoot();return this.for?Object(a.a)(e).querySelector("#"+this.for):t.nodeType==Node.DOCUMENT_FRAGMENT_NODE?e.host:t},attached:function(){this._findTarget()},detached:function(){this.manualMode||this._removeListeners()},playAnimation:function(t){"entry"===t?this.show():"exit"===t&&this.hide()},cancelAnimation:function(){this.$.tooltip.classList.add("cancel-animation")},show:function(){if(!this._showing){if(""===Object(a.a)(this).textContent.trim()){for(var t=!0,e=Object(a.a)(this).getEffectiveChildNodes(),n=0;n<e.length;n++)if(""!==e[n].textContent.trim()){t=!1;break}if(t)return}this._showing=!0,this.$.tooltip.classList.remove("hidden"),this.$.tooltip.classList.remove("cancel-animation"),this.$.tooltip.classList.remove(this._getAnimationType("exit")),this.updatePosition(),this._animationPlaying=!0,this.$.tooltip.classList.add(this._getAnimationType("entry"))}},hide:function(){if(this._showing){if(this._animationPlaying)return this._showing=!1,void this._cancelAnimation();this._onAnimationFinish(),this._showing=!1,this._animationPlaying=!0}},updatePosition:function(){if(this._target&&this.offsetParent){var t=this.offset;14!=this.marginTop&&14==this.offset&&(t=this.marginTop);var e,n,i=this.offsetParent.getBoundingClientRect(),a=this._target.getBoundingClientRect(),o=this.getBoundingClientRect(),r=(a.width-o.width)/2,s=(a.height-o.height)/2,c=a.left-i.left,l=a.top-i.top;switch(this.position){case"top":e=c+r,n=l-o.height-t;break;case"bottom":e=c+r,n=l+a.height+t;break;case"left":e=c-o.width-t,n=l+s;break;case"right":e=c+a.width+t,n=l+s}this.fitToVisibleBounds?(i.left+e+o.width>window.innerWidth?(this.style.right="0px",this.style.left="auto"):(this.style.left=Math.max(0,e)+"px",this.style.right="auto"),i.top+n+o.height>window.innerHeight?(this.style.bottom=i.height-l+t+"px",this.style.top="auto"):(this.style.top=Math.max(-i.top,n)+"px",this.style.bottom="auto")):(this.style.left=e+"px",this.style.top=n+"px")}},_addListeners:function(){this._target&&(this.listen(this._target,"mouseenter","show"),this.listen(this._target,"focus","show"),this.listen(this._target,"mouseleave","hide"),this.listen(this._target,"blur","hide"),this.listen(this._target,"tap","hide")),this.listen(this.$.tooltip,"animationend","_onAnimationEnd"),this.listen(this,"mouseenter","hide")},_findTarget:function(){this.manualMode||this._removeListeners(),this._target=this.target,this.manualMode||this._addListeners()},_delayChange:function(t){500!==t&&this.updateStyles({"--paper-tooltip-delay-in":t+"ms"})},_manualModeChanged:function(){this.manualMode?this._removeListeners():this._addListeners()},_cancelAnimation:function(){this.$.tooltip.classList.remove(this._getAnimationType("entry")),this.$.tooltip.classList.remove(this._getAnimationType("exit")),this.$.tooltip.classList.remove("cancel-animation"),this.$.tooltip.classList.add("hidden")},_onAnimationFinish:function(){this._showing&&(this.$.tooltip.classList.remove(this._getAnimationType("entry")),this.$.tooltip.classList.remove("cancel-animation"),this.$.tooltip.classList.add(this._getAnimationType("exit")))},_onAnimationEnd:function(){this._animationPlaying=!1,this._showing||(this.$.tooltip.classList.remove(this._getAnimationType("exit")),this.$.tooltip.classList.add("hidden"))},_getAnimationType:function(t){if("entry"===t&&""!==this.animationEntry)return this.animationEntry;if("exit"===t&&""!==this.animationExit)return this.animationExit;if(this.animationConfig[t]&&"string"==typeof this.animationConfig[t][0].name){if(this.animationConfig[t][0].timing&&this.animationConfig[t][0].timing.delay&&0!==this.animationConfig[t][0].timing.delay){var e=this.animationConfig[t][0].timing.delay;"entry"===t?this.updateStyles({"--paper-tooltip-delay-in":e+"ms"}):"exit"===t&&this.updateStyles({"--paper-tooltip-delay-out":e+"ms"})}return this.animationConfig[t][0].name}},_removeListeners:function(){this._target&&(this.unlisten(this._target,"mouseenter","show"),this.unlisten(this._target,"focus","show"),this.unlisten(this._target,"mouseleave","hide"),this.unlisten(this._target,"blur","hide"),this.unlisten(this._target,"tap","hide")),this.unlisten(this.$.tooltip,"animationend","_onAnimationEnd"),this.unlisten(this,"mouseenter","hide")}})},265:function(t,e,n){"use strict";n.d(e,"a",function(){return s}),n.d(e,"d",function(){return c}),n.d(e,"b",function(){return l}),n.d(e,"c",function(){return u});var i=n(0),a=n(13),o=n(176),r=n(196),s=function(t,e){if(e.name)return e.name;var n=t.states[e.entity_id];return n?Object(o.a)(n):null},c=function(t,e,n){return t.callWS(i.a({type:"config/entity_registry/update",entity_id:e},n))},l=function(t,e){return t.callWS({type:"config/entity_registry/remove",entity_id:e})},d=function(t){return t.sendMessagePromise({type:"config/entity_registry/list"})},p=function(t,e){return t.subscribeEvents(Object(r.a)(function(){return d(t).then(function(t){return e.setState(t,!0)})},500,!0),"entity_registry_updated")},u=function(t,e){return Object(a.d)("_entityRegistry",d,p,t,e)}},299:function(t,e,n){"use strict";n.d(e,"b",function(){return a}),n.d(e,"a",function(){return o}),n.d(e,"c",function(){return r}),n.d(e,"d",function(){return s});var i=n(0),a=function(t){return t.callApi("GET","config/config_entries/entry")},o=function(t,e){return t.callApi("DELETE","config/config_entries/entry/"+e)},r=function(t,e){return t.callWS({type:"config_entries/system_options/list",entry_id:e})},s=function(t,e,n){return t.callWS(i.a({type:"config_entries/system_options/update",entry_id:e},n))}},308:function(t,e,n){"use strict";n.d(e,"a",function(){return o}),n.d(e,"c",function(){return r}),n.d(e,"f",function(){return s}),n.d(e,"b",function(){return c}),n.d(e,"d",function(){return l}),n.d(e,"e",function(){return u}),n.d(e,"h",function(){return h}),n.d(e,"g",function(){return f});var i=n(196),a=n(13),o=function(t,e){return t.callApi("POST","config/config_entries/flow",{handler:e})},r=function(t,e){return t.callApi("GET","config/config_entries/flow/"+e)},s=function(t,e,n){return t.callApi("POST","config/config_entries/flow/"+e,n)},c=function(t,e){return t.callApi("DELETE","config/config_entries/flow/"+e)},l=function(t){return t.callApi("GET","config/config_entries/flow_handlers")},d=function(t){return t.sendMessagePromise({type:"config_entries/flow/progress"})},p=function(t,e){return t.subscribeEvents(Object(i.a)(function(){return d(t).then(function(t){return e.setState(t,!0)})},500,!0),"config_entry_discovered")},u=function(t){return Object(a.h)(t,"_configFlowProgress",d,p)},h=function(t,e){return u(t.connection).subscribe(e)},f=function(t,e){var n=e.context.title_placeholders||{},i=Object.keys(n);if(0===i.length)return t("component."+e.handler+".config.title");var a=[];return i.forEach(function(t){a.push(t),a.push(n[t])}),t.apply(void 0,["component."+e.handler+".config.flow_title"].concat(a))}},362:function(t,e,n){"use strict";n.d(e,"a",function(){return o}),n.d(e,"b",function(){return r});var i=n(0),a=n(18),o=function(){return Promise.all([n.e(1),n.e(2),n.e(6),n.e(7),n.e(29)]).then(n.bind(null,474))},r=function(t,e,n){Object(a.a)(t,"show-dialog",{dialogTag:"dialog-data-entry-flow",dialogImport:o,dialogParams:i.a({},e,{flowConfig:n})})}},365:function(t,e,n){"use strict";n.d(e,"a",function(){return a}),n.d(e,"b",function(){return o});var i=n(18),a=function(){return n.e(27).then(n.bind(null,471))},o=function(t,e){Object(i.a)(t,"show-dialog",{dialogTag:"dialog-device-registry-detail",dialogImport:a,dialogParams:e})}},407:function(t,e,n){"use strict";n.d(e,"a",function(){return m}),n.d(e,"b",function(){return b});var i,a,o,r,s,c,l=n(0),d=n(308),p=n(1),u=n(58),h=n(362),f=n(198),m=h.a,b=function(t,e){return Object(h.b)(t,e,{loadDevicesAndAreas:!0,getFlowHandlers:function(t){return Object(d.d)(t).then(function(e){return e.sort(function(e,n){return Object(f.a)(t.localize("component."+e+".config.title"),t.localize("component."+n+".config.title"))})})},createFlow:d.a,fetchFlow:d.c,handleFlowStep:d.f,deleteFlow:d.b,renderAbortDescription:function(t,e){var n=Object(u.b)(t.localize,"component."+e.handler+".config.abort."+e.reason,e.description_placeholders);return n?Object(p.f)(i||(i=l.f(["\n            <ha-markdown allowsvg .content=","></ha-markdown>\n          "],["\n            <ha-markdown allowsvg .content=","></ha-markdown>\n          "])),n):""},renderShowFormStepHeader:function(t,e){return t.localize("component."+e.handler+".config.step."+e.step_id+".title")},renderShowFormStepDescription:function(t,e){var n=Object(u.b)(t.localize,"component."+e.handler+".config.step."+e.step_id+".description",e.description_placeholders);return n?Object(p.f)(a||(a=l.f(["\n            <ha-markdown allowsvg .content=","></ha-markdown>\n          "],["\n            <ha-markdown allowsvg .content=","></ha-markdown>\n          "])),n):""},renderShowFormStepFieldLabel:function(t,e,n){return t.localize("component."+e.handler+".config.step."+e.step_id+".data."+n.name)},renderShowFormStepFieldError:function(t,e,n){return t.localize("component."+e.handler+".config.error."+n)},renderExternalStepHeader:function(t,e){return t.localize("component."+e.handler+".config.step."+e.step_id+".title")},renderExternalStepDescription:function(t,e){var n=Object(u.b)(t.localize,"component."+e.handler+".config."+e.step_id+".description",e.description_placeholders);return Object(p.f)(r||(r=l.f(["\n        <p>\n          ","\n        </p>\n        ","\n      "],["\n        <p>\n          ","\n        </p>\n        ","\n      "])),t.localize("ui.panel.config.integrations.config_flow.external_step.description"),n?Object(p.f)(o||(o=l.f(["\n              <ha-markdown allowsvg .content=","></ha-markdown>\n            "],["\n              <ha-markdown allowsvg .content=","></ha-markdown>\n            "])),n):"")},renderCreateEntryDescription:function(t,e){var n=Object(u.b)(t.localize,"component."+e.handler+".config.create_entry."+(e.description||"default"),e.description_placeholders);return Object(p.f)(c||(c=l.f(["\n        ","\n        <p>Created config for ",".</p>\n      "],["\n        ","\n        <p>Created config for ",".</p>\n      "])),n?Object(p.f)(s||(s=l.f(["\n              <ha-markdown allowsvg .content=","></ha-markdown>\n            "],["\n              <ha-markdown allowsvg .content=","></ha-markdown>\n            "])),n):"",e.title)}})}},411:function(t,e,n){"use strict";var i=n(4),a=n(30),o=(n(179),n(192));customElements.define("ha-state-icon",class extends a.a{static get template(){return i.a`
    ...
    `}static get properties(){return{device:Object,devices:Array,areas:Array,entities:Array,hass:Object,narrow:{type:Boolean,reflectToAttribute:!0},hideSettings:{type:Boolean,value:!1},_childDevices:{type:Array,computed:"_computeChildDevices(device, devices)"}}}firstUpdated(t){super.firstUpdated(t),Object(p.a)()}connectedCallback(){super.connectedCallback(),this._unsubAreas=Object(d.c)(this.hass.connection,t=>{this._areas=t}),this._unsubDevices=Object(l.a)(this.hass.connection,t=>{this.devices=t,this.device=t.find(t=>t.id===this.device.id)})}disconnectedCallback(){super.disconnectedCallback(),this._unsubAreas&&this._unsubAreas(),this._unsubDevices&&this._unsubDevices()}_computeArea(t,e){return t&&e&&e.area_id?t.find(t=>t.area_id===e.area_id).name:"No Area"}_computeChildDevices(t,e){return e.filter(e=>e.via_device_id===t.id).sort((t,e)=>Object(c.b)(t.name,e.name))}_computeDeviceEntities(t,e,n){return n.filter(t=>t.device_id===e.id).sort((e,n)=>Object(c.b)(u(t,e)||`zzz${e.entity_id}`,u(t,n)||`zzz${n.entity_id}`))}_computeStateObj(t,e){return e.states[t.entity_id]}_computeEntityName(t,e){return u(e,t)||`(${this.localize("ui.panel.config.integrations.config_entry.entity_unavailable")})`}_deviceName(t){return t.name_by_user||t.name}_computeDeviceName(t,e){const n=t.find(t=>t.id===e);return n?this._deviceName(n):`(${this.localize("ui.panel.config.integrations.config_entry.device_unavailable")})`}_gotoSettings(){const t=this.device;Object(p.b)(this,{device:t,updateEntry:async e=>{await Object(l.b)(this.hass,t.id,e)}})}_openMoreInfo(t){this.fire("hass-more-info",{entityId:t.model.entity.entity_id})}})},724:function(t,e,n){"use strict";n.r(e);var i,a,o,r,s,c,l,d=n(0),p=(n(234),n(1)),u=(n(182),n(251),n(85),n(109),n(143),n(181),n(177),n(241),n(232),n(411),n(152),n(95),n(179),n(96)),h=(n(195),n(176)),f=n(407),m=n(308),b=n(18),g=(function(t){function e(){return null!==t&&t.apply(this,arguments)||this}d.d(e,t),e.prototype.connectedCallback=function(){t.prototype.connectedCallback.call(this),Object(f.a)()},e.prototype.render=function(){var t=this;return Object(p.f)(c||(c=d.f(["\n      <hass-subpage\n        header=","\n      >\n        ",'\n\n        <ha-config-section class="configured">\n          <span slot="header"\n            >',"</span\n          >\n          <ha-card>\n            ",'\n          </ha-card>\n        </ha-config-section>\n\n        <ha-fab\n          icon="hass:plus"\n          title=',"\n          @click=","\n          ?rtl=","\n        ></ha-fab>\n      </hass-subpage>\n    "],["\n      <hass-subpage\n        header=","\n      >\n        ",'\n\n        <ha-config-section class="configured">\n          <span slot="header"\n            >',"</span\n          >\n          <ha-card>\n            ",'\n          </ha-card>\n        </ha-config-section>\n\n        <ha-fab\n          icon="hass:plus"\n          title=',"\n          @click=","\n          ?rtl=","\n        ></ha-fab>\n      </hass-subpage>\n    "])),this.hass.localize("ui.panel.config.integrations.caption"),this.configEntriesInProgress.length?Object(p.f)(a||(a=d.f(['\n              <ha-config-section>\n                <span slot="header"\n                  >',"</span\n                >\n                <ha-card>\n                  ","\n                </ha-card>\n              </ha-config-section>\n            "],['\n              <ha-config-section>\n                <span slot="header"\n                  >',"</span\n                >\n                <ha-card>\n                  ","\n                </ha-card>\n              </ha-config-section>\n            "])),this.hass.localize("ui.panel.config.integrations.discovered"),this.configEntriesInProgress.map(function(e){return Object(p.f)(i||(i=d.f(['\n                      <div class="config-entry-row">\n                        <paper-item-body>\n                          ',"\n                        </paper-item-body>\n                        <mwc-button\n                          @click=",'\n                          data-id="','"\n                          >',"</mwc-button\n                        >\n                      </div>\n                    "],['\n                      <div class="config-entry-row">\n                        <paper-item-body>\n                          ',"\n                        </paper-item-body>\n                        <mwc-button\n                          @click=",'\n                          data-id="','"\n                          >',"</mwc-button\n                        >\n                      </div>\n                    "])),Object(m.g)(t.hass.localize,e),t._continueFlow,e.flow_id,t.hass.localize("ui.panel.config.integrations.configure"))})):"",this.hass.localize("ui.panel.config.integrations.configured"),this.entityRegistryEntries.length?this.configEntries.map(function(e,n){return Object(p.f)(r||(r=d.f(['\n                    <a\n                      href="/config/integrations/config_entry/','"\n                    >\n                      <paper-item data-index=',">\n                        <paper-item-body two-line>\n                          <div>\n                            ",":\n                            ","\n                          </div>\n                          <div secondary>\n                            ","\n                          </div>\n                        </paper-item-body>\n                        <ha-icon-next></ha-icon-next>\n                      </paper-item>\n                    </a>\n                  "],['\n                    <a\n                      href="/config/integrations/config_entry/','"\n                    >\n                      <paper-item data-index=',">\n                        <paper-item-body two-line>\n                          <div>\n                            ",":\n                            ","\n                          </div>\n                          <div secondary>\n                            ","\n                          </div>\n                        </paper-item-body>\n                        <ha-icon-next></ha-icon-next>\n                      </paper-item>\n                    </a>\n                  "])),e.entry_id,n,t.hass.localize("component."+e.domain+".config.title"),e.title,t._getEntities(e).map(function(t){return Object(p.f)(o||(o=d.f(["\n                                <span>\n                                  <ha-state-icon\n                                    .stateObj=",'\n                                  ></ha-state-icon>\n                                  <paper-tooltip position="bottom"\n                                    >',"</paper-tooltip\n                                  >\n                                </span>\n                              "],["\n                                <span>\n                                  <ha-state-icon\n                                    .stateObj=",'\n                                  ></ha-state-icon>\n                                  <paper-tooltip position="bottom"\n                                    >',"</paper-tooltip\n                                  >\n                                </span>\n                              "])),t,Object(h.a)(t))}))}):Object(p.f)(s||(s=d.f(['\n                  <div class="config-entry-row">\n                    <paper-item-body two-line>\n                      <div>\n                        ',"\n                      </div>\n                    </paper-item-body>\n                  </div>\n                "],['\n                  <div class="config-entry-row">\n                    <paper-item-body two-line>\n                      <div>\n                        ',"\n                      </div>\n                    </paper-item-body>\n                  </div>\n                "])),this.hass.localize("ui.panel.config.integrations.none")),this.hass.localize("ui.panel.config.integrations.new"),this._createFlow,Object(u.a)(this.hass))},e.prototype._createFlow=function(){var t=this;Object(f.b)(this,{dialogClosedCallback:function(){return Object(b.a)(t,"hass-reload-entries")}})},e.prototype._continueFlow=function(t){var e=this;Object(f.b)(this,{continueFlowId:t.target.getAttribute("data-id")||void 0,dialogClosedCallback:function(){return Object(b.a)(e,"hass-reload-entries")}})},e.prototype._getEntities=function(t){var e=this;if(!this.entityRegistryEntries)return[];var n=[];return this.entityRegistryEntries.forEach(function(i){i.config_entry_id===t.entry_id&&i.entity_id in e.hass.states&&n.push(e.hass.states[i.entity_id])}),n},Object.defineProperty(e,"styles",{get:function(){return Object(p.c)(l||(l=d.f(["\n      ha-card {\n        overflow: hidden;\n      }\n      mwc-button {\n        top: 3px;\n        margin-right: -0.57em;\n      }\n      .config-entry-row {\n        display: flex;\n        padding: 0 16px;\n      }\n      ha-icon {\n        cursor: pointer;\n        margin: 8px;\n      }\n      .configured a {\n        color: var(--primary-text-color);\n        text-decoration: none;\n      }\n      ha-fab {\n        position: fixed;\n        bottom: 16px;\n        right: 16px;\n        z-index: 1;\n      }\n\n      ha-fab[rtl] {\n        right: auto;\n        left: 16px;\n      }\n    "],["\n      ha-card {\n        overflow: hidden;\n      }\n      mwc-button {\n        top: 3px;\n        margin-right: -0.57em;\n      }\n      .config-entry-row {\n        display: flex;\n        padding: 0 16px;\n      }\n      ha-icon {\n        cursor: pointer;\n        margin: 8px;\n      }\n      .configured a {\n        color: var(--primary-text-color);\n        text-decoration: none;\n      }\n      ha-fab {\n        position: fixed;\n        bottom: 16px;\n        right: 16px;\n        z-index: 1;\n      }\n\n      ha-fab[rtl] {\n        right: auto;\n        left: 16px;\n      }\n    "])))},enumerable:!0,configurable:!0}),d.c([Object(p.g)()],e.prototype,"hass",void 0),d.c([Object(p.g)()],e.prototype,"configEntries",void 0),d.c([Object(p.g)()],e.prototype,"entityRegistryEntries",void 0),d.c([Object(p.g)()],e.prototype,"configEntriesInProgress",void 0),e=d.c([Object(p.d)("ha-config-entries-dashboard")],e)}(p.a),n(124)),y=(n(161),n(184),n(198)),v=(n(412),n(185),n(4)),x=n(30),_=n(118),w=n(175),k=n(265);customElements.define("ha-ce-entities-card",class extends(Object(w.a)(Object(_.a)(x.a))){static get template(){return v.a`
      <style>
        ha-card {
          flex: 1 0 100%;
          padding-bottom: 8px;
    ...
    `}static get properties(){return{heading:String,entities:Array,hass:Object}}_computeStateObj(t,e){return e.states[t.entity_id]}_computeEntityName(t,e){return Object(k.a)(e,t)||`(${this.localize("ui.panel.config.integrations.config_entry.entity_unavailable")})`}_openMoreInfo(t){this.fire("hass-more-info",{entityId:t.model.entity.entity_id})}});var j,O,E,C,z,P,S,I,A,$=function(t,e){return t.callApi("POST","config/config_entries/options/flow",{handler:e})},F=function(t,e){return t.callApi("GET","config/config_entries/options/flow/"+e)},D=function(t,e,n){return t.callApi("POST","config/config_entries/options/flow/"+e,n)},T=function(t,e){return t.callApi("DELETE","config/config_entries/options/flow/"+e)},L=n(58),R=n(362),q=(R.a,n(99)),N=n(299),M=function(){return n.e(24).then(n.bind(null,711))},V=function(t){function e(){var e=null!==t&&t.apply(this,arguments)||this;return e._computeConfigEntryDevices=Object(g.a)(function(t,e){return e?e.filter(function(e){return e.config_entries.includes(t.entry_id)}).sort(function(t,e){return Number(!!t.via_device_id)-Number(!!e.via_device_id)||Object(y.b)(t.name||"",e.name||"")}):[]}),e._computeNoDeviceEntities=Object(g.a)(function(t,e){return e?e.filter(function(e){return!e.device_id&&e.config_entry_id===t.entry_id}):[]}),e}return d.d(e,t),Object.defineProperty(e.prototype,"_configEntry",{get:function(){var t=this;return this.configEntries?this.configEntries.find(function(e){return e.entry_id===t.configEntryId}):void 0},enumerable:!0,configurable:!0}),e.prototype.render=function(){var t=this,e=this._configEntry;if(!e)return Object(p.f)(E||(E=d.f(['\n        <hass-error-screen error="Integration not found."></hass-error-screen>\n      '],['\n        <hass-error-screen error="Integration not found."></hass-error-screen>\n      '])));var n=this._computeConfigEntryDevices(e,this.deviceRegistryEntries),i=this._computeNoDeviceEntities(e,this.entityRegistryEntries);return Object(p.f)(I||(I=d.f(["\n      <hass-subpage .header=",">\n        ",'\n        <paper-icon-button\n          slot="toolbar-icon"\n          icon="hass:message-settings-variant"\n          @click=','\n        ></paper-icon-button>\n        <paper-icon-button\n          slot="toolbar-icon"\n          icon="hass:delete"\n          @click=','\n        ></paper-icon-button>\n\n        <div class="content">\n          ',"\n          ","\n          ","\n        </div>\n      </hass-subpage>\n    "],["\n      <hass-subpage .header=",">\n        ",'\n        <paper-icon-button\n          slot="toolbar-icon"\n          icon="hass:message-settings-variant"\n          @click=','\n        ></paper-icon-button>\n        <paper-icon-button\n          slot="toolbar-icon"\n          icon="hass:delete"\n          @click=','\n        ></paper-icon-button>\n\n        <div class="content">\n          ',"\n          ","\n          ","\n        </div>\n      </hass-subpage>\n    "])),e.title,e.supports_options?Object(p.f)(C||(C=d.f(['\n              <paper-icon-button\n                slot="toolbar-icon"\n                icon="hass:settings"\n                @click=',"\n              ></paper-icon-button>\n            "],['\n              <paper-icon-button\n                slot="toolbar-icon"\n                icon="hass:settings"\n                @click=',"\n              ></paper-icon-button>\n            "])),this._showSettings):"",this._showSystemOptions,this._removeEntry,0===n.length&&0===i.length?Object(p.f)(z||(z=d.f(["\n                <p>\n                  ","\n                </p>\n              "],["\n                <p>\n                  ","\n                </p>\n              "])),this.hass.localize("ui.panel.config.integrations.config_entry.no_devices")):"",n.map(function(e){return Object(p.f)(P||(P=d.f(['\n              <ha-device-card\n                class="card"\n                .hass=',"\n                .areas=","\n                .devices=","\n                .device=","\n                .entities=","\n                .narrow=","\n              ></ha-device-card>\n            "],['\n              <ha-device-card\n                class="card"\n                .hass=',"\n                .areas=","\n                .devices=","\n                .device=","\n                .entities=","\n                .narrow=","\n              ></ha-device-card>\n            "])),t.hass,t.areas,t.deviceRegistryEntries,e,t.entityRegistryEntries,t.narrow)}),i.length>0?Object(p.f)(S||(S=d.f(['\n                <ha-ce-entities-card\n                  class="card"\n                  .heading=',"\n                  .entities=","\n                  .hass=","\n                  .narrow=","\n                ></ha-ce-entities-card>\n              "],['\n                <ha-ce-entities-card\n                  class="card"\n                  .heading=',"\n                  .entities=","\n                  .hass=","\n                  .narrow=","\n                ></ha-ce-entities-card>\n              "])),this.hass.localize("ui.panel.config.integrations.config_entry.no_device"),i,this.hass,this.narrow):"")},e.prototype._showSettings=function(){var t,e;t=this,e=this._configEntry,Object(R.b)(t,{startFlowHandler:e.entry_id},{loadDevicesAndAreas:!1,createFlow:$,fetchFlow:F,handleFlowStep:D,deleteFlow:T,renderAbortDescription:function(t,n){var i=Object(L.b)(t.localize,"component."+e.domain+".options.abort."+n.reason,n.description_placeholders);return i?Object(p.f)(j||(j=d.f(["\n              <ha-markdown allowsvg .content=","></ha-markdown>\n            "],["\n              <ha-markdown allowsvg .content=","></ha-markdown>\n            "])),i):""},renderShowFormStepHeader:function(t,e){return t.localize("ui.dialogs.options_flow.form.header")},renderShowFormStepDescription:function(t,e){return""},renderShowFormStepFieldLabel:function(t,n,i){return t.localize("component."+e.domain+".options.step."+n.step_id+".data."+i.name)},renderShowFormStepFieldError:function(t,n,i){return t.localize("component."+e.domain+".options.error."+i)},renderExternalStepHeader:function(t,e){return""},renderExternalStepDescription:function(t,e){return""},renderCreateEntryDescription:function(t,e){return Object(p.f)(O||(O=d.f(["\n          <p>","</p>\n        "],["\n          <p>","</p>\n        "])),t.localize("ui.dialogs.options_flow.success.description"))}})},e.prototype._showSystemOptions=function(){var t,e;t=this,e={entry:this._configEntry},Object(b.a)(t,"show-dialog",{dialogTag:"dialog-config-entry-system-options",dialogImport:M,dialogParams:e})},e.prototype._removeEntry=function(){var t=this;confirm(this.hass.localize("ui.panel.config.integrations.config_entry.delete_confirm"))&&Object(N.a)(this.hass,this.configEntryId).then(function(e){Object(b.a)(t,"hass-reload-entries"),e.require_restart&&alert(t.hass.localize("ui.panel.config.integrations.config_entry.restart_confirm")),Object(q.a)(t,"/config/integrations/dashboard",!0)})},Object.defineProperty(e,"styles",{get:function(){return Object(p.c)(A||(A=d.f(["\n      .content {\n        display: flex;\n        flex-wrap: wrap;\n        padding: 4px;\n        justify-content: center;\n      }\n      .card {\n        box-sizing: border-box;\n        display: flex;\n        flex: 1 0 300px;\n        min-width: 0;\n        max-width: 500px;\n        padding: 8px;\n      }\n    "],["\n      .content {\n        display: flex;\n        flex-wrap: wrap;\n        padding: 4px;\n        justify-content: center;\n      }\n      .card {\n        box-sizing: border-box;\n        display: flex;\n        flex: 1 0 300px;\n        min-width: 0;\n        max-width: 500px;\n        padding: 8px;\n      }\n    "])))},enumerable:!0,configurable:!0}),d.c([Object(p.g)()],e.prototype,"hass",void 0),d.c([Object(p.g)()],e.prototype,"narrow",void 0),d.c([Object(p.g)()],e.prototype,"configEntryId",void 0),d.c([Object(p.g)()],e.prototype,"configEntries",void 0),d.c([Object(p.g)()],e.prototype,"entityRegistryEntries",void 0),d.c([Object(p.g)()],e.prototype,"deviceRegistryEntries",void 0),d.c([Object(p.g)()],e.prototype,"areas",void 0),e}(p.a);customElements.define("ha-config-entry-page",V);var B=n(226),U=n(133),W=n(222);!function(t){function e(){var e=null!==t&&t.apply(this,arguments)||this;return e.routerOptions={defaultPage:"dashboard",routes:{dashboard:{tag:"ha-config-entries-dashboard"},config_entry:{tag:"ha-config-entry-page"}}},e._configEntries=[],e._configEntriesInProgress=[],e._entityRegistryEntries=[],e._deviceRegistryEntries=[],e._areas=[],e}d.d(e,t),e.prototype.connectedCallback=function(){t.prototype.connectedCallback.call(this),this.hass&&this._loadData()},e.prototype.disconnectedCallback=function(){if(t.prototype.disconnectedCallback.call(this),this._unsubs){for(;this._unsubs.length;)this._unsubs.pop()();this._unsubs=void 0}},e.prototype.firstUpdated=function(e){var n=this;t.prototype.firstUpdated.call(this,e),this.addEventListener("hass-reload-entries",function(){n._loadData(),Object(m.e)(n.hass.connection).refresh()})},e.prototype.updated=function(e){t.prototype.updated.call(this,e),!this._unsubs&&e.has("hass")&&this._loadData()},e.prototype.updatePageEl=function(t){t.hass=this.hass,t.entityRegistryEntries=this._entityRegistryEntries,t.configEntries=this._configEntries,"dashboard"!==this._currentPage?(t.configEntryId=this.routeTail.path.substr(1),t.deviceRegistryEntries=this._deviceRegistryEntries,t.areas=this._areas,t.narrow=this.narrow):t.configEntriesInProgress=this._configEntriesInProgress},e.prototype._loadData=function(){var t=this;Object(N.b)(this.hass).then(function(e){t._configEntries=e.sort(function(t,e){return Object(y.b)(t.title,e.title)})}),this._unsubs||(this._unsubs=[Object(B.c)(this.hass.connection,function(e){t._areas=e}),Object(k.c)(this.hass.connection,function(e){t._entityRegistryEntries=e}),Object(W.a)(this.hass.connection,function(e){t._deviceRegistryEntries=e}),Object(m.h)(this.hass,function(e){t._configEntriesInProgress=e})])},d.c([Object(p.g)()],e.prototype,"hass",void 0),d.c([Object(p.g)()],e.prototype,"narrow",void 0),d.c([Object(p.g)()],e.prototype,"_configEntries",void 0),d.c([Object(p.g)()],e.prototype,"_configEntriesInProgress",void 0),d.c([Object(p.g)()],e.prototype,"_entityRegistryEntries",void 0),d.c([Object(p.g)()],e.prototype,"_deviceRegistryEntries",void 0),d.c([Object(p.g)()],e.prototype,"_areas",void 0),e=d.c([Object(p.d)("ha-config-integrations")],e)}(U.a)},93:function(t,e,n){"use strict";n(5),n(113),n(114),n(115),n(116);var i=n(60),a=(n(41),n(6)),o=n(4),r=n(97);Object(a.a)({is:"paper-input",_template:o.a`
    <style>
      :host {
        display: block;
      }
...
//# sourceMappingURL=chunk.1ad252306d09bed30335.js.map