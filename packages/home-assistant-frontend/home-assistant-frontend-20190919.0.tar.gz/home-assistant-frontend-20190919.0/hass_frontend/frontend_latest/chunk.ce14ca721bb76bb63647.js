/*! For license information please see chunk.ce14ca721bb76bb63647.js.LICENSE */
...
`;n.setAttribute("strip-whitespace",""),Object(s.a)({_template:n,is:"paper-spinner",behaviors:[i.a]})},195:function(e,t,a){"use strict";var s=a(4),o=a(30);a(95);customElements.define("ha-config-section",class extends o.a{static get template(){return s.a`
    ...
    `}static get properties(){return{hass:{type:Object},progress:{type:Boolean,value:!1},disabled:{type:Boolean,value:!1}}}tempClass(e){var t=this.$.container.classList;t.add(e),setTimeout(()=>{t.remove(e)},1e3)}ready(){super.ready(),this.addEventListener("click",e=>this.buttonTapped(e))}buttonTapped(e){this.progress&&e.stopPropagation()}actionSuccess(){this.tempClass("success")}actionError(){this.tempClass("error")}computeDisabled(e,t){return e||t}})},241:function(e,t,a){"use strict";a(109);var s=a(179);customElements.define("ha-icon-next",class extends s.a{connectedCallback(){super.connectedCallback(),setTimeout(()=>{this.icon="ltr"===window.getComputedStyle(this).direction?"hass:chevron-right":"hass:chevron-left"},100)}})},250:function(e,t,a){"use strict";var s=a(9),o=a(99);t.a=Object(s.a)(e=>(class extends e{navigate(...e){Object(o.a)(this,...e)}}))},333:function(e,t,a){"use strict";a.d(t,"a",function(){return o});var s=a(48);const o=(e,t)=>Object(s.a)(e,{message:t.localize("ui.common.successfully_saved")})},336:function(e,t,a){"use strict";var s=a(0),o=(a(218),a(18));customElements.define("ha-call-api-button",class extends s.a{render(){return s.f`
      <ha-progress-button
        ...
        ><slot></slot
      ></ha-progress-button>
    `}constructor(){super(),this.method="POST",this.data={},this.disabled=!1,this.progress=!1}static get properties(){return{hass:{},progress:Boolean,path:String,method:String,data:{},disabled:Boolean}}get progressButton(){return this.renderRoot.querySelector("ha-progress-button")}async _buttonTapped(){this.progress=!0;const e={method:this.method,path:this.path,data:this.data};try{const a=await this.hass.callApi(this.method,this.path,this.data);this.progress=!1,this.progressButton.actionSuccess(),e.success=!0,e.response=a}catch(t){this.progress=!1,this.progressButton.actionError(),e.success=!1,e.response=t}Object(o.a)(this,"hass-api-called",e)}})},464:function(e,t,a){"use strict";a.d(t,"a",function(){return s}),a.d(t,"b",function(){return o});const s=e=>e.callWS({type:"cloud/alexa/entities"}),o=e=>e.callWS({type:"cloud/alexa/sync"})},721:function(e,t,a){"use strict";a.r(t);var s=a(3),o=(a(85),a(181),a(207),a(4)),i=a(30),n=(a(177),a(336),a(152),a(95),a(195),a(0));a(143),a(187);const r=e=>e.callWS({type:"webhook/list"});var c=a(279),l=a(18);const d=(e,t)=>{Object(l.a)(e,"show-dialog",{dialogTag:"dialog-manage-cloudhook",dialogImport:()=>Promise.all([a.e(1),a.e(21)]).then(a.bind(null,708)),dialogParams:t})};customElements.define("cloud-webhooks",class extends n.a{static get properties(){return{hass:{},cloudStatus:{},_cloudHooks:{},_localHooks:{},_progress:{}}}constructor(){super(),this._progress=[]}connectedCallback(){super.connectedCallback(),this._fetchData()}render(){return n.f`
      ${this.renderStyle()}
    ...
    `}});var u=a(200),p=a(118),h=a(175),g=a(464);class m extends n.a{constructor(){super(...arguments),this._syncing=!1}render(){if(!this.cloudStatus)return n.f``;const{alexa_enabled:e,alexa_report_state:t}=this.cloudStatus.prefs;return n.f`
