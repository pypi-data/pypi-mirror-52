...
`},694:function(t,e,i){"use strict";i.r(e),i.d(e,"HuiPlantStatusCardEditor",function(){return c});var n=i(3),a=i(0),s=(i(93),i(190),i(179),i(199)),o=i(18),l=i(205);const r=Object(s.a)({type:"string",entity:"string",name:"string?"});let c=class extends a.a{setConfig(t){t=r(t),this._config=t}get _entity(){return this._config.entity||""}get _name(){return this._config.name||""}render(){return this.hass?a.f`
      ${l.a}
...
//# sourceMappingURL=chunk.ed6aedc51e3d56e88ff4.js.map