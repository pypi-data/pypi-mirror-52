...
`,is:"paper-dialog-scrollable",properties:{dialogElement:{type:Object}},get scrollTarget(){return this.$.scrollable},ready:function(){this._ensureTarget(),this.classList.add("no-padding")},attached:function(){this._ensureTarget(),requestAnimationFrame(this.updateScrollState.bind(this))},updateScrollState:function(){this.toggleClass("is-scrolled",this.scrollTarget.scrollTop>0),this.toggleClass("can-scroll",this.scrollTarget.offsetHeight<this.scrollTarget.scrollHeight),this.toggleClass("scrolled-to-bottom",this.scrollTarget.scrollTop+this.scrollTarget.offsetHeight>=this.scrollTarget.scrollHeight)},_ensureTarget:function(){this.dialogElement=this.dialogElement||this.parentElement,this.dialogElement&&this.dialogElement.behaviors&&this.dialogElement.behaviors.indexOf(i.b)>=0?(this.dialogElement.sizingTarget=this.scrollTarget,this.scrollTarget.classList.remove("fit")):this.dialogElement&&this.scrollTarget.classList.add("fit")}})},706:function(e,t,a){"use strict";a.r(t);var i=a(3),s=a(0),n=(a(208),a(93),a(144),a(146),a(143),a(85),a(194),a(56)),o=a(233);let r=class extends s.a{async showDialog(e){this._params=e,this._error=void 0,this._nameByUser=this._params.device.name_by_user||"",this._areaId=this._params.device.area_id,await this.updateComplete}connectedCallback(){super.connectedCallback(),this._unsubAreas=Object(o.c)(this.hass.connection,e=>{this._areas=e})}disconnectedCallback(){super.disconnectedCallback(),this._unsubAreas&&this._unsubAreas()}render(){if(!this._params)return s.f``;const e=this._params.device;return s.f`
    ...
    `}_nameChanged(e){this._error=void 0,this._nameByUser=e.detail.value}_renderAreas(){if(this._areas)return this._areas.map(e=>s.f`
      ...
      `]}};i.b([Object(s.g)()],r.prototype,"hass",void 0),i.b([Object(s.g)()],r.prototype,"_nameByUser",void 0),i.b([Object(s.g)()],r.prototype,"_error",void 0),i.b([Object(s.g)()],r.prototype,"_params",void 0),i.b([Object(s.g)()],r.prototype,"_areas",void 0),i.b([Object(s.g)()],r.prototype,"_areaId",void 0),r=i.b([Object(s.d)("dialog-device-registry-detail")],r)}}]);
//# sourceMappingURL=chunk.b80e59dfaaf0f5f3fde1.js.map