...
`},693:function(t,e,i){"use strict";i.r(e),i.d(e,"HuiWeatherForecastCardEditor",function(){return c});var n=i(3),a=i(0),s=(i(190),i(197)),o=i(18),l=i(205);const r=Object(s.a)({type:"string",entity:"string?",name:"string?"});let c=class extends a.a{setConfig(t){t=r(t),this._config=t}get _entity(){return this._config.entity||""}get _name(){return this._config.name||""}render(){return this.hass?a.f`
      ${l.a}
...
//# sourceMappingURL=chunk.d10fbee2584137edaf85.js.map