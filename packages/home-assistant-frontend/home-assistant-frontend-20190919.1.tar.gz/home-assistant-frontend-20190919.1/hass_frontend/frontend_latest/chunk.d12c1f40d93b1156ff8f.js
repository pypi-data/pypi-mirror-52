/*! For license information please see chunk.d12c1f40d93b1156ff8f.js.LICENSE */
...
`;o.setAttribute("strip-whitespace",""),Object(s.a)({_template:o,is:"paper-spinner",behaviors:[r.a]})},739:function(e,t,a){"use strict";a.r(t);var s=a(3),i=a(0),r=a(56);a(187),a(177);const o=e=>e.callWS({type:"system_health/info"}),c=(e,t)=>"homeassistant"===e?-1:"homeassistant"===t?1:e<t?-1:t<e?1:0;customElements.define("system-health-card",class extends i.a{static get properties(){return{hass:{},_info:{}}}render(){if(!this.hass)return;const e=[];if(this._info){const t=Object.keys(this._info).sort(c);for(const a of t){const t=[];for(const e of Object.keys(this._info[a]).sort())t.push(i.f`
    ...
    `}});const l="latest",n="20190919.1",d="states";class h extends i.a{render(){const e=this.hass,t=window.CUSTOM_UI_LIST||[],a=localStorage.defaultPage===d&&"states"===d?"/lovelace":"/states",s=localStorage.defaultPage===d&&"states"===d?"Go to the Lovelace UI":"Go to the states UI",r=`${localStorage.defaultPage===d?"Remove":"Set"} ${d} as default page on this device`;return i.f`
      <div class="about">
        <p class="version">
...
//# sourceMappingURL=chunk.d12c1f40d93b1156ff8f.js.map