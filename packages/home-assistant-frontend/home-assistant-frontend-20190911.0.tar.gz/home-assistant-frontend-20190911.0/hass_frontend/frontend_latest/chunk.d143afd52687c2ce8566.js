...
`},237:function(e,t,i){"use strict";var n=i(3),s=i(0),a=(i(85),i(18));let o=class extends s.a{render(){const e=["Backend-selected","default"].concat(Object.keys(this.hass.themes.themes).sort());return s.f`
    ...
    `}};n.b([Object(s.g)()],o.prototype,"hass",void 0),n.b([Object(s.g)()],o.prototype,"entities",void 0),o=n.b([Object(s.d)("hui-entity-editor")],o)},299:function(e,t,i){"use strict";function n(e){return e.map(e=>"string"==typeof e?{entity:e}:e)}i.d(t,"a",function(){return n})},678:function(e,t,i){"use strict";i.r(t),i.d(t,"HuiGlanceCardEditor",function(){return d});var n=i(3),s=i(0),a=(i(146),i(143),i(144),i(207),i(185),i(237),i(247),i(177),i(179),i(197)),o=i(299),c=i(18),l=i(205);const h=a.a.union([{entity:"entity-id",name:"string?",icon:"icon?"},"entity-id"]),r=Object(a.a)({type:"string",title:"string|number?",theme:"string?",columns:"number?",show_name:"boolean?",show_state:"boolean?",show_icon:"boolean?",entities:[h]});let d=class extends s.a{setConfig(e){e=r(e),this._config=e,this._configEntities=Object(o.a)(e.entities)}get _title(){return this._config.title||""}get _theme(){return this._config.theme||"Backend-selected"}get _columns(){return this._config.columns||NaN}get _show_name(){return this._config.show_name||!0}get _show_icon(){return this._config.show_icon||!0}get _show_state(){return this._config.show_state||!0}render(){return this.hass?s.f`
      ${l.a}
...
//# sourceMappingURL=chunk.d143afd52687c2ce8566.js.map