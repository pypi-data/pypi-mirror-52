...
class ExploreApi(object):
    ...
    def aggregate_with_http_info(self, collection, agg, **kwargs):
        ...
        all_params = ['collection', 'agg', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'pretty', 'flat', 'max_age_cache']
        ...
        if 'pwithin' in params:
            query_params.append(('pwithin', params['pwithin']))
            collection_formats['pwithin'] = 'multi'
        if 'gwithin' in params:
            query_params.append(('gwithin', params['gwithin']))
            collection_formats['gwithin'] = 'multi'
        if 'gintersect' in params:
            query_params.append(('gintersect', params['gintersect']))
            collection_formats['gintersect'] = 'multi'
        if 'notpwithin' in params:
            query_params.append(('notpwithin', params['notpwithin']))
            collection_formats['notpwithin'] = 'multi'
        if 'notgwithin' in params:
            query_params.append(('notgwithin', params['notgwithin']))
            collection_formats['notgwithin'] = 'multi'
        if 'notgintersect' in params:
            query_params.append(('notgintersect', params['notgintersect']))
            collection_formats['notgintersect'] = 'multi'
    ...
    def count_with_http_info(self, collection, **kwargs):
        ...
        all_params = ['collection', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'pretty', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def geohashgeoaggregate_with_http_info(self, collection, geohash, **kwargs):
        ...
        all_params = ['collection', 'geohash', 'agg', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'pretty', 'flat', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def geosearch_with_http_info(self, collection, **kwargs):
        ...
        all_params = ['collection', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'pretty', 'flat', 'include', 'exclude', 'size', '_from', 'sort', 'after', 'before', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def range(self, collection, field, **kwargs):
        """
        RangeRequest
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.range(collection, field, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str collection: collection (required)
        :param str field: The field whose range is calculated (required)
        :param list[str] f: - A triplet for filtering the result. Multiple filter can be provided in distinct parameters (AND operator is applied) or in the same parameter separated by semi-colons (OR operator is applied). The order does not matter.    - A triplet is composed of a field name, a comparison operator and a value.      The possible values of the comparison operator are :           Operator |                   Description                    | value type          :eq:     | {fieldName} equals {comma separated values}. **OR** operation is applied for the specified values | numeric or strings           :ne:     | {fieldName} must not equal {comma separated values }. **AND** operation is applied for the specified values | numeric or strings           :like:   | {fieldName}  is like {value}                     | numeric or strings           :gte:    | {fieldName} is greater than or equal to  {value} | numeric           :gt:     | {fieldName} is greater than {value}              | numeric           :lte:    | {fieldName} is less than or equal to {value}     | numeric           :lt:     | {fieldName}  is less than {value}                | numeric           :range:  | {fieldName} is between `{comma separated [min<max] values}`. **OR** operation is applied for the specified ranges | numeric or strings. If the field's type is date, then min & max should be timestamps in millisecond or a Date expression
        :param list[str] q: A full text search. Optionally, it's possible to search on a field using this syntax: {fieldname}:{text}
        :param list[str] pwithin: Any element having its centroid contained within the given WKT Polygon or MultiPolygon (clock-wise) or the given BBOX : `west, south, east, north`. 
        :param list[str] gwithin: Any element having its geometry contained within the given WKT string (clock-wise) or the given BBOX : `west, south, east, north`
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.range_with_http_info(collection, field, **kwargs)
        else:
            (data) = self.range_with_http_info(collection, field, **kwargs)
            return data

    def range_with_http_info(self, collection, field, **kwargs):
        """
        RangeRequest
        Calculates the min and max values of a field in the collection, given the filters
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.range_with_http_info(collection, field, callback=callback_function)
        ...
        all_params = ['collection', 'field', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'pretty', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'collection' is set
        if ('collection' not in params) or (params['collection'] is None):
            raise ValueError("Missing the required parameter `collection` when calling `range`")
        # verify the required parameter 'field' is set
        if ('field' not in params) or (params['field'] is None):
            raise ValueError("Missing the required parameter `field` when calling `range`")
        ...
        return self.api_client.call_api('/explore/{collection}/_range', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def range_post(self, collection, **kwargs):
        """
        Aggregate
        Calculates the min and max values of a field in the collection, given the filters
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.range_post(collection, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str collection: collection (required)
        :param RangeRequest body:
        :param bool pretty: Pretty print
        :param int max_age_cache: max-age-cache
        :return: RangeResponse
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.range_post_with_http_info(collection, **kwargs)
        else:
            (data) = self.range_post_with_http_info(collection, **kwargs)
            return data

    def range_post_with_http_info(self, collection, **kwargs):
        """
        Aggregate
        Calculates the min and max values of a field in the collection, given the filters
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.range_post_with_http_info(collection, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method range_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'collection' is set
        if ('collection' not in params) or (params['collection'] is None):
            raise ValueError("Missing the required parameter `collection` when calling `range_post`")
        ...
        return self.api_client.call_api('/explore/{collection}/_range', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def suggest(self, collections, **kwargs):
        ...
        :param list[str] pwithin: Any element having its centroid contained within the given geometry (WKT)
        :param list[str] gwithin: Any element having its geometry contained within the given geometry (WKT)
        :param list[str] gintersect: Any element having its geometry intersecting the given geometry (WKT)
        :param list[str] notpwithin: Any element having its centroid outside the given geometry (WKT)
        :param list[str] notgwithin: Any element having its geometry outside the given geometry (WKT)
        :param list[str] notgintersect: Any element having its geometry not intersecting the given geometry (WKT)
        :param bool pretty: Pretty print
        :param int size: The maximum number of entries or sub-entries to be returned. The default value is 10
        :param int _from: From index to start the search from. Defaults to 0.
    ...
    def suggest_with_http_info(self, collections, **kwargs):
        ...
        all_params = ['collections', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'pretty', 'size', '_from', 'field', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def tiledgeosearch_with_http_info(self, collection, x, y, z, **kwargs):
        ...
        all_params = ['collection', 'x', 'y', 'z', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'pretty', 'flat', 'include', 'exclude', 'size', '_from', 'sort', 'after', 'before', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def tiledgeosearch1_with_http_info(self, collection, x, y, z, **kwargs):
        ...
        all_params = ['collection', 'x', 'y', 'z', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'size', '_from', 'sort', 'after', 'before', 'sampling', 'coverage', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
