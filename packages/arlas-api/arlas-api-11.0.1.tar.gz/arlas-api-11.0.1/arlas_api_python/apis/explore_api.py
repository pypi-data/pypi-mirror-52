...
class ExploreApi(object):
    ...
    def aggregate(self, collection, agg, **kwargs):
        ...
        :param list[str] pwithin: Any element having its centroid contained within the given bbox : `west, south, east, north`. 
        :param list[str] gwithin: Any element having its geometry contained within the given geometry (WKT) or the given BBOX : `west, south, east, north`
        :param list[str] gintersect: Any element having its geometry intersecting the given geometry (WKT) or the given BBOX : `west, south, east, north`
        :param list[str] notpwithin: Any element having its centroid outside the given bbox : `west, south, east, north`.
        :param list[str] notgwithin: Any element having its geometry outside the given geometry (WKT) or the given BBOX : `west, south, east, north`
        :param list[str] notgintersect: Any element having its geometry not intersecting the given geometry (WKT) nor the given BBOX : `west, south, east, north`
