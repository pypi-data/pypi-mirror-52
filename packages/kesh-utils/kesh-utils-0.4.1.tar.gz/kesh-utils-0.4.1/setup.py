...
setup(
    ...
    packages=["KUtils/classifier", "KUtils/common", "KUtils/eda", "KUtils/linear_regression", "KUtils/logistic_regression", "KUtils/classifier", "KUtils/cluster", "KUtils/kalgo", "KUtils/stat"],
