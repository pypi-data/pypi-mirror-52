...
For more info see [pyrankvote/ranking_methods.py](https://github.com/jontingvold/pyrankvote/ranking_methods.py) and Wikipedia.
...
## License
[MIT](https://github.com/jontingvold/pyrankvote/LICENSE.txt)