...
def _download_content(DOI, location= None):
    ...
    """
    if location == None:
        location = "/Users/ameyakarnad/Desktop/data/"
    flag = 0
    works = Works()
    try:
...
def download_bulk(DOI_list, location):
    ...
    if location[-1] != "/":
        location = location + "/"
    p=mp.Pool(8)
    p.map(_download_content, DOI_list) 
    p.close()
    p.join()


# Test = _download_content("10.1177/2056305116672885", location = "/Users/ameyakarnad/Desktop/data/")
# DOI_list = ["10.1177/2056305116672885","10.1177/1461444818771083"]