...
class Alert(Base):
    ...
    def __init__(self, payload, alert_timestamp, sensor_ref_name, irflow_alert_id, integration_id, tenant_id,
    ...
    def __repr__(self):
        return "<Alert(Id=%s, payload='%s', " \
               ...
               % (self.id, self.payload, self.alert_timestamp,
                  self.irflow_alert_id, self.integration_id, self.tenant_id, self.sensor_ref_name,
