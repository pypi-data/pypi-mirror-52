    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='badges', to='election.Race')),
            ],
        ),
        migrations.CreateModel(
            name='RaceRating',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to=models.Q(models.Q(('app_label', 'election'), ('model', 'race')), models.Q(('app_label', 'raceratings'), ('model', 'ratingpagetype')), _connector='OR'), on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='children', to='raceratings.RatingPageContent')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('model_type', models.CharField(choices=[('Race', 'race'), ('Home', 'home')], max_length=4)),
            ],
        ),
        migrations.AddField(
            model_name='ratingpagecontentblock',
            name='content_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='raceratings.RatingPageContentType'),
        ),
        migrations.AddField(
            model_name='ratingpagecontentblock',
            name='page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='blocks', to='raceratings.RatingPageContent'),
        ),
