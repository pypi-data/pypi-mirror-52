...
def try_for_config_file(config_rel_path):
    ...
    print(f'interested_file : {interested_file}')
    ...
    print(f'potential_path2 : {potential_path}')
    if os.path.isfile(potential_path):
        print(f'return potential_path2 : {potential_path}')
        return potential_path
