...
from vitaoptimum.result import VitaOptimumPlusBcsResult


class Bcs(VitaOptimumPlusConstrained):
    """Binary Constrained Global Optimization Method"""

    def __init__(self, fobj, dim, ng, nh, np=100,
    ...
    def run(self, restarts=1, verbose=False):
        ...
        self._lib_plus.vitaOptimumPlus_Bcs.restype = ctypes.c_double
        self._lib_plus.vitaOptimumPlus_Bcs.argtypes = [
            callback_type,          # fobj
        ...
        best = self._lib_plus.vitaOptimumPlus_Bcs(
        ...
        return VitaOptimumPlusBcsResult(self._dim, self._fobj_orig, best, xopt, constr,
                                        converged, self._qmeasures)

    def info(self):
        self._lib_plus.vitaOptimumPlus_Bcs_info()
