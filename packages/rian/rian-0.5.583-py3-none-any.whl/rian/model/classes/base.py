...
class Model(nbase.ObjectIP):
    ...
    def optimize(self, *args, **kwds):
        ...
        return rian.model.optimize(self, *args, **kwds)
    ...
    def save(self, *args, **kwds):
        ...
        return rian.model.save(self, *args, **kwds)

    def show(self, *args, **kwds):
        """Show model as image."""
        return rian.model.show(self, *args, **kwds)

    def copy(self, *args, **kwds):
        """Create copy of model."""
        return rian.model.copy(self, *args, **kwds)
