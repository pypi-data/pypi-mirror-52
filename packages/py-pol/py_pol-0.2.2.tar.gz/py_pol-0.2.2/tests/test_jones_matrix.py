...
class TestJonesMatrix(object):
    ...
    def test_diattenuator_azimuth_ellipticity(self):
        ...
        M1.diattenuator_azimuth_ellipticity(
            p1=.75, p2=0.25, az=0 * degrees, el=0 * degrees)
        proposal = M1.get()
        ...
        M1 = Jones_matrix('diat_az_el')
        M1.diattenuator_azimuth_ellipticity(
            p1=0.75, p2=0.25, az=0 * degrees, el=90 * degrees)
        proposal = M1.get()
        assert comparison(proposal, solution,
        ...
        M1 = Jones_matrix('diat_az_el')
        M1.diattenuator_azimuth_ellipticity(
            p1=1, p2=0, az=0 * degrees, el=45 * degrees)
        proposal = M1.get()
        assert comparison(proposal, solution,
        ...
        M1 = Jones_matrix('diat_az_el')
        M1.diattenuator_azimuth_ellipticity(
            p1=0.75, p2=0.25, az=45 * degrees, el=0 * degrees)
        proposal = M1.get()
        assert comparison(proposal, solution,
        ...
        M1 = Jones_matrix('diat_az_el')
        M1.diattenuator_azimuth_ellipticity(
            p1=0.75, p2=0.25, az=45 * degrees, el=90 * degrees)
        proposal = M1.get()
        assert comparison(proposal, solution,
