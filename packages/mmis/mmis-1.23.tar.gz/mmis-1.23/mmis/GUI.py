...
#ImgFolder = '/usr/local/lib/python3.5/dist-packages/mmis/Images/'  # when installed locally using tar.gz
...
class TabSettings(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.image_file = ImgFolder+'HZlogo.png'
        self.Logo.SetFocus()
    ...
    def Excel_File_Header_Generation(self):
        Module_names = ['Not Found','Sample Heater', 'Dual Heater']
...
class MainWindow(wx.Frame):
    ...
    def Create_Notebook(self):
        ...
        bmp1 = wx.Bitmap(ImgFolder+"Connected.png", wx.BITMAP_TYPE_ANY)
        bmp2 = wx.Bitmap(ImgFolder+"Disconnected.png", wx.BITMAP_TYPE_ANY)
        bmp3 = wx.Bitmap(ImgFolder+"warning.png", wx.BITMAP_TYPE_ANY)
    ...
    def OnAbout(self,e):
        ...
        self.about.SetName("Modular Microscope Instrument")
        ...
        icon = wx.Icon()
        icon.CopyFromBitmap(wx.Bitmap(ImgFolder+"DEMOico.ico", wx.BITMAP_TYPE_ANY))
...
def StartGUI():
    ...
    if w>800:
        adj = 0
        w = w-300
        frame = MainWindow(None, -1, "Modular Microscope Instrument", w, h-600, adj)
    else:
        adj = 50
        frame = MainWindow(None, -1, "Modular Microscope Instrument", w, h, adj)
    frame.Show()
    app.MainLoop()
