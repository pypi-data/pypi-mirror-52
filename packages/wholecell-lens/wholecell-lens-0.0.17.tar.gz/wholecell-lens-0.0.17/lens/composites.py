...
#
# def get_emitter_keys(processes):
#     emitter_keys = {}
#     internal_keys = []
#     external_keys = []
#     for process_id, process_object in processes.iteritems():
#         process_keys = process_object.default_emitter_keys()
#         internal_keys.extend(process_keys.get('internal'))
#         external_keys.extend(process_keys.get('external'))
#     emitter_keys['internal'] = list(set(internal_keys))
#     emitter_keys['external'] = list(set(external_keys))
#     return emitter_keys
#
# # composites
...
#     emitter_config['keys'] = get_emitter_keys(processes)
