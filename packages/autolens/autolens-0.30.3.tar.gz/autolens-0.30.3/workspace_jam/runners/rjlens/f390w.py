...
pipeline_settings = al.PipelineSettings(include_shear=True, fix_lens_light=False)
...
# pixel-grid. To run this pipeline on our instrument, simply comment out / delete the lines above (lines 47-51) which run
