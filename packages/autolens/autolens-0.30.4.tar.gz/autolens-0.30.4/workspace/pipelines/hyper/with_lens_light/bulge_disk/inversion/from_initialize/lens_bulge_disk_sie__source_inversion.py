...
def make_pipeline(
    ...
    phase3 = al.PhaseImaging(
        ...
        galaxies=dict(
            lens=al.GalaxyModel(
                redshift=redshift_lens,
                bulge=phase2.result.constant.galaxies.lens.bulge,
                disk=phase2.result.constant.galaxies.lens.disk,
                mass=phase2.result.constant.galaxies.lens.mass,
                shear=phase2.result.constant.galaxies.lens.shear,
    ...
    phase4 = InversionPhase(
        ...
        galaxies=dict(
            lens=al.GalaxyModel(
                redshift=redshift_lens,
                bulge=phase2.result.variable.galaxies.lens.bulge,
                disk=phase2.result.variable.galaxies.lens.disk,
            ...
            source=al.GalaxyModel(
                ...
                hyper_galaxy=phase3.result.hyper_combined.constant.galaxies.source.hyper_galaxy,
            ),
        ),
