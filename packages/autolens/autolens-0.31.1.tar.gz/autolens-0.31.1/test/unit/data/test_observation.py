...
class TestObservation:
    ...
    def test__simulate_imaging_data_from_lens__source_galaxy__compare_to_manual_imaging_data(
        ...
        assert (
            imaging_data.background_noise_map == observation_imaging_data.background_noise_map
        )
        assert imaging_data.poisson_noise_map == observation_imaging_data.poisson_noise_map
        assert (
            imaging_data.exposure_time_map == observation_imaging_data.exposure_time_map
        ).all()
        assert (
            imaging_data.background_sky_map == observation_imaging_data.background_sky_map
        ).all()
    ...
    def test__simulate_imaging_data_from_lens__source_galaxy__and_write_to_fits(self):
        ...
        assert (
            imaging_data.poisson_noise_map == observation_imaging_data_loaded.poisson_noise_map
        )
        assert (
            imaging_data.exposure_time_map == observation_imaging_data_loaded.exposure_time_map
        ).all()
        assert (
