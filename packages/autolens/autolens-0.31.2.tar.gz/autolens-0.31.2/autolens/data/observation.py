...
class ImagingObservation(object):
    ...
    def simulate_imaging_data_from_galaxies(
        ...
        """Simulate Imaging instrument for this instrument, as follows:
        ...
        2) Use this grid and the lens and source galaxies to setup a tracer, which generates the image of \
           the simulated Imaging instrument.

        3) Simulate the Imaging instrument, using a special image which ensures edge-effects don't
