...
def make_pipeline(
    ...
    class LensSourcePhase(al.PhaseImaging):
        def customize_priors(self, results):
            ...
            self.galaxies.lens.bulge.centre = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.bulge.centre

            self.galaxies.lens.bulge.axis_ratio = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.bulge.axis_ratio

            self.galaxies.lens.bulge.phi = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.bulge.phi

            self.galaxies.lens.bulge.intensity = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.bulge.intensity

            self.galaxies.lens.bulge.effective_radius = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.bulge.effective_radius

            self.galaxies.lens.bulge.sersic_index = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.bulge.sersic_index

            ### Lens Light to Light + Mass, Bulge -> Bulge, Disk -> Disk ###

            self.galaxies.lens.disk.centre = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.disk.centre

            self.galaxies.lens.disk.axis_ratio = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.disk.axis_ratio

            self.galaxies.lens.disk.phi = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.disk.phi

            self.galaxies.lens.disk.intensity = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.disk.intensity

            self.galaxies.lens.disk.effective_radius = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).constant.galaxies.lens.disk.effective_radius

            if pipeline_settings.disk_as_sersic:
                self.galaxies.lens.disk.sersic_index = results.from_phase(
                    "phase_2__lens_bulge_disk_sie__source_inversion"
                ).constant.galaxies.lens.disk.sersic_index

            ### Lens Mass, SIE ->  NFW ###

            if pipeline_settings.align_bulge_dark_centre:

                self.galaxies.lens.dark.centre = self.galaxies.lens.bulge.centre
            ...
            self.galaxies.source.pixelization = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).inversion.constant.galaxies.source.pixelization

            self.galaxies.source.regularization = results.from_phase(
                "phase_2__lens_bulge_disk_sie__source_inversion"
            ).inversion.constant.galaxies.source.regularization
    ...
    phase2 = al.PhaseImaging(
        ...
        galaxies=dict(
            lens=al.GalaxyModel(
                redshift=redshift_lens,
                bulge=phase1.result.variable.galaxies.lens.bulge,
                disk=phase1.result.variable.galaxies.lens.disk,
                dark=phase1.result.variable.galaxies.lens.dark,
                shear=phase1.result.variable.galaxies.lens.shear,
            ),
            source=al.GalaxyModel(
                redshift=redshift_source,
                pixelization=phase1.result.constant.galaxies.source.pixelization,
                regularization=phase1.result.constant.galaxies.source.regularization,
            ),
        ),
        sub_grid_size=sub_grid_size,
        signal_to_noise_limit=signal_to_noise_limit,
