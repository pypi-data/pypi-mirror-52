...
def make_pipeline(
    ...
    pipeline_name = "pipeline_init__lens_bulge_disk_sie__source_sersic"
    ...
    phase2 = LensSubtractedPhase(
        ...
        galaxies=dict(
            lens=al.GalaxyModel(
                redshift=redshift_lens,
                bulge=phase1.result.constant.galaxies.lens.bulge,
                disk=phase1.result.constant.galaxies.lens.disk,
    ...
    phase3 = LensSourcePhase(
        ...
        galaxies=dict(
            lens=al.GalaxyModel(
                ...
                bulge=al.light_profiles.EllipticalSersic,
                disk=disk,
                mass=phase2.result.constant.galaxies.lens.mass,
                shear=phase2.result.constant.galaxies.lens.mass,
            ),
            source=al.GalaxyModel(
                redshift=redshift_source,
                light=phase2.result.constant.galaxies.source.light,
            ),
        ),
        sub_grid_size=sub_grid_size,
        signal_to_noise_limit=signal_to_noise_limit,
    ...
    phase4 = al.PhaseImaging(
        ...
        galaxies=dict(
            lens=al.GalaxyModel(
                redshift=redshift_lens,
                bulge=phase3.result.variable.galaxies.lens.bulge,
                disk=phase3.result.variable.galaxies.lens.disk,
                mass=phase2.result.variable.galaxies.lens.mass,
                shear=phase2.result.variale.galaxies.lens.shear,
            ),
            source=al.GalaxyModel(
                redshift=redshift_source,
                light=phase2.result.variable.galaxies.source.light,
            ),
        ),
        sub_grid_size=sub_grid_size,
        signal_to_noise_limit=signal_to_noise_limit,
