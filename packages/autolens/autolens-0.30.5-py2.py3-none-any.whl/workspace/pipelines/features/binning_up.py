...
# Description: initialize the lens mass model and source light profile using x1 source with a bin up factor of x2.
...
def make_pipeline(phase_folders=None, bin_up_factor=2):
    ...
    phase2 = al.PhaseImaging(
        ...
        galaxies=dict(
            ...
            source=al.GalaxyModel(
                redshift=1.0, light=phase1.result.variable.galaxies.source.light
            ),
        ),
        mask_function=mask_function,
        optimizer_class=af.MultiNest,
