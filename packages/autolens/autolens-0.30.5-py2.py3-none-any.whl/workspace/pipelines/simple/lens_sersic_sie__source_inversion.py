...
def make_pipeline(
    ...
    class LensSubtractedPhase(al.PhaseImaging):
        def modify_image(self, image, results):
            return image - phase1.result.unmasked_model_image
    ...
    phase4 = InversionPhase(
        ...
        galaxies=dict(
            lens=al.GalaxyModel(
                ...
                shear=phase3.result.variable.galaxies.lens.mass,
            ),
            source=al.GalaxyModel(
                redshift=redshift_source,
                pixelization=pixelization,
    ...
    phase5 = al.PhaseImaging(
        ...
        galaxies=dict(
            ...
            source=al.GalaxyModel(
                redshift=redshift_source,
                pixelization=phase4.result.variable.galaxies.source.pixelization,
                regularization=phase4.result.variable.galaxies.source.regularization,
            ),
        ),
        mask_function=mask_function_circular,
        sub_grid_size=sub_grid_size,
