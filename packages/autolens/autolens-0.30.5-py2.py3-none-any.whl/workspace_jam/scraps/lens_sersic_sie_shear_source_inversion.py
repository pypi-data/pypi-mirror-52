...
def make_pipeline(
    ...
    pipeline_name = al.pipeline_tagging.pipeline_tag_from_pipeline_settings(
,
    ...
    phase1 = LensPhase(
        ...
        galaxies=dict(
            lens=al.GalaxyModel(redshift=redshift_lens, light=al.light_profiles.EllipticalSersic)
        ),
    ...
    phase2 = LensSubtractedPhase(
        ...
        galaxies=dict(
            ...
            source=al.GalaxyModel(redshift=redshift_source, light=al.light_profiles.EllipticalSersic),
        ),
