    ...
    class LensSourcePhase(al.PhaseImaging):
        def customize_priors(self, results):
            self.galaxies.lens.bulge = results.from_phase(
                "phase_1__lens_bulge_disk_mlr_nfw__source_inversion__fixed_lens_light"
            ...
            ### Lens Mass, NFW ->  NFW, MLR -> MLR ###

            self.galaxies.lens.dark = results.from_phase(
                "phase_1__lens_bulge_disk_mlr_nfw__source_inversion__fixed_lens_light"
            ).variable.galaxies.lens.dark
