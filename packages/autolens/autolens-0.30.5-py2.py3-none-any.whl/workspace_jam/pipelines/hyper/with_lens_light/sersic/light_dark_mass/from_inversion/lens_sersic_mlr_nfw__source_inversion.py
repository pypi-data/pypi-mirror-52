    ...
    class LensSourcePhase(al.PhaseImaging):
        def customize_priors(self, results):
            ...
            self.galaxies.lens.light.phi = results.from_phase(
                "phase_2__lens_sersic_sie__source_inversion"
            ).constant.galaxies.lens.light.phi

            self.galaxies.lens.light.intensity = results.from_phase(
                "phase_2__lens_sersic_sie__source_inversion"
            ).constant.galaxies.lens.light.intensity

            self.galaxies.lens.light.effective_radius = results.from_phase(
                "phase_2__lens_sersic_sie__source_inversion"
            ).constant.galaxies.lens.light.effective_radius

            self.galaxies.lens.light.sersic_index = results.from_phase(
                "phase_2__lens_sersic_sie__source_inversion"
    ...
    class LensSourcePhase(al.PhaseImaging):
        def customize_priors(self, results):
            ...
            self.galaxies.lens.light = results.from_phase(
                "phase_1__lens_sersic_mlr_nfw__source_inversion__fixed_lens_light"
            ...
            self.galaxies.source.pixelization = results.from_phase(
                "phase_1__lens_sersic_mlr_nfw__source_inversion__fixed_lens_light"
            ).inversion.variable.galaxies.source.pixelization

            self.galaxies.source.regularization = results.from_phase(
                "phase_1__lens_sersic_mlr_nfw__source_inversion__fixed_lens_light"
            ).inversion.variable.galaxies.source.regularization
