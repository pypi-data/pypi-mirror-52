...
class WeekDays:
    ...
    """
    def __init__(
            self, sunday=False, monday=False, tueday=False, wednesday=False, thursday=False, friday=False,
            saturday=False):
        self.sunday = sunday
        self.monday = monday
        self.tuesday = tueday
    ...
    def string_list(self):
        ...
        """
        weekdays = [weekday for weekday, enabled in self.dict.items() if enabled]
...
class StopInfo:
    ...
    def __init__(self, stop_type='never', date=None, number=0):
        self.type = stop_type
        self.date = date
        self.number = number
