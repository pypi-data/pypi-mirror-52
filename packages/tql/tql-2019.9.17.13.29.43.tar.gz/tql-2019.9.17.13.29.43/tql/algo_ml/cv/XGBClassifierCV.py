...
class XGBClassifierCV(object):
    ...
    def fit(self, X, y, X_test, feval=roc_auc_score, sample_weight=None, eval_metric='auc', early_stopping_rounds=100,
            verbose=100, xgb_model=None, sample_weight_eval_set=None, callbacks=None):
        """输入数组"""
