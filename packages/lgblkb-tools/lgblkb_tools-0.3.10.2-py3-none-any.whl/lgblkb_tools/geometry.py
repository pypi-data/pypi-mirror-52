...
def clean_multipolygon(multipolygon: shg.MultiPolygon):
	...
	for polygon in multipolygon:
		lu.simple_logger.debug('polygon: %s',polygon)
	...
	for shell_index,holes in tree.items():
		try:
			...
			lu.simple_logger.debug('multipolygon:\n%s',multipolygon)
			lu.simple_logger.debug('geoms:\n%s',geoms)
			lu.simple_logger.debug('shell_index: %s',shell_index)
			raise exc
