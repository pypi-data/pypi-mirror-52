...
par.set_constraint("l_1(1)", +0.5)
par.set_constraint("l_2(1)", -2.0)
par.set_constraint("l_3(1)", 0.0)
par.set_constraint("l_4(1)", 0.0)
par.set_constraint("l_5(1)", 0.0)
par.set_constraint("l_6(1)", 0.0)
par.set_constraint("lp_1(1)", 0.0)
par.set_constraint("lp_2(1)", 0.0)
par.set_constraint("lp_3(1)", 0.0)
par.set_constraint("lp_4(1)", 0.0)
par.set_constraint("lp_5(1)", 0.0)
par.set_constraint("lp_6(1)", 0.0)
