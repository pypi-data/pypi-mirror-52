...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-container-database autonomous-data-warehouse autonomous-data-warehouse-backup autonomous-database autonomous-database-backup autonomous-db-preview-version autonomous-exadata-infrastructure autonomous-exadata-infrastructure-shape backup data-guard-association database external-backup-job maintenance-run node patch patch-history system system-shape version'
        ...
        'db autonomous-database' = 'change-compartment create create-from-clone delete generate-wallet get list restore start stop update'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database create' = 'admin-password autonomous-container-database-id compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds wait-for-state wait-interval-seconds'
        'db autonomous-database create-from-clone' = 'admin-password autonomous-container-database-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds source-id wait-for-state wait-interval-seconds'
        ...
        'db database create' = 'admin-password auto-backup-enabled auto-backup-window character-set db-name db-system-id db-version db-workload from-json help max-wait-seconds ncharacter-set pdb-name recovery-window-in-days source wait-for-state wait-interval-seconds'
        ...
        'db database update' = 'auto-backup-enabled auto-backup-window database-id defined-tags force freeform-tags from-json help if-match max-wait-seconds recovery-window-in-days wait-for-state wait-interval-seconds'
        ...
        'db system launch' = 'admin-password auto-backup-enabled availability-domain backup-network-nsg-ids backup-subnet-id character-set cluster-name compartment-id cpu-core-count data-storage-percentage database-edition db-name db-version db-workload defined-tags disk-redundancy display-name domain fault-domains freeform-tags from-json help hostname initial-data-storage-size-in-gb license-model max-wait-seconds ncharacter-set node-count nsg-ids pdb-name recovery-window-in-days shape sparse-diskgroup ssh-authorized-keys-file subnet-id time-zone wait-for-state wait-interval-seconds'
        'db system launch-from-backup' = 'admin-password availability-domain backup-id backup-network-nsg-ids backup-subnet-id backup-tde-password cluster-name compartment-id cpu-core-count data-storage-percentage database-edition db-name defined-tags disk-redundancy display-name domain fault-domains freeform-tags from-json help hostname initial-data-storage-size-in-gb license-model max-wait-seconds node-count nsg-ids shape sparse-diskgroup ssh-authorized-keys-file subnet-id time-zone wait-for-state wait-interval-seconds'
