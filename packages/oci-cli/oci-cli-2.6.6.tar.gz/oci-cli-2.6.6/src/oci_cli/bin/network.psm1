...
function GetOciCommandsToLongParams_network() {
    $ociCommandsToLongParams = @{
        ...
        'network virtual-circuit update' = 'bandwidth-shape-name cross-connect-mappings customer-bgp-asn defined-tags display-name force freeform-tags from-json gateway-id help if-match max-wait-seconds provider-service-key-name provider-state reference-comment virtual-circuit-id wait-for-state wait-interval-seconds'
