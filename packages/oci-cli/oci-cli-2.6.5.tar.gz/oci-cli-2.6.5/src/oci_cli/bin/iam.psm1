...
function GetOciCommandsToLongParams_iam() {
    $ociCommandsToLongParams = @{
        ...
        'iam tag create' = 'defined-tags description freeform-tags from-json help is-cost-tracking max-wait-seconds name tag-namespace-id wait-for-state wait-interval-seconds'
