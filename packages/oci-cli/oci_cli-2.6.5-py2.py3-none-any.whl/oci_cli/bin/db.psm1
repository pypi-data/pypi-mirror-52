...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db database create' = 'admin-password auto-backup-enabled auto-backup-window backup-destination character-set db-name db-system-id db-version db-workload from-json help max-wait-seconds ncharacter-set pdb-name recovery-window-in-days source vm-cluster-id wait-for-state wait-interval-seconds'
