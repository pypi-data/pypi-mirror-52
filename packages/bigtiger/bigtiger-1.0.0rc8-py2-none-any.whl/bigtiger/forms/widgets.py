...
class QuickDateSelector(widgets.MultiWidget):
    ...
    def format_output(self, rendered_widgets, value):
        output = []
        output.append(u'<div class="quickDateSelector" tabindex="0">')
        output.append(format_html(
            u'<div class="dropdown"><input type="text" value="{0}&nbsp;&nbsp;至&nbsp;&nbsp;{1}" readonly="readonly" onClick="quickDateSelector.showQuickDateSelector()"></div>', value[0], value[1]))
        output.append(format_html(u'<div class="{0}">', "dropdown-panle"))
        output.append(format_html(u'<p>日期范围</p>'))
        output.append(format_html(u'<p>开始时间：{0}</p>', rendered_widgets[0]))
        output.append(format_html(u'<p>结束时间：{0}</p>', rendered_widgets[1]))
        output.append(format_html(u'<p>快捷日期</p>'))
        output.append(format_html(u'<p><ul class="quick-list clearfix">'))
        output.append(format_html(
            u'<li><a href="javascript:void(0)" onClick="quickDateSelector.quickChangDate(1)">今天</a></li>'))
        output.append(format_html(
            u'<li><a href="javascript:void(0)" onClick="quickDateSelector.quickChangDate(2)">昨天</a></li>'))
        output.append(format_html(
            u'<li><a href="javascript:void(0)" onClick="quickDateSelector.quickChangDate(3)">最近7天</a></li>'))
        output.append(format_html(
            u'<li><a href="javascript:void(0)" onClick="quickDateSelector.quickChangDate(4)">上周</a></li>'))
        output.append(format_html(
            u'<li><a href="javascript:void(0)" onClick="quickDateSelector.quickChangDate(5)">最近15天</a></li>'))
        output.append(format_html(
            u'<li><a href="javascript:void(0)" onClick="quickDateSelector.quickChangDate(6)">本月</a></li>'))
        output.append(format_html(
            u'<li><a href="javascript:void(0)" onClick="quickDateSelector.quickChangDate(7)">最近30天</a></li>'))
        output.append(format_html(
            u'<li><a href="javascript:void(0)" onClick="quickDateSelector.quickChangDate(8)">上月</a></li>'))
        output.append(format_html(u'</ul></p>'))
        output.append(format_html(
            u'<div class="operator"><a class="btn btn-size25 btn-confirm" href="javascript:void(0)" onClick="quickDateSelector.hideQuickDateSelector()">确定</a></div>'))
