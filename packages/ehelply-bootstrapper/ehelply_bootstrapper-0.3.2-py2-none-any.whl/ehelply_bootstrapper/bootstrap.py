...
class Bootstrap:
    ...
    def __init__(self, service_name: str, service_key: str, service_version: str, loadables: List[str],
        ...
        self.logger.info(" * Dev mode: " + str(self.dev_mode))
        ...
        Config(config_path=self.config_path, configs=configs, dev_mode=self.dev_mode).init()
        ...
        State.integrations = IntegrationManager()
    ...
    def mysql_init(self):
        ...
        :return:
        """
        self.mysql_driver = Mysql(dev_mode=self.dev_mode).init()
