...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-budgets", "1.9.0", __name__, "aws-budgets@1.9.0.jsii.tgz")
class CfnBudget(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-budgets.CfnBudget"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-budgets.CfnBudget.BudgetDataProperty", jsii_struct_bases=[], name_mapping={'budget_type': 'budgetType', 'time_unit': 'timeUnit', 'budget_limit': 'budgetLimit', 'budget_name': 'budgetName', 'cost_filters': 'costFilters', 'cost_types': 'costTypes', 'time_period': 'timePeriod'})
    class BudgetDataProperty():
        def __init__(self, *, budget_type: str, time_unit: str, budget_limit: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnBudget.SpendProperty"]]]=None, budget_name: typing.Optional[str]=None, cost_filters: typing.Any=None, cost_types: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnBudget.CostTypesProperty"]]]=None, time_period: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnBudget.TimePeriodProperty"]]]=None):
            """
