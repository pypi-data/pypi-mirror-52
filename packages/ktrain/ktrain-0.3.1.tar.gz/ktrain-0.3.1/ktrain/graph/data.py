...
def graph_nodes_from_csv(nodes_filepath, 
    ...
    Return:
        tuple of KT_NodeSequence objects for train and validation sets
    """
    ...
    tr_data, te_data = model_selection.train_test_split(node_data, 
                                                        train_size=None, 
                                                        test_size=val_pct, 
    ...
    preproc = None
    return (KT_NodeSequence(train_gen), KT_NodeSequence(test_gen), preproc)
