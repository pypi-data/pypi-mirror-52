...
class IsoContour(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    mesh = property(_VisusGuiNodesPy.IsoContour_mesh_get, _VisusGuiNodesPy.IsoContour_mesh_set)
...
class IsoContourNode(VisusDataflowPy.Node):
    ...
    def __init__(self, *args):
        _VisusGuiNodesPy.IsoContourNode_swiginit(self, _VisusGuiNodesPy.new_IsoContourNode(*args))
...
class IsoContourRenderNode(VisusDataflowPy.Node, VisusGuiPy.GLObject):
    ...
    def __init__(self, *args):
        _VisusGuiNodesPy.IsoContourRenderNode_swiginit(self, _VisusGuiNodesPy.new_IsoContourRenderNode(*args))
...
class RenderArrayNode(VisusDataflowPy.Node, VisusGuiPy.GLObject):
    ...
    def __init__(self, *args):
        _VisusGuiNodesPy.RenderArrayNode_swiginit(self, _VisusGuiNodesPy.new_RenderArrayNode(*args))
...
class KdRenderArrayNode(VisusDataflowPy.Node, VisusGuiPy.GLObject):
    ...
    def __init__(self, *args):
        _VisusGuiNodesPy.KdRenderArrayNode_swiginit(self, _VisusGuiNodesPy.new_KdRenderArrayNode(*args))
