...
class GLCamera(object):
    ...
    def glMousePressEvent(self, evt):
        return _VisusGuiPy.GLCamera_glMousePressEvent(self, evt)

    def glMouseMoveEvent(self, evt):
        return _VisusGuiPy.GLCamera_glMouseMoveEvent(self, evt)

    def glMouseReleaseEvent(self, evt):
        return _VisusGuiPy.GLCamera_glMouseReleaseEvent(self, evt)

    def glWheelEvent(self, evt):
        return _VisusGuiPy.GLCamera_glWheelEvent(self, evt)

    def glKeyPressEvent(self, evt):
        return _VisusGuiPy.GLCamera_glKeyPressEvent(self, evt)

    def getFrustum(self):
        return _VisusGuiPy.GLCamera_getFrustum(self)

    def getFinalFrustum(self):
        return _VisusGuiPy.GLCamera_getFinalFrustum(self)

    def getOrthoParams(self):
        return _VisusGuiPy.GLCamera_getOrthoParams(self)

    def setOrthoParams(self, value):
        return _VisusGuiPy.GLCamera_setOrthoParams(self, value)

    def getViewport(self):
        return _VisusGuiPy.GLCamera_getViewport(self)

    def setViewport(self, value):
        return _VisusGuiPy.GLCamera_setViewport(self, value)

    def mirror(self, ref):
        return _VisusGuiPy.GLCamera_mirror(self, ref)

    def guessPosition(self, *args):
        return _VisusGuiPy.GLCamera_guessPosition(self, *args)

    def glRender(self, gl):
        return _VisusGuiPy.GLCamera_glRender(self, gl)

    def writeToObjectStream(self, ostream):
        return _VisusGuiPy.GLCamera_writeToObjectStream(self, ostream)

    def readFromObjectStream(self, istream):
        return _VisusGuiPy.GLCamera_readFromObjectStream(self, istream)
...
class GLOrthoCamera(GLCamera):
    ...
    def setLookAt(self, pos, dir, vup):
        return _VisusGuiPy.GLOrthoCamera_setLookAt(self, pos, dir, vup)

    def guessPosition(self, position, ref=-1):
        return _VisusGuiPy.GLOrthoCamera_guessPosition(self, position, ref)

    def isRotationDisabled(self):
        return _VisusGuiPy.GLOrthoCamera_isRotationDisabled(self)

    def setRotationDisabled(self, value):
        return _VisusGuiPy.GLOrthoCamera_setRotationDisabled(self, value)
    ...
    def rotate(self, quantity):
        return _VisusGuiPy.GLOrthoCamera_rotate(self, quantity)

    def getOrthoParams(self):
        return _VisusGuiPy.GLOrthoCamera_getOrthoParams(self)

    def setOrthoParams(self, value):
        return _VisusGuiPy.GLOrthoCamera_setOrthoParams(self, value)

    def getViewport(self):
        return _VisusGuiPy.GLOrthoCamera_getViewport(self)

    def setViewport(self, value):
        return _VisusGuiPy.GLOrthoCamera_setViewport(self, value)

    def getFrustum(self):
        return _VisusGuiPy.GLOrthoCamera_getFrustum(self)

    def getFinalFrustum(self):
        return _VisusGuiPy.GLOrthoCamera_getFinalFrustum(self)

    def glMousePressEvent(self, evt):
        return _VisusGuiPy.GLOrthoCamera_glMousePressEvent(self, evt)

    def glMouseReleaseEvent(self, evt):
        return _VisusGuiPy.GLOrthoCamera_glMouseReleaseEvent(self, evt)

    def glMouseMoveEvent(self, evt):
        return _VisusGuiPy.GLOrthoCamera_glMouseMoveEvent(self, evt)

    def glWheelEvent(self, evt):
        return _VisusGuiPy.GLOrthoCamera_glWheelEvent(self, evt)

    def glKeyPressEvent(self, evt):
        return _VisusGuiPy.GLOrthoCamera_glKeyPressEvent(self, evt)

    def writeToObjectStream(self, ostream):
        return _VisusGuiPy.GLOrthoCamera_writeToObjectStream(self, ostream)

    def readFromObjectStream(self, istream):
        return _VisusGuiPy.GLOrthoCamera_readFromObjectStream(self, istream)
...
class GLLookAtCamera(GLCamera):
    ...
    def __init__(self, defaultRotFactor_=5.2, defaultPanFactor_=30.0):
        _VisusGuiPy.GLLookAtCamera_swiginit(self, _VisusGuiPy.new_GLLookAtCamera(defaultRotFactor_, defaultPanFactor_))
    ...
    def isUsingOrthoProjection(self):
        return _VisusGuiPy.GLLookAtCamera_isUsingOrthoProjection(self)

    def setUseOrthoProjection(self, value):
        return _VisusGuiPy.GLLookAtCamera_setUseOrthoProjection(self, value)

    def isAutoOrthoParams(self):
        return _VisusGuiPy.GLLookAtCamera_isAutoOrthoParams(self)

    def setAutoOrthoParams(self, value):
        return _VisusGuiPy.GLLookAtCamera_setAutoOrthoParams(self, value)

    def getOrthoParams(self):
        return _VisusGuiPy.GLLookAtCamera_getOrthoParams(self)

    def setOrthoParams(self, value):
        return _VisusGuiPy.GLLookAtCamera_setOrthoParams(self, value)

    def getViewport(self):
        return _VisusGuiPy.GLLookAtCamera_getViewport(self)

    def setViewport(self, value):
        return _VisusGuiPy.GLLookAtCamera_setViewport(self, value)

    def getFrustum(self):
        return _VisusGuiPy.GLLookAtCamera_getFrustum(self)

    def glMousePressEvent(self, evt):
        return _VisusGuiPy.GLLookAtCamera_glMousePressEvent(self, evt)

    def glMouseMoveEvent(self, evt):
        return _VisusGuiPy.GLLookAtCamera_glMouseMoveEvent(self, evt)

    def glMouseReleaseEvent(self, evt):
        return _VisusGuiPy.GLLookAtCamera_glMouseReleaseEvent(self, evt)

    def glWheelEvent(self, evt):
        return _VisusGuiPy.GLLookAtCamera_glWheelEvent(self, evt)

    def glKeyPressEvent(self, evt):
        return _VisusGuiPy.GLLookAtCamera_glKeyPressEvent(self, evt)

    def guessPosition(self, position, ref=-1):
        return _VisusGuiPy.GLLookAtCamera_guessPosition(self, position, ref)

    def setBounds(self, logic_box):
        return _VisusGuiPy.GLLookAtCamera_setBounds(self, logic_box)

    def setLookAt(self, pos, center, vup):
        return _VisusGuiPy.GLLookAtCamera_setLookAt(self, pos, center, vup)

    def writeToObjectStream(self, ostream):
        return _VisusGuiPy.GLLookAtCamera_writeToObjectStream(self, ostream)

    def readFromObjectStream(self, istream):
        return _VisusGuiPy.GLLookAtCamera_readFromObjectStream(self, istream)
