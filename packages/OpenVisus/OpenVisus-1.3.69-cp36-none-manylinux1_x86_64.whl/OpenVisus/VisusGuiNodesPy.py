...
class GLCameraNode(VisusDataflowPy.Node):
    ...
    def __init__(self, *args):
        this = _VisusGuiNodesPy.new_GLCameraNode(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def writeToObjectStream(self, ostream):
        return _VisusGuiNodesPy.GLCameraNode_writeToObjectStream(self, ostream)

    def readFromObjectStream(self, istream):
        return _VisusGuiNodesPy.GLCameraNode_readFromObjectStream(self, istream)
GLCameraNode_swigregister = _VisusGuiNodesPy.GLCameraNode_swigregister
GLCameraNode_swigregister(GLCameraNode)

class IsoContour(_object):
    __swig_setmethods__ = {}
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["mesh"] = _VisusGuiNodesPy.IsoContour_mesh_set
    __swig_getmethods__["mesh"] = _VisusGuiNodesPy.IsoContour_mesh_get
    if _newclass:
        mesh = _swig_property(_VisusGuiNodesPy.IsoContour_mesh_get, _VisusGuiNodesPy.IsoContour_mesh_set)
...
class IsoContourNode(VisusDataflowPy.Node):
    ...
    def __init__(self, *args):
        this = _VisusGuiNodesPy.new_IsoContourNode(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def getFieldRange(self):
        return _VisusGuiNodesPy.IsoContourNode_getFieldRange(self)
    ...
    def writeToObjectStream(self, ostream):
        return _VisusGuiNodesPy.IsoContourNode_writeToObjectStream(self, ostream)

    def readFromObjectStream(self, istream):
        return _VisusGuiNodesPy.IsoContourNode_readFromObjectStream(self, istream)
...
class IsoContourRenderNode(VisusDataflowPy.Node, VisusGuiPy.GLObject):
    ...
    def __init__(self, *args):
        this = _VisusGuiNodesPy.new_IsoContourRenderNode(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def getNodeBounds(self):
        return _VisusGuiNodesPy.IsoContourRenderNode_getNodeBounds(self)

    def getMaterial(self):
        return _VisusGuiNodesPy.IsoContourRenderNode_getMaterial(self)

    def setMaterial(self, value):
        return _VisusGuiNodesPy.IsoContourRenderNode_setMaterial(self, value)

    def getIsoContour(self):
        return _VisusGuiNodesPy.IsoContourRenderNode_getIsoContour(self)

    def setIsoContour(self, contour):
        return _VisusGuiNodesPy.IsoContourRenderNode_setIsoContour(self, contour)
    ...
    def writeToObjectStream(self, ostream):
        return _VisusGuiNodesPy.IsoContourRenderNode_writeToObjectStream(self, ostream)

    def readFromObjectStream(self, istream):
        return _VisusGuiNodesPy.IsoContourRenderNode_readFromObjectStream(self, istream)
...
class RenderArrayNode(VisusDataflowPy.Node, VisusGuiPy.GLObject):
    ...
    def __init__(self, *args):
        this = _VisusGuiNodesPy.new_RenderArrayNode(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def getNodeBounds(self):
        return _VisusGuiNodesPy.RenderArrayNode_getNodeBounds(self)
    ...
    def writeToObjectStream(self, ostream):
        return _VisusGuiNodesPy.RenderArrayNode_writeToObjectStream(self, ostream)

    def readFromObjectStream(self, istream):
        return _VisusGuiNodesPy.RenderArrayNode_readFromObjectStream(self, istream)
...
class KdRenderArrayNode(VisusDataflowPy.Node, VisusGuiPy.GLObject):
    ...
    def __init__(self, *args):
        this = _VisusGuiNodesPy.new_KdRenderArrayNode(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def getNodeBounds(self):
        return _VisusGuiNodesPy.KdRenderArrayNode_getNodeBounds(self)
