...
class Executor(object):
    ...
    @retry(wait=wait_fixed(3))
    def end_report(self, task, has_output, id, result, topic_partitions, errors):
        try:
            data = {
                "type": "end",
                "task_id": task.task_id,
    ...
    def data_process(self, task, data, partition=None, offset=None):
        ...
        self.end_report(task, has_output, id, result, topic_partitions, error_collector.export())
