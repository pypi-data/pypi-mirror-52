...
from pbga.base import PbgaException
...
class H2DbManager:
    ...
    def _perform_checks(self):
        ...
        if not self.check_java_is_in_system():
            raise PbgaException("Java executable was not found on the local system")
    ...
    def split_db_path(db_path: str) -> tuple:
        if os.path.isfile(db_path):
            ...
            raise PbgaException("'{}' does not point to a file".format(db_path))
