...
from hawking.encoder.malaya import MalayaXLNetTextEncoder, MalayaBertTextEncoder
...
def create_encoder(config={
    ...
    if config['entity_type'] == 'text':
        ...
        elif config['encoder_type'] == 'malaya-bert':
            encoder = MalayaBertTextEncoder(encoder_weights)
        elif config['encoder_type'] == 'malaya-xlnet':
            encoder = MalayaXLNetTextEncoder(encoder_weights)
        else:
