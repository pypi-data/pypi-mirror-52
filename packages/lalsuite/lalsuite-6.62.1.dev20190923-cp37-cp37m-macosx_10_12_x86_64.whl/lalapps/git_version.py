...
id = "53198bb8096dfc2fe00f03708d98a357e429eeec"
date = "2019-09-22 18:37:57 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "53198bb8096dfc2fe00f03708d98a357e429eeec":
        return
    msg = "Program id (53198bb8096dfc2fe00f03708d98a357e429eeec) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
