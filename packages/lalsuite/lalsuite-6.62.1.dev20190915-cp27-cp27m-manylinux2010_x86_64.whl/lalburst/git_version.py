...
id = "75f1284c93f574af327422da35a966450b043788"
date = "2019-09-13 14:39:26 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "75f1284c93f574af327422da35a966450b043788":
        return
    msg = "Program id (75f1284c93f574af327422da35a966450b043788) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
