...
class ProgressBar(Component):
    """
    Simple progress bar support by all browsers.  Available CSS classes (Under
    dazzler-core-progress-bar) - progress The div where the value is - high -
    low - optimum - striped - rounded
    """
    _aspect_keys = []
    _children = []
    ...
    id = Aspect()
    class_name = Aspect()
    progress_class_name = Aspect()
    style = Aspect()
    progress_text = Aspect()
    click = Aspect()
    striped = Aspect()
    rounded = Aspect()
