...
class Table(Component):
    """
    Display data in a tabular manner (Non interactive).  Available CSS classes
    - dazzler-core-table (root) - table-head - table-heading - table-body -
    table-row - table-cell - table-footer
    """
    _aspect_keys = []
    _children = []
