...
class PlateStatistic(object):
    ...
    def __init__(self, args):
        ...
        self.rawFragmentCount = collections.defaultdict( collections.Counter ) # (library, mux) -> cell -> counts
    ...
    def plot(self, target_path, title=None):
        for data, name in [
            ...
            #        size = (x/np.percentile(df[name],99))*200
                ...
                plt.savefig(target_path.replace('.png','') + f'{name}_{mux}_{library}.png')
                plt.close()
