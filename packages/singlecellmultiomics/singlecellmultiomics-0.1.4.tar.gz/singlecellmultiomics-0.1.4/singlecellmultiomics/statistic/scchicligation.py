...
class ScCHICLigation():
    def __init__(self,args):
        self.per_cell_a_obs = collections.defaultdict( collections.Counter ) # cell -> { A_start: count, total_cuts: count }
        self.per_cell_ta_obs = collections.defaultdict( collections.Counter ) # cell -> { TA_start: count, total_cuts: count }
