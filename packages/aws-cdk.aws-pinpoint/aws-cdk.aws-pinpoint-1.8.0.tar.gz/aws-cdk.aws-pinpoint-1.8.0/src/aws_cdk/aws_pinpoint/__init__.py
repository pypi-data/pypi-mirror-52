...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-pinpoint", "1.8.0", __name__, "aws-pinpoint@1.8.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-pinpoint.CfnAppProps", jsii_struct_bases=[], name_mapping={'name': 'name'})
class CfnAppProps():
...
class CfnApplicationSettingsProps():
    ...
    @property
    def campaign_hook(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnApplicationSettings.CampaignHookProperty"]]]:
        """``AWS::Pinpoint::ApplicationSettings.CampaignHook``.
...
class CfnSegment(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-pinpoint.CfnSegment"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, application_id: str, name: str, dimensions: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["SegmentDimensionsProperty"]]]=None, segment_groups: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["SegmentGroupsProperty"]]]=None) -> None:
        ...
        """
        props = CfnSegmentProps(application_id=application_id, name=name, dimensions=dimensions, segment_groups=segment_groups)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-pinpoint.CfnSegmentProps", jsii_struct_bases=[], name_mapping={'application_id': 'applicationId', 'name': 'name', 'dimensions': 'dimensions', 'segment_groups': 'segmentGroups'})
class CfnSegmentProps():
    def __init__(self, *, application_id: str, name: str, dimensions: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnSegment.SegmentDimensionsProperty"]]]=None, segment_groups: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnSegment.SegmentGroupsProperty"]]]=None):
