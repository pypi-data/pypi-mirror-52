...
#
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# JS: {'runLinearRegistrationWASM', 'bisLinearTransformation', [ 'bisImage', 'bisImage', 'bisLinearTransformation_opt', 'ParamObj', 'debug' ], {"checkorientation" : "python matlab"}}
#      returns a bisLinearTransformation
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
...
#
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# JS: {'runNonLinearRegistrationWASM', 'bisComboTransformation', [ 'bisImage', 'bisImage', 'bisLinearTransformation_opt', 'ParamObj', 'debug' ], {"checkorientation" : "python matlab"}}
#      returns a bisComboTransformation
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
