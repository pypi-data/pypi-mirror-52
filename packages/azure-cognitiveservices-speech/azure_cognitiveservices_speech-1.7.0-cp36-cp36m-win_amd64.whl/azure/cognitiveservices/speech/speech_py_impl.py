...
class DialogServiceConfig(SpeechConfig):
    __swig_setmethods__ = {}
    for _s in [SpeechConfig]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    ...
    __repr__ = _swig_repr
    if _newclass:
        from_bot_secret = staticmethod(_speech_py_impl.DialogServiceConfig_from_bot_secret)
    else:
        from_bot_secret = _speech_py_impl.DialogServiceConfig_from_bot_secret
    if _newclass:
        from_speech_commands_app_id = staticmethod(_speech_py_impl.DialogServiceConfig_from_speech_commands_app_id)
    else:
        from_speech_commands_app_id = _speech_py_impl.DialogServiceConfig_from_speech_commands_app_id

    def set_application_id(self, applicationId )  :
        return _speech_py_impl.DialogServiceConfig_set_application_id(self, applicationId)

    def get_application_id(self)  :
        return _speech_py_impl.DialogServiceConfig_get_application_id(self)

    def set_initial_silence_timeout(self, connectionInitialSilenceTimeout )  :
        return _speech_py_impl.DialogServiceConfig_set_initial_silence_timeout(self, connectionInitialSilenceTimeout)

    def get_initial_silence_timeout(self)  :
        return _speech_py_impl.DialogServiceConfig_get_initial_silence_timeout(self)

    def set_text_to_speech_audio_format(self, audioFormat )  :
        return _speech_py_impl.DialogServiceConfig_set_text_to_speech_audio_format(self, audioFormat)

    def get_text_to_speech_audio_format(self)  :
        return _speech_py_impl.DialogServiceConfig_get_text_to_speech_audio_format(self)
...
def DialogServiceConfig_from_bot_secret(secretKey , subscription , region )  :
    return _speech_py_impl.DialogServiceConfig_from_bot_secret(secretKey, subscription, region)
DialogServiceConfig_from_bot_secret = _speech_py_impl.DialogServiceConfig_from_bot_secret

def DialogServiceConfig_from_speech_commands_app_id(appId , subscription , region )  :
    return _speech_py_impl.DialogServiceConfig_from_speech_commands_app_id(appId, subscription, region)
DialogServiceConfig_from_speech_commands_app_id = _speech_py_impl.DialogServiceConfig_from_speech_commands_app_id
...
class ConversationTranscriber(ConversationTranscriberRecognizerBase):
    ...
    def stop_transcribing_async(self, *args)  :
        return _speech_py_impl.ConversationTranscriber_stop_transcribing_async(self, *args)

    def end_conversation_async(self, *args)  :
        return _speech_py_impl.ConversationTranscriber_end_conversation_async(self, *args)
