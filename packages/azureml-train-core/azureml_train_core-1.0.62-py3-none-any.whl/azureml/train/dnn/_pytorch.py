...
class PyTorch(_FrameworkBaseEstimator):
    ...
    .. remarks::
            ...
            | Dependencies | PyTorch 1.0/1.1/1.2 |
            | ---------------------- | ----------------- |
            | Python                 | 3.6.2             |
    ...
    :param distributed_training: Parameters for running a distributed training job.
        ...
        For running a distributed job with MPI backend, use :class:`azureml.train.runconfig.MpiConfiguration`
    ...
    :type distributed_training: azureml.core.runconfig.MpiConfiguration, azureml.train.dnn.Gloo,
