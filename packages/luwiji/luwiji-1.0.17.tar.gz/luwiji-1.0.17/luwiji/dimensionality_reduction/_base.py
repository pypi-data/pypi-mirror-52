...
class BaseIllustrationDimensionalityReduction:
    def __init__(self):
        ...
        self.pca_combination = Image(f"{here}/assets/pca_combination.png", width=800)
        self.tsne_4 = Image(f"{here}/assets/tsne_4.png", width=700)
        self.tsne_1 = Image(f"{here}/assets/tsne_1.png", width=700)
        self.tsne_3 = Image(f"{here}/assets/tsne_3.png", width=700)
        self.tsne_2 = Image(f"{here}/assets/tsne_2.png", width=700)
