...
setup(
	...
	extras_require={
		...
		"toml": ["toml"],
		"ALL": ["aiohttp", "bencode.py", "ctypes-windows-sdk", "flask", "gensim", "netifaces", "nltk",
			"orderedset", "pycryptodome", "pyOpenSSL", "PyPDF2", "pypiwin32", "rhash", "toml",
			"unidecode", "werkzeug", "wmi", "wx"],
	},
	use_2to3=False
)
