...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-amplify", "1.8.0", __name__, "aws-amplify@1.8.0.jsii.tgz")
class CfnApp(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-amplify.CfnApp"):
    ...
    def auto_branch_creation_config(self) -> typing.Optional[typing.Union[typing.Optional["AutoBranchCreationConfigProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
    ...
    def auto_branch_creation_config(self, value: typing.Optional[typing.Union[typing.Optional["AutoBranchCreationConfigProperty"], typing.Optional[aws_cdk.core.IResolvable]]]):
...
class CfnAppProps():
    ...
    @property
    def auto_branch_creation_config(self) -> typing.Optional[typing.Union[typing.Optional["CfnApp.AutoBranchCreationConfigProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::Amplify::App.AutoBranchCreationConfig``.
...
class CfnBranch(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-amplify.CfnBranch"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, app_id: str, branch_name: str, basic_auth_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["BasicAuthConfigProperty"]]]=None, build_spec: typing.Optional[str]=None, description: typing.Optional[str]=None, enable_auto_build: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, environment_variables: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "EnvironmentVariableProperty"]]]]]=None, stage: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
        ...
        """
        props = CfnBranchProps(app_id=app_id, branch_name=branch_name, basic_auth_config=basic_auth_config, build_spec=build_spec, description=description, enable_auto_build=enable_auto_build, environment_variables=environment_variables, stage=stage, tags=tags)
