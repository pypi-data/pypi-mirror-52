...
class UnitAPIApi(object):
    ...
    def get_unit_by_uuid_with_http_info(self, uuid, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_unit_by_u_uid" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'uuid' is set
        if ('uuid' not in params or
                params['uuid'] is None):
            raise ValueError("Missing the required parameter `uuid` when calling `get_unit_by_u_uid`")  # noqa: E501
    ...
    def get_unit_conversion_by_uuid_with_http_info(self, uuid, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_unit_conversion_by_u_uid" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'uuid' is set
        if ('uuid' not in params or
                params['uuid'] is None):
            raise ValueError("Missing the required parameter `uuid` when calling `get_unit_conversion_by_u_uid`")  # noqa: E501
    ...
    def list_all_unit_conversions(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_all_unit_conversions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_all_unit_conversions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_all_unit_conversions_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_all_unit_conversions_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve a collection of Unit Conversions  # noqa: E501

        A Spark Works Accounts authenticated user is able to retrieve all of the Platform Unit Conversions.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_all_unit_conversions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_all_unit_conversions" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def list_all_units(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_all_units(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_all_units_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_all_units_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_all_units_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve a collection of Units  # noqa: E501

        A Spark Works Accounts authenticated user is able to retrieve all of the Platform Units.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_all_units_with_http_info(async_req=True)
        >>> result = thread.get()
