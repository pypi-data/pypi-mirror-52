...
"""
    ...
    OpenAPI spec version: 10.0.1-dev.4
...
class Project(ProjectMixin):
    ...
    def __init__(self, public=None, label=None, info=None, description=None, group=None, providers=None, editions=None, id=None, parents=None, info_exists=None, created=None, modified=None, templates=None, permissions=None, files=None, notes=None, tags=None, analyses=None):  # noqa: E501
