...
from nlp_datasets import DSSMSameFileDataset, DSSMSeparateFileDataset
...
class XYZSameFileDatasetTest(tf.test.TestCase):
    ...
    def testBuildTrainDataset(self):
        d = DSSMSameFileDataset(config=config, logger_name=None)
...
class XYZSeparateFileDatasetTest(tf.test.TestCase):
    ...
    def testBuildTrainDataset(self):
        o = DSSMSeparateFileDataset(config=config, logger_name=None)
