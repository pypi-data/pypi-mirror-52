...
extensions = [
    Extension(
        "lsh.cMinhash",
        ["lsh/cMinhash{}".format(ext), "lsh/MurmurHash3.cpp", "lsh/MurmurHash3.h"],
        include_dirs=includes + [os.path.abspath(os.path.join(os.path.dirname(__file__), 'lsh'))]
    )
]
...
class UploadCommand(Command):
    ...
    def run(self):
        ...
        os.system(
            '{0} setup.py sdist'.format(sys.executable)
        )
