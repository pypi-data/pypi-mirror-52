...
class Report:
    ...
    def getDeviceResults2(self, productName, productVersion, stationName, deviceID=None, resultKeys=None, onlyGood=True, onlyNewest=True):
    ...
    def getDeviceResults(self, productName, productVersion, stationName, deviceID=None, resultKeys=None, onlyGood=True, onlyNewest=True):
        rv, data = self.getDeviceResults2(productName, productVersion, stationName, deviceID, resultKeys, onlyGood, onlyNewest)
        return data
