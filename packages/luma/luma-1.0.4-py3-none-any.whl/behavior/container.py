...
class ContainerBehavior:
  ...
  def list(self):
    ...
    resp = self.util.cli_request('GET',
      self.util.build_url('{app}/iot/v1/containers?type={container_type}&page={page}&pagesize={pagesize}&{filter}', {**data} ))
  ...
  def delete(self):
    ...
    resp = self.util.cli_request('DELETE',
        self.util.build_url('{app}/iot/v1/containers/{container_id}', {'container_id': container_id}))
  ...
  def share(self):
    ...
    if self.current:
      if self.json:
        resp = self.util.cli_request('GET',
          self.util.build_url('{app}/iot/v1/containers/{container_id}/access', {'container_id': container_id}))
    ...
    if self.absolute:
      ...
      access_resp = self.util.cli_request('PUT', self.util.build_url('{app}/iot/v1/containers/{container_id}/access',\
    ...
    access_resp = self.util.cli_request('PUT',
        self.util.build_url('{app}/iot/v1/containers/{container_id}/access', {'container_id': container_id}), data=json.dumps(data))
