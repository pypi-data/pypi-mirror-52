...
class ContainerVersionBehavior:
  ...
  def list(self):
    ...
    resp = self.util.cli_request('GET',
      self.util.build_url('{app}/iot/v1/containers/{container_id}/versions?page={page}&pagesize={pagesize}&{filter}',
  ...
  def start_stop(self):
    ...
    resp = self.util.cli_request('POST', self.util.build_url('{app}/iot/v1/containers/{container_id}/versions/{version_id}/{action}',\
    ...
    ver_resp = self.util.cli_request('GET',
      self.util.build_url('{app}/iot/v1/containers/{container_id}/versions/{version_id}', {'container_id': container_id, 'version_id': version_id}))
  ...
  def run(self, command):
    ...
    resp = self.util.cli_request('POST', self.util.build_url('{app}/iot/v1/containers/{container_id}/versions/{version_id}/exec',\
      ...
      if self.json:
        ...
        for v in versions:
          resp = self.util.cli_request('DELETE',
              self.util.build_url('{app}/iot/v1/containers/{container_id}/versions/{version_id}', {'container_id': container_id, 'version_id': v['id']}))
