    ...
    if self.from_version:
      ...
      if self.version:
        ...
        if self.version_bump == 'patch':
          versions = self.util.cli_request('GET', self.util.build_url('{app}/iot/v1/component-sets/{component_set_id}/versions?major={major}&minor={minor}&sort=patch+desc',\
          ...
          versions = self.util.cli_request('GET', self.util.build_url('{app}/iot/v1/component-sets/{component_set_id}/versions?major={major}&sort=minor+desc',\
              { 'component_set_id': version_data['componentSetId'], 'major': version_data['major'] }))['payload']['data']
        else:
          versions = self.util.cli_request('GET', self.util.build_url('{app}/iot/v1/component-sets/{component_set_id}/versions?sort=major+desc',\
