...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'bdgenomics', 'mango', 'pileup', 'static', 'extension.js'),
        os.path.join(here, 'bdgenomics', 'mango', 'pileup', 'static', 'index.js')
    ]
...
version_ns = {}
with open(os.path.join(here, 'bdgenomics', 'mango', 'pileup', '_version.py')) as f:
...
setup_args = {
    ...
    'data_files': [
        ('share/jupyter/nbextensions/pileup', [
            'bdgenomics/mango/pileup/static/extension.js',
            'bdgenomics/mango/pileup/static/index.js',
