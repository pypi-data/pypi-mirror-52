...
if __name__ == '__main__':
    ...
    train_avg_loss, train_avg_acc, train_run_speed = cls_task._calculate_metrics(run_states)

    run_states = cls_task.eval()
    eval_avg_loss, eval_avg_acc, eval_run_speed = cls_task._calculate_metrics(run_states)

    print(eval_avg_acc, end="")