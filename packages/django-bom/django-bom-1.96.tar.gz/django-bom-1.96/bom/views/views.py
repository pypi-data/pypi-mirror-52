            ...
            try:
                ...
                for row in reader:
                    ...
                    if 'part_class' in part_data and 'description' in part_data and 'revision' in part_data:
                        ...
                        pr, _ = PartRevision.objects.get_or_create(part=part, revision=part_data['revision'], defaults={
                            'description': part_data['description'],
                        })

                        manufacturer_part, _ = ManufacturerPart.objects.get_or_create(part=part,
