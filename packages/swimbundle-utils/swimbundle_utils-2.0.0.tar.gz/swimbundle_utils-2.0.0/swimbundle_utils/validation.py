...
class InfinityVal(SpecialValue):
    ...
    def __init__(self, pos=True):
        """
        :param pos: If this infinity is positive or negative
        """
        self.pos = pos
...
class RegexValidator(Validator):
    ...
    def __init__(self, regex):
        super(RegexValidator, self).__init__("regex")
        self.regex = regex
...
class Validators(object):
    ...
    class __Validators(object):
        ...
        def add_type_validator_inst(self, inst, override=False):
            ...
            :param inst: Validator class instance
            :param override: Override any previous entry with the same name
            :return: None
            """
        ...
        def add_type_validator(self, type_name, func, override=False):
            ...
            :param type_name: Name of the validator
            :param func: Function with signature func(val) -> return ValidValue(val) or InvalidValue(val)
            :param override: If this validator already exists, replace it in the mapping
            :return: None
            """
        ...
        def is_datetime(self, value):
            try:
                return ValidValue(pendulum.parse(value).to_iso8601_string())
            except ParserError:
                return InvalidValue(value)
