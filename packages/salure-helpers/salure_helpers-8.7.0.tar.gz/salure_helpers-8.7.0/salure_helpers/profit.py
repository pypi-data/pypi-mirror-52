...
class UpdateConnector:
    ...
    def update_cost_center(self, data: dict, method: str, overload_fields={}):
        """
    ...
    def update_cost_carrier(self, data: dict, method: str, overload_fields={}):
        """
        ...
        for field in required_fields:
            if field not in data.keys():
                return 'Pietertje, field {} is required. Required fields are: {}'.format(field, tuple(required_fields))
