...
class UpdateConnector:
    ...
    def new_wage_component(self, data: dict, overload_fields={}):
        ...
        # Add fields that you want to update a dict (adding to body itself is too much text)
        selector_to_update.update({"EnSe": data['contract_no']}) if 'contract_no' in data else selector_to_update.update({"EnSe": data['contract_no']})
        selector_to_update.update({"DaEn": data['enddate']}) if 'enddate' in data else selector_to_update.update({"DaEn": data['enddate']})
        selector_to_update.update({"DiTp": data['apply_type']}) if 'apply_type' in data else selector_to_update.update({"DiTp": data['apply_type']})
        ...
        base_body['HrVarValue']['Element'].update(selector_to_update)
