...
class SomToday:
    ...
    def get_metadata(self):
        ...
        """
        client = Client('http://{}-oop.somtoday.nl/services/umService?wsdl'.format(self.environment))
        methods = {}
    ...
    def get_data(self, dataset_name: str, params: dict):
        ...
        if response.status_code == 200:
            ...
            item_dict = json.loads(json_data)['soap:Envelope']['soap:Body']['ns2:{dataset_name}Response'.format(dataset_name=dataset_name)]['return']
