...
class ProfitMutations:
    ...
    def process_dataset(self, check_columns: list, connector: str, unique_key: str, changed_or_edited: str, dateformat=None, export_columns=None, column_value_mapping=None, column_mapping=None):
        """
    ...
    def process_new_employees(self, unique_key: str):
        """
        This function is the process trigger to process new employees
        ----------
        :return: nothing
        """
        df_mutations = self.get_changed_data('salure_new_employee', check_columns=[unique_key], unique_key=unique_key)
