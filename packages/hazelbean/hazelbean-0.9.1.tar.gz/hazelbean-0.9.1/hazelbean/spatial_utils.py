...
def clip_raster_by_bb(input_path, bb, output_path):
    ...
    c, r, width, height = hb.bb_path_to_cr_size(bb, input_path)
...
def reproject_dataset_to_match(input_path, match_path, output_path, resampling_method):
    ...
    print('int((lrx - ulx)/pixel_spacing)', int((uly - lry) / pixel_spacing), int((lrx - ulx)/pixel_spacing), int((uly - lry) / pixel_spacing))
