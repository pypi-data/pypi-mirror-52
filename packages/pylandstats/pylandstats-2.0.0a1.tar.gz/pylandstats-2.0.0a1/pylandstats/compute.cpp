...
typename __pythran_compute::compute_adjacency_arr::type<pythonic::types::ndarray<npy_uint32,pythonic::types::pshape<long,long>>, long>::result_type compute_adjacency_arr0(pythonic::types::ndarray<npy_uint32,pythonic::types::pshape<long,long>>&& padded_arr, long&& num_classes) 
{
  
                            PyThreadState *_save = PyEval_SaveThread();
                            try {
                                auto res = __pythran_compute::compute_adjacency_arr()(padded_arr, num_classes);
...
typename __pythran_compute::compute_adjacency_arr::type<pythonic::types::numpy_texpr<pythonic::types::ndarray<npy_uint32,pythonic::types::pshape<long,long>>>, long>::result_type compute_adjacency_arr1(pythonic::types::numpy_texpr<pythonic::types::ndarray<npy_uint32,pythonic::types::pshape<long,long>>>&& padded_arr, long&& num_classes) 
{
...
#endif
PyMODINIT_FUNC
PYTHRAN_MODULE_INIT(compute)(void)
#ifndef _WIN32
...
PYTHRAN_MODULE_INIT(compute)(void) {
    ...
    #else
    PyObject* theModule = Py_InitModule3("compute",
                                         Methods,
                                         ""
    );
    #endif
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.3post1",
                                      "2019-09-24 15:24:03.893081",
                                      "fbf5be7b884b6f6bbb463afb3941c8f8ae3b4ed3cd0bdf04d6e4ba1afed6f0ad");
    if(! theDoc)
        PYTHRAN_RETURN;
