...
extra_message_error_codes = ['ConfigurationError', 'ExpressionError', 'StorageError', 'InvalidPath', 'AuthenticationFailure']
...
class ExecutionError(Exception):
    ...
    def __init__(self, error_response):
        self.error_code = error_response['errorData']['errorCode'] if 'errorCode' in error_response['errorData'] else None
        ...
        message = error_messages[self.error_code] if self.error_code is not None else ''
