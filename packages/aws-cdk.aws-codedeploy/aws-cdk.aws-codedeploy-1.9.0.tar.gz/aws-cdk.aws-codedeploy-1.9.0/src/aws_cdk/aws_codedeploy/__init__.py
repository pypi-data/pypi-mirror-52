...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codedeploy", "1.9.0", __name__, "aws-codedeploy@1.9.0.jsii.tgz")
...
class CfnDeploymentConfig(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codedeploy.CfnDeploymentConfig"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, deployment_config_name: typing.Optional[str]=None, minimum_healthy_hosts: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["MinimumHealthyHostsProperty"]]]=None) -> None:
    ...
    def minimum_healthy_hosts(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["MinimumHealthyHostsProperty"]]]:
    ...
    def minimum_healthy_hosts(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["MinimumHealthyHostsProperty"]]]):
...
class CfnDeploymentConfigProps():
    def __init__(self, *, deployment_config_name: typing.Optional[str]=None, minimum_healthy_hosts: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnDeploymentConfig.MinimumHealthyHostsProperty"]]]=None):
    ...
    @property
    def minimum_healthy_hosts(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnDeploymentConfig.MinimumHealthyHostsProperty"]]]:
        """``AWS::CodeDeploy::DeploymentConfig.MinimumHealthyHosts``.
...
class CfnDeploymentGroup(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codedeploy.CfnDeploymentGroup"):
    ...
    def alarm_configuration(self) -> typing.Optional[typing.Union[typing.Optional["AlarmConfigurationProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
    ...
    def alarm_configuration(self, value: typing.Optional[typing.Union[typing.Optional["AlarmConfigurationProperty"], typing.Optional[aws_cdk.core.IResolvable]]]):
...
class CfnDeploymentGroupProps():
    ...
    @property
    def alarm_configuration(self) -> typing.Optional[typing.Union[typing.Optional["CfnDeploymentGroup.AlarmConfigurationProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::CodeDeploy::DeploymentGroup.AlarmConfiguration``.
