...
class CiscoConnectivityFlow(AbstractConnectivityFlow):
    ...
    def _add_vlan_flow(self, vlan_range, port_mode, port_name, qnq, c_tag):
        ...
        with self._cli_handler.get_cli_service(self._cli_handler.config_mode) as config_session:
            ...
            try:
                current_config = self._add_switchport_vlan(vlan_actions,
                                                           iface_action,
                                                           vlan_range,
                                                           port_name,
                                                           port_mode,
    ...
    def _add_switchport_vlan(self, vlan_actions, iface_actions, vlan_range, port_name, port_mode, qnq, c_tag):
