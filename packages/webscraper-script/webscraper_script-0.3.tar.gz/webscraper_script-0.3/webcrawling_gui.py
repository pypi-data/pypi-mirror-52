...
if os.path.exists('C:/Users/geckodriver.exe'):#proceeding program excution only if geckodriver is installed
    def enter_place():
        if place_text.get()=="":
            list1.delete(0,END)
    ...
    messagebox.showerror("geckodriver missing!","Please place geckodriver.exe file inside path C:/Users/")
    list1.delete(0,END)
    list1.insert(END,"geckodriver for firefox has not been installed in your system")
    list1.insert(END,"Please place geckodriver.exe file inside path C:/Users/")
