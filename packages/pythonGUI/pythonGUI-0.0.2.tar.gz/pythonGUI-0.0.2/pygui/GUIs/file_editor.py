...
def crash(event=None, *args, **kwargs):
    ...
    if __name__ == '__main__':
        ...
        ROOT.destroy()
        globals().update({'debug_run': True})
        from pygui.GUIs import text_editor as te
        te.main()
...
class Dialog(Toplevel):
    ...
    def ok(self, event=None):
        ...
        if not self.validate():
            self.initial_focus.lift() # put focus back
            return
...
class Monkey(object):
    ...
    def reload(self):
        try:
            ...
            print('WARNING: The file edited monkey failed msg:', ex)
            pass
