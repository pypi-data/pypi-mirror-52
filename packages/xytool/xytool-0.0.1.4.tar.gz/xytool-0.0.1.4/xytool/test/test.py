...
# -*- coding: utf-8 -*-
# AUTHOR: XYCoder
# FILE: ~/Desktop/saic/xytool/xytool/test/test.py
# DATE: 2019/08/21 Wed
# TIME: 14:12:21
...
import glob
from xytool.common.sysenv import System
...
# from xytool.test.testUI.te import TestThread
...
class Test:
    ...
    def get_device_name_with_IMEI(self,IMEI,type):
        ...
        return result[0].split('=')[1].rstrip()
