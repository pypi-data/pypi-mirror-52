...
# -*- coding: utf-8 -*-
"""
API for the command-line I{xytool} tool.
"""
...
from xytool.ios.CommonScript import IOSProjectTool, GitLabTool
from xytool.ios.cert import Cert
from xytool.ios.package import Package
from xytool.common.xylog import *
import xytool.common.globalvar as gv
from xytool.config import log_store_local
from xytool.config import Config
from xytool.common.sysenv import SysEvn,System
from xytool.ios.oclint import OCLint
from xytool.test.testUI import TestUI
...
__all__ = ['pull', 'pullsubmodule', 'initproject', 'package', "pps", 'syn', 'merge','diagnose','monkey', 'main']
...
def _print_helpdoc():
    ...
    print("     \033[0;32mxytool [action] [parameters(optional)]\033[0m ")
    print("\033[4;30msystem command:\033[0m")
    print("     \033[0;32m[-h]\033[0m or \033[0;32m[--help]\033[0m     \thelpdocument for xytool")
    print("     \033[0;32m[-v]\033[0m or \033[0;32m[--version]\033[0m   \tversion of xytool")
    print("\033[4;30mxytool actions:\033[0m")
