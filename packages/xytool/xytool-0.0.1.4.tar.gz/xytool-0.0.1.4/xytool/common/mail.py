...
from xytool.source.html import diagnosemail_body, diagnosemail_header,mergemail_body
from xytool.source.image import jsonfileicon
import base64,os
...
class Email():
    ...
    def get_html_text(self,html_path):
        with open(html_path,'r') as f:
            # print(f.read())
            content = f.read()
            self.sendemail(None,"此邮件来自代码自动诊断","iOS项目组",htmltext=content,image='/Users/v-sunweiwei/Desktop/saic/xytool/xytool/source/img/jsonfileicon.png',filepath='/Users/v-sunweiwei/Desktop/extension/人力图.jpg')
...
if __name__ == "__main__":
    ...
    # Email().get_html_text('/Users/v-sunweiwei/Desktop/saic/xytool/xytool/source/htmlx/diagnosemail.html')
