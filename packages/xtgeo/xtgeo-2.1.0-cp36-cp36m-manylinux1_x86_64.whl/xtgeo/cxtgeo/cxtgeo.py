...
def grd3d_imp_roffbin_fvec(fc, swp, bpos, fvc, nx, dbg):
    return _cxtgeo.grd3d_imp_roffbin_fvec(fc, swp, bpos, fvc, nx, dbg)
grd3d_imp_roffbin_fvec = _cxtgeo.grd3d_imp_roffbin_fvec

def grd3d_imp_roffbin_ivec(fc, swp, bpos, ivc, nx, dbg):
    return _cxtgeo.grd3d_imp_roffbin_ivec(fc, swp, bpos, ivc, nx, dbg)
grd3d_imp_roffbin_ivec = _cxtgeo.grd3d_imp_roffbin_ivec

def grd3d_imp_roffbin_bvec(fc, swp, bpos, bvc, nx, dbg):
    return _cxtgeo.grd3d_imp_roffbin_bvec(fc, swp, bpos, bvc, nx, dbg)
...
def grd3d_roff_to_xtgeo(nx, ny, nz, xoffset, yoffset, zoffset, xscale, yscale, zscale, p_cornerlines_v, p_splitenz_v, p_zdata_v, p_coord_v, p_zcorn_v, p_actnum_v, debug):
    return _cxtgeo.grd3d_roff_to_xtgeo(nx, ny, nz, xoffset, yoffset, zoffset, xscale, yscale, zscale, p_cornerlines_v, p_splitenz_v, p_zdata_v, p_coord_v, p_zcorn_v, p_actnum_v, debug)
grd3d_roff_to_xtgeo = _cxtgeo.grd3d_roff_to_xtgeo
...
def grd3d_imp_ecl_egrid(fc, nx, ny, nz, bpos_mapaxes, bpos_coord, bpos_zcorn, bpos_actnum, p_coord_v, p_zcorn_v, actnum_v, debug, option):
    return _cxtgeo.grd3d_imp_ecl_egrid(fc, nx, ny, nz, bpos_mapaxes, bpos_coord, bpos_zcorn, bpos_actnum, p_coord_v, p_zcorn_v, actnum_v, debug, option)
