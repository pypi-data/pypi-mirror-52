...
##################################
def visual_de_nat_pacbio(clu,allgene,genename,refGenes,path,apapos,atipos,apapos_r,atipos_r,ir,es,alta,altd,altp,nat,difflib,pairs,fpkmcal,ir_r,\
	es_r,alta_r,altd_r,altp_r,de_nat_lib,mapdict,conf,cf,bamlist):
	...
	##Normailiation
		...
		###Normaliation END	
		return wig
	def transcripts(cr,h,scale,line,arrayline,sort_dict,refGenes,minpos,maxpos,genename,allgene,nat):
		global hh
		think=dict()
		for j in sort_dict:
			info=j.split()
