...
do	
	...
	rMATS.sh -d ${prefix}/JC/temp/${i}.JCEC.input.txt -o ${prefix}/JC/temp/${i}out_JCEC -c 0.0001 -p 8 -t U
	joinFiles.py ${prefix}/AS/"as".${i}.txt ${prefix}/JC/temp/${i}out_JCEC/rMATS_Result.txt  0 0 ${prefix}/JC/${i}.MATS.ReadsOnTargetAndJunctionCount.txt
done
