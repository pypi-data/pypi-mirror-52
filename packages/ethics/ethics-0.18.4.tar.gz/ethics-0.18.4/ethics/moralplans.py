...
from ethics.moralprinciples import *
...
class Situation:
    ...
    def __is_instrumental_at(self, effect, positions):
        ...
        return not self.__satisfies_goal(sn)    
    ...
    def __satisfies_goal(self, state):
    ...
    def __plan_found(self, newplancand, principle):
        ...
        if self.__satisfies_goal(fstate):
