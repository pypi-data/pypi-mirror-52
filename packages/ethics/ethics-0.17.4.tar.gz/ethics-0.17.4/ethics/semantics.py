...
class CausalNetwork(Model):
    ...
    def compute_layers(self, layer = 0):
        ...
        if layer == 0:
            ...
            handled_vars = self.__merge_lists(self.layers.values())
            ...
            if len(unhandled_vars) > 0:
                ...
                for v in unhandled_vars:
                    ...
                    if entails(And(handled_vars_formula, v_formula), v) or entails(And(handled_vars_formula, v_formula), Not(v)):
