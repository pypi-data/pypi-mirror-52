...
from azureml.telemetry.contracts._event import Event as _Event
...
class LogScope:
    ...
    def get_merged_props(self, props: dict) -> dict:
...
@contextmanager
def context_scope(component_name, name, track=False, na_properties: set = None, **kwargs) -> LogScope:
    """
