...
PLAN_NAMES = [
    'MySQL Percona Single 5.7.25_2',
    'MySQL Percona FOXHA Small - 5.7.25_2',
    'MySQL Percona FOXHA Small - 5.7.25 - aws-prod_2'
]
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for plan_name in PLAN_NAMES:
            plan = orm['physical.Plan'].objects.filter(name=plan_name).first()
            plan_attr_dns = orm.PlanAttr()
            plan_attr_dns.created_at = BASE_DATA['created_at']
            plan_attr_dns.updated_at = BASE_DATA['updated_at']
            plan_attr_dns.dbaas_plan = plan
            plan_attr_dns.dnsapi_vm_domain = BASE_DATA['dnsapi_vm_domain']
            plan_attr_dns.dnsapi_database_domain = BASE_DATA['dnsapi_database_domain']
            plan_attr_dns.save()
    ...
    models = {
        u'dbaas_dnsapi.databaseinfradnslist': {
            'Meta': {'unique_together': "(('name', 'domain'),)", 'object_name': 'DatabaseInfraDNSList'},
        ...
        u'dbaas_dnsapi.planattr': {
            ...
            'dnsapi_secondary_database_domain': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'dnsapi_secondary_database_sufix': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
