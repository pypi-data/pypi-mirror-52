...
## Basic information
NAME         = "btrdb_admin"
DESCRIPTION  = "Bindings to interact with the Berkeley Tree Database Admin API using gRPC."
AUTHOR       = "Allen Leis"
EMAIL        = "allen@pingthings.io"
MAINTAINER   = "Allen Leis"
LICENSE      = "BSD-3-Clause"
REPOSITORY   = "https://github.com/BTrDB/btrdb-admin-python"
PACKAGE      = "btrdb_admin"
URL          = "http://btrdb.io/"
...
config = {
    ...
    "package_data": {
        "btrdb_admin": ["grpcinterface/admin.proto"],
    },
    "zip_safe": False,
    "entry_points": {
        "console_scripts": [],
