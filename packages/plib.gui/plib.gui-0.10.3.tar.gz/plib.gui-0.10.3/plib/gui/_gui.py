...
from plib.gui.defs import GUI_KDE, GUI_QT, GUI_GTK, GUI_WX, GUI_KDE4, GUI_QT4, GUI_PYSIDE, GUI_QT5, GUI_PYSIDE2
...
if gui_toolkit == 0:
    ...
    # check KDE first since Qt is preferred there
    if KDE_PRESENT or QT_PRESENT or KDE4_PRESENT or QT4_PRESENT or PYSIDE_PRESENT or QT5_PRESENT or PYSIDE2_PRESENT:
        ...
        # if KDE is running, default to matching KDE or Qt or PySide version
        if kde_session or kde_desktop or kde_winmgr:
            if os.getenv('KDE_SESSION_VERSION') == '4':
                ...
                if QT5_PRESENT:
                    gui_toolkit = GUI_QT5
                elif PYSIDE2_PRESENT:
                    # This is the last choice because it appears to be less
                    # "canonical" than PyQt5
                    gui_toolkit = GUI_PYSIDE2
            else:
                if KDE_PRESENT:
                    gui_toolkit = GUI_KDE
                elif QT_PRESENT:
    ...
    # check Qt 5 if none of the above worked
    if (gui_toolkit == 0) and QT5_PRESENT:
        gui_toolkit = GUI_QT5
    
    # check PySide2 if none of the above worked
    if (gui_toolkit == 0) and PYSIDE2_PRESENT:
        gui_toolkit = GUI_PYSIDE2
