#!/usr/bin/env python3
"""
Module QT5COMBO -- Python Qt 5 Combo Box Widgets
...
from ._qt5common import _PQtSequenceMeta, _PQtWidget


class PQtComboBox(qt.QComboBox, _PQtWidget, combo.PComboBoxBase):
