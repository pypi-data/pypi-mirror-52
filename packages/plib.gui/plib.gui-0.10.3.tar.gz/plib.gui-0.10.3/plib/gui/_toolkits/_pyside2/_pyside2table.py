#!/usr/bin/env python3
"""
Module PYSIDE2TABLE -- Python PySide2 Table Objects
...
from ._pyside2common import _PQtSequenceMeta, _PQtClientWidget, _qtalignmap
...
class PQtTable(_PQtClientWidget, qt.QTableWidget, table.PTableBase):
