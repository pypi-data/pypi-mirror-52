#!/usr/bin/env python3
"""
Module PYSIDE2LISTVIEW -- Python PySide2 Tree/List View Objects
Sub-Package GUI.TOOLKITS.PYSIDE2 of Package PLIB -- Python GUI Toolkits
...
from ._pyside2common import (_PQtSequenceMeta, _PQtWidget, _PQtClientWidget, _PQtCommunicator,
                           _qtalignmap)
...
class PQtListView(_PQtClientWidget, _PQtListViewBase, listview.PListViewBase):
...
class PQtListBox(_PQtWidget, _PQtListViewBase, listview.PListBoxBase):
