#!/usr/bin/env python3
"""
Module PYSIDE2ACTION -- Python PySide2 Action Objects
...
This module contains the PySide GUI objects for handling user actions.
"""
...
from ._pyside2common import _PQtCommunicator, _PQtWidgetBase
