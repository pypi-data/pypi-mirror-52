#!/usr/bin/env python
"""
Module PYSIDEAPP -- Python PySide Application Objects
Sub-Package GUI.TOOLKITS.PYSIDE of Package PLIB -- Python GUI Toolkits
...
from ._pysidecommon import _PQtCommunicator, _PQtWidgetMeta, _qtmessagefuncs
