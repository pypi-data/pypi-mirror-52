...
from ._kdecommon import _PKDECommunicator, _kdemessagefuncs
...
_kdeversion_items = tuple(
    getattr(kdecore.KDE, 'version{}'.format(name))()
...
class PKDEApplication(_PKDECommunicator, kdecore.KApplication,
