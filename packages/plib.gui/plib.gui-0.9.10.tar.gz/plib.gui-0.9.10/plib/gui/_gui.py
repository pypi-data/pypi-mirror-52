...
from plib.gui.defs import GUI_KDE, GUI_QT, GUI_GTK, GUI_WX, GUI_KDE4, GUI_QT4, GUI_PYSIDE
...
if gui_toolkit == 0:
    ...
    # check KDE/Qt first
    if KDE_PRESENT or QT_PRESENT or KDE4_PRESENT or QT4_PRESENT or PYSIDE_PRESENT:
