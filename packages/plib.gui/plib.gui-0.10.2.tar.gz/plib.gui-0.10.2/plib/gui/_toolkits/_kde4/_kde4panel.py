#!/usr/bin/env python
"""
Module KDE4PANEL -- Python KDE Panel Objects
...
This module contains the KDE 4 GUI objects for the panel widgets.
"""
...
class PKDEPanel(_PKDEWidgetBase, qt.QFrame, panel.PPanelBase):
