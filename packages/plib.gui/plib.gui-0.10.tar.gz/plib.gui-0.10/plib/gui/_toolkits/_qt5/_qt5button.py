#!/usr/bin/env python3
"""
Module QT5BUTTON -- Python Qt 5 Button Widgets
...
class PQtButton(qt.QPushButton, _PQtButtonMixin, _PQtWidget,
                button.PButtonBase):
...
class PQtCheckBox(qt.QCheckBox, _PQtButtonMixin, _PQtWidget,
