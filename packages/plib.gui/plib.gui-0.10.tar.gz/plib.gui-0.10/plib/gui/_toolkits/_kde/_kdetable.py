#!/usr/bin/env python
"""
Module KDETABLE -- Python KDE Table Objects
...
This module contains the KDE GUI objects for the table widgets.
"""
...
class PKDETableLabels(table.PTableLabelsBase):
    ...
    def _set_align(self, index, align):
        ...
        # (Why the @#$&*! isn't that built into KDE?)
        pass
...
class PKDETable(_PKDEClientWidget, qttable.QTable, table.PTableBase):
    ...
    def paintCell(self, painter, row, col, rect, selected, colorgroup=None):
        ...
        # FIXME: wtf isn't this already built into KDE???
        if colorgroup is not None:
            ...
            qttable.QTable.paintCell(self, painter, row, col,
                                     rect, selected, colorgroup)
        else:
