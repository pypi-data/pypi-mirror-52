#!/usr/bin/env python3
"""
Module PYSIDE2APP -- Python PySide2 Application Objects
...
This module contains the PySide GUI application objects.
"""
...
from ._pyside2common import _PQtCommunicator, _PQtWidgetMeta, _qtmessagefuncs
