...
_DATAGATEWAYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\036\022\034/v1alpha1/{id=jobs/*}/export'),
  ),
])
