...
def call(
        ...
        call_name: str,
        args: List[Any] = [],
        kwargs: Dict[str, Any] = {}) -> Callable[..., A]:
...
def prototype(
        ...
        call_name: str,
        args: List[Any],
        kwargs: Dict[str, Any]) -> Callable[..., B]:
...
def safe_call(call: Callable[[A], B], kwargs: Dict[str, Any]) -> Optional[B]:
    try:
        return call(**kwargs)
...
class LazyCallable:
    def __init__(self, call: Callable[..., B]):
        self._callable = call
