...
def _is_callable(obj: A, set: KeysView) -> bool:
    return isinstance(obj, list) and len(obj) == 1 and obj[0] in set
...
class Factory:
    ...
    def dag_nodes(self) -> Mapping[str, Dag._node]:
