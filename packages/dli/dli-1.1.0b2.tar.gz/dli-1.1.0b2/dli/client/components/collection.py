...
class Collection(SirenComponent):
    ...
    def create_collection(
        ...
        return siren_to_entity(
            self.client.session.post(
                self.urls.collections_index, json=payload
            ).to_siren()
        )
    ...
    def _get_collection(self, **kwargs):
        response = self.client.session.get(
            self.urls.collections_index, params=kwargs
        )
    ...
    def edit_collection(
        ...
        **kwargs
        ...
        response = self.client.session.put(
            self.urls.collections_instance.format(id=collection_id),
    ...
    def get_packages_for_collection(self, collection_id, count=100):
        ...
        response = self.client.session.get(
            self.urls.collections_instance_packages.format(id=collection_id),
