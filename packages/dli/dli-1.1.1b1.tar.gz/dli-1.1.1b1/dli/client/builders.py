...
class DatasetBuilder:
    ...
    def __init__(self, location_builder=None, data_preview_type='NONE', **kwargs):
        self._data = dict(kwargs)

        # Remove this when https://git.mdevlab.com/data-lake/data-lake-interface/merge_requests/1437/diffs
        # is merged
        sample_data = self._data.get('sample_data')
        if sample_data:
            data_preview_type = 'STATIC'

        self._data['data_preview_type'] = data_preview_type
