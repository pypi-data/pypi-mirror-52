...
class Package(SirenComponent):
    ...
    def get_package_datasets(self, package_id, count=100):
        ...
        return self.client.session.get(
            self.urls.package_datasets.format(id=package_id),
    ...
    def register_package(
        ...
        :param str manager_id: Account ID for the Data Lake Account representing
        ...
        return siren_to_entity(
            self.client.session.post(
                self.urls.package_index, json=payload
            ).to_siren()
        )
    ...
    def edit_package(
        ...
        **kwargs
        ...
        """
        fields = filter_out_unknown_keys(to_camel_cased_dict(kwargs), Package._KNOWN_FIELDS)
        ...
        result = self.client.session.put(
            self.urls.package_edit.format(id=package_id), json=package_as_dict
        )
    ...
    def delete_package(self, package_id):
        ...
        self.client.session.delete(
            self.urls.package_edit.format(id=package_id)
        )
    ...
    def _get_package(self, **kwargs):
        response = self.client.session.get(
            self.urls.package_index, params=kwargs
        )
