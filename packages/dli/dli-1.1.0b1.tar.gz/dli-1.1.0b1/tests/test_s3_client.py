...
class S3UploadTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.bucket = client.s3_resource.Bucket('s3_test')
        self.bucket.create()
    ...
    def test_upload_files_with_no_bucket_access_fails(self):
        ...
        with patch.object(self.s3_client, 's3_resource') as patched_s3_resource:
            patched_s3_resource.Bucket().Object().upload_file.side_effect = (
                error
            )
