...
int CloseChain_OUT( vector<ChainAtom> & chain );
...
int CloseChain_2points( vector<ChainAtom> & chain, int p1=0, int p2=10 );
...
int CloseChain_1point( vector<ChainAtom> & chain );
...
int CloseChains_OUT( vector< vector<ChainAtom> > & vComp );
// CloseChain_OUT_Link

int CloseChains_2points( vector< vector<ChainAtom> > & vComp, int p1=0, int p2=10 );
// CloseChain_F_Link_2points

int CloseChains_1point( vector< vector<ChainAtom> > & vComp );
