...
const int KNOTS_AMOUNT = 40;    // The number of knot types we can recognize in this package (we have their Alexander polynomials written in our "library" - array
...
bool FindTheKnot_poly( vector<ChainAtom> chain, polynomial<int> & det, double & det_d);
