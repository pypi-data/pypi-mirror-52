...
base64_picture = namedtuple('base64_picture', ['format', 'data'])
...
class Picture:
    ...
    @staticmethod
    def parse_base64(data: Union[str, bytes, bytearray]) -> Optional[NamedTuple]:
        """
        ...
        return base64_picture(picture_format, picture_data)
