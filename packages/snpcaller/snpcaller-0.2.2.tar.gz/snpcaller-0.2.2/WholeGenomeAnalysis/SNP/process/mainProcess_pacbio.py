            ...
            for matchObject in arrObject:
                ...
                for snip in snpData['SNP']:
                    if (snip['chrom'] == matchChr):
                        ...
                        if( 'rs5030656' in snip['name'] and 'NumReads442' in sequence.query_name):
                            print("rs1135822")
                        ...
                        if (matchStart < chromStart < matchEnd and matchStart < chromEnd < matchEnd):
                            ...
                            snps = Snp(1, sequence.query_name, rawReads, snip['name'], snip['chrom'],
...
final_snp_list = callsnip.filterSnipObject(snip_dic, snip_totalReads, 0.10)
