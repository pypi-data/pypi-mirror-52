...
def setup_static_dirs(app: Application):
    ...
    for component in app.components:
        ...
        static_app_dir = component_path / 'static'
        static_dir = DEPLOY_SETTINGS.static_dir

        for directory in static_app_dir.glob('*'):
            os.system('mkdir -p {}'.format(static_dir))
            os.system('ln -sf {} {}'.format(directory, static_dir))
