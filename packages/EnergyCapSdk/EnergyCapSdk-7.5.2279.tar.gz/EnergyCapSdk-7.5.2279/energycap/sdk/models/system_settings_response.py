...
class SystemSettingsResponse(Model):
    ...
    :param default_meter_time_zone: Default time zone for new meters
    ...
    def __init__(self, organization_name=None, display_organization_name_in_header=None, organization_logo=None, automatic_logout_minutes=None, default_country=None, default_meter_time_zone=None, default_date_format=None):
