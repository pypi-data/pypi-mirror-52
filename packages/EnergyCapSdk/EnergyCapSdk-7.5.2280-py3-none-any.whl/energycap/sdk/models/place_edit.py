...
class PlaceEdit(Model):
    ...
    :param weather_station_code: The code for the weather station the place is
     assigned to <span class='property-internal'>Must be between 0 and 6
     characters</span>
    ...
    _validation = {
        ...
        'weather_station_code': {'max_length': 6, 'min_length': 0},
    }
    ...
    def __init__(self, place_code, place_info, parent_place_id, place_type_id, primary_use_id=None, build_date=None, address=None, weather_station_code=None):
