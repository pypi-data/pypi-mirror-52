...
CANNOT_SET_ENCRYPTION_PASSWORD = 2066                          #: Impossibile impostare la password crittigrafica; la crittografia dei dati verrà disabilitata
...
PN_NUMDE_ERR = 5420                                            #: Numero interno del documento elettronico non trovato! Inserire un nuomero interno valido o lasciare il campo vuoto
