...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v0.2.12-dev.1568406970+gb89f734'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v0.2.12-dev.1568406970+gb89f734`
                """)
            else:
                raise
