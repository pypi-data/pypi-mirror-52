...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v0.2.12-alpha.1568485435+g1f55f78'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v0.2.12-alpha.1568485435+g1f55f78`
                """)
            else:
                raise
