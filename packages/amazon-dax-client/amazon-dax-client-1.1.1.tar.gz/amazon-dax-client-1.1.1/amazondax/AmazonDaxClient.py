...
class AmazonDaxClient(object):
    ...
    def __init__(self, session=None,
        ...
        partition = None
        self.meta = ClientMeta(event_emitter, self._client_config, self._endpoints[0], service_model, PY_TO_OP_NAME, partition)
    ...
    def _do_request(self, action, op_name, **kwargs):
        ...
        self.meta.events.emit(
            ...
            params=api_params, model=operation_model, context=request_context)
        RequestValidator.validate_api_using_operation_model(operation_model, api_params)
