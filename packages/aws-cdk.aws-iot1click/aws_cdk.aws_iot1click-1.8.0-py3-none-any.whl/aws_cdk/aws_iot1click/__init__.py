...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-iot1click", "1.8.0", __name__, "aws-iot1click@1.8.0.jsii.tgz")
...
class CfnProjectProps():
    def __init__(self, *, placement_template: typing.Union[aws_cdk.core.IResolvable, "CfnProject.PlacementTemplateProperty"], description: typing.Optional[str]=None, project_name: typing.Optional[str]=None):
    ...
    @property
    def placement_template(self) -> typing.Union[aws_cdk.core.IResolvable, "CfnProject.PlacementTemplateProperty"]:
        """``AWS::IoT1Click::Project.PlacementTemplate``.
